...
(function initDevLog() {
  ...
  document.addEventListener('click', function(e) {
    const title = e.target.closest('h1, .font-display');
    if (title) {
      titleTapCount++;
  ...
  function createPanel() {
    ...
    div.style.cssText = 'position:fixed;top:0;left:0;right:0;bottom:0;z-index:9999;background:rgba(20,20,35,0.92);backdrop-filter:blur(6px);display:flex;flex-direction:column;font-family:monospace;';
    div.innerHTML = `
