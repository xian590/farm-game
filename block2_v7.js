...
function __diagLog(step, ok, err) {
  try {
    ...
    if (!el) {
      ...
      el.id = '__init_diag';
      el.style.cssText = 'position:fixed;top:0;left:0;right:0;z-index:99998;background:#1a1625;color:#e8e0f0;font-family:monospace;font-size:12px;padding:8px;max-height:200px;overflow:auto;white-space:pre-wrap;';
      document.body.appendChild(el);
    }
    const line = (ok ? '✅ ' : '❌ ') + step + (err ? ' | ' + err : '') + '\n';
    el.textContent += line;
  } catch(e) {}
}
