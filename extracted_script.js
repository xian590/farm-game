...
tailwind.config = {
      theme: {
        extend: {
          ...
          fontFamily: {
            'display': ['"Ma Shan Zheng"', 'sans-serif'],
            'title':   ['"ZCOOL XiaoWei"', 'sans-serif'],
            'body':    ['"Noto Sans SC"', 'sans-serif'],
          },
          boxShadow: {
            'soft':   '0 4px 24px rgba(184, 169, 201, 0.15)',
            'card':   '0 8px 32px rgba(184, 169, 201, 0.12)',
            'float':  '0 16px 48px rgba(184, 169, 201, 0.2)',
            'inner':  'inset 0 1px 0 rgba(255,255,255,0.9)',
            'glow':   '0 0 40px rgba(212, 181, 199, 0.3)',
          },
          animation: {
            ...
            'soft-pop':    'softPop 0.5s cubic-bezier(0.34, 1.2, 0.64, 1)',
            ...
            'petal-fall':  'petalFall 5s ease-out forwards',
            'slide-in':    'slideIn 0.5s cubic-bezier(0.22, 1, 0.36, 1)',
            'slide-out':   'slideOut 0.4s cubic-bezier(0.22, 1, 0.36, 1)',
          ...
          keyframes: {
            ...
            sunGlow: {
              '0%, 100%': { filter: 'drop-shadow(0 0 20px rgba(253, 230, 138, 0.5))' },
              '50%':      { filter: 'drop-shadow(0 0 40px rgba(253, 230, 138, 0.7))' },
            },
            moonGlow: {
              '0%, 100%': { filter: 'drop-shadow(0 0 15px rgba(226, 232, 240, 0.6))' },
              '50%':      { filter: 'drop-shadow(0 0 30px rgba(226, 232, 240, 0.8))' },
            },
            petalFall: {
...
const PERSONAS = [
  ...
  { id: 'lily', name: '铃兰公主', flower: '铃兰', color: '#88C898', animal: '🦌 小鹿',
    ...
    rhythm: '稳步前进 + 定期显化挑战舒适区',
    advice: ['每月设定一个小显化挑战目标', '拥抱变化是成长的开始', '相信自己有应对变化的能力', '从小改变开始积累勇气', '奖励自己每一次突破'],
  ...
  { id: 'blue', name: '蓝星花公主', flower: '蓝星花', color: '#9DB5C8', animal: '🐋 白鲸',
    ...
    rhythm: '情绪调频 + 建立能量边界',
    advice: ['建立情绪边界，不承接他人情绪', '每天留独处时间恢复能量', '练习情绪觉察和命名', '把敏感变成超能力', '学会保护自己的能量场'],
  ...
  { id: 'sakura', name: '樱花公主', flower: '樱花', color: '#F0D5E0', animal: '🐰 玉兔',
    trait: '疗愈主导精灵型', second: '敏感型',
    advantage: '治愈力强，温柔细腻，有灵气，艺术感知力强',
    block: '敏感玻璃心，容易受伤，情绪起伏大',
    rhythm: '温柔疗愈 + 建立内心力量',
    advice: ['敏感是天赋不是缺点', '建立保护自己的能量盾', '把敏感用在创造上', '学会筛选身边的人', '内心强大才能温柔'],
...
const PERSONALITY_TEST = [
  ...
  { q: '你理想的恋爱状态是？', options: [
    ...
    { text: '精神共鸣、灵魂伴侣', scores: { action: 0, create: 3, empathy: 1, stable: 0, charm: 1 } },
  ...
  { q: '你更喜欢什么样的工作环境？', options: [
    { text: '快节奏、有显化挑战、能冲业绩', scores: { action: 3, create: 1, empathy: 0, stable: 0, charm: 2 } },
...
// 限制性信念测试（10题精简版保留）
const BELIEF_TEST = [
  { q: '我觉得自己不值得被好好爱着', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'unworthy'},
  { q: '我觉得好事情不会长久发生在我身上', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ...
  { q: '我觉得自己赚不到大钱', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'money'},
  { q: '我觉得我不够好，不配拥有最好的', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'unworthy'},
  { q: '我总是需要很努力才能得到想要的', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'hard'},
  { q: '我觉得别人不会真正地爱我', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'unlovable'},
  { q: '我觉得我不行，做什么都做不好', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'incapable'},
  { q: '我必须做得完美才值得被爱', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
  ], type: 'perfect'},
  { q: '我总是把别人的需求放在自己前面', options: [
    { text: '完全不符合', score: 1 },
    { text: '有点符合', score: 2 },
    { text: '比较符合', score: 3 },
    { text: '非常符合', score: 4 },
...
const SATS_GUIDES = {
  '恋爱SP': `
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8859C">🌙 第一阶段：身体放松（约2分钟）</div>
    </div>
    <p class="mb-2">找一个舒服的姿势躺下来，闭上眼睛，轻轻地呼吸。</p>
    <p class="mb-2">把注意力带到你的脚趾头上。感受脚趾的感觉，然后对它们说：放松吧。</p>
    <p class="mb-2">慢慢往上，放松你的脚掌、脚跟、脚踝。让小腿的肌肉也柔软下来，就像融化的黄油一样。</p>
    <p class="mb-2">继续往上，放松你的膝盖、大腿、臀部。感觉双腿变得越来越沉，越来越沉，沉进床垫里。</p>
    <p class="mb-2">现在把注意力带到你的腹部。随着呼吸，腹部轻轻地起伏。放松腹部的肌肉，让它变得柔软。</p>
    <p class="mb-2">再往上，放松你的胸口、肩膀、手臂、手掌、指尖。感觉手臂也变得沉甸甸的，很放松。</p>
    <p class="mb-2">放松你的脖子、下巴、脸颊、眼睛、额头、头皮。你整张脸都柔软下来了，眉头也舒展开了。</p>
    <p class="mb-4">现在，你的整个身体都完完全全地放松了。你感觉很轻，很轻，就像漂浮在云端一样。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(184,169,201,0.12)">
      <div class="text-[10px] font-medium mb-1" style="color:#8B7E9C">☁️ 第二阶段：进入半梦半醒（约3分钟）</div>
    </div>
    <p class="mb-2">继续深呼吸。每一次吸气，都吸进平静和安宁；每一次呼气，都呼出所有的紧张和担忧。</p>
    <p class="mb-2">你感觉越来越困，越来越困。眼皮越来越沉，越来越沉。</p>
    <p class="mb-2">你快要睡着了，但还有一丝清醒。就在这个状态里，多待一会儿。</p>
    <p class="mb-4">不用急，慢慢来。你很安全，你很放松。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(212,165,184,0.15)">
      <div class="text-[10px] font-medium mb-1" style="color:#B87590">💖 第三阶段：构建场景（约5分钟）</div>
    </div>
    <p class="mb-2">现在，想象你已经和心爱的人在一起了。</p>
    <p class="mb-2">清晨，你从睡梦中醒来。微微睁开眼睛，看到他/她就在你身边，睡得很安详。</p>
    <p class="mb-2">你能闻到他/她身上的味道，那种让你安心的味道。</p>
    <p class="mb-2">你伸出手，轻轻碰了碰他/她的脸。皮肤暖暖的，很光滑。</p>
    <p class="mb-2">他/她醒了，看到你，露出了一个温柔的笑容，眼睛里都是爱意。</p>
    <p class="mb-2">他/她伸手把你搂进怀里，在你额头上亲了一下，轻声说：「早安，宝贝。」</p>
    <p class="mb-2">你把脸埋进他/她的胸口，听到他/她稳定的心跳声。</p>
    <p class="mb-2">你们一起起床，一起做早餐。厨房里飘着食物的香气，你们一边做一边说笑。</p>
    <p class="mb-2">阳光从窗户照进来，落在地板上，暖暖的。空气中都是甜甜的味道。</p>
    <p class="mb-4">感受这份幸福、这份满足、这份安心。就好像它已经真实发生了一样。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(245,230,200,0.25)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8955A">✨ 第四阶段：循环锚点（约5分钟）</div>
    </div>
    <p class="mb-2">现在，从这个长长的场景里，选出一个最让你心动的小动作。</p>
    <p class="mb-2">也许是他/她对你笑的那一刻，也许是他/她抱住你的那一刻，也许是他/她对你说「我爱你」的瞬间。</p>
    <p class="mb-2">找到那个动作，然后反复播放它。</p>
    <p class="mb-2">他/她对你笑了... 又笑了... 再一次笑了...</p>
    <p class="mb-2">每一次播放，都让那种甜蜜的感觉更强烈一点。</p>
    <p class="mb-2">你越相信，它就越真实。</p>
    <p class="mb-2">就这样，一遍又一遍地循环播放。</p>
    <p>💖 带着这份甜蜜的感觉，慢慢入睡吧～它已经是你的了。</p>
  `,
  '财富事业': `
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(245,230,200,0.2)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8955A">🌙 第一阶段：身体放松（约2分钟）</div>
    </div>
    <p class="mb-2">找一个舒服的姿势躺下来，闭上眼睛，轻轻地呼吸。</p>
    <p class="mb-2">从脚趾开始，一点一点往上放松。放松你的脚趾、脚掌、小腿、大腿...</p>
    <p class="mb-2">放松你的腹部、胸口、肩膀、手臂、手掌...</p>
    <p class="mb-2">放松你的脖子、脸、头皮。整个身体都变得柔软、沉重、放松。</p>
    <p class="mb-4">你感觉很安全，很安心。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(184,169,201,0.12)">
      <div class="text-[10px] font-medium mb-1" style="color:#8B7E9C">☁️ 第二阶段：进入半梦半醒（约3分钟）</div>
    </div>
    <p class="mb-2">继续深呼吸。每一次吸气，都吸进丰盛和富足；每一次呼气，都呼出所有的匮乏和焦虑。</p>
    <p class="mb-2">你越来越困，越来越放松。眼皮越来越沉。</p>
    <p class="mb-4">就在这个似睡非睡的状态里，多待一会儿。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(232,200,122,0.2)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8955A">💰 第三阶段：构建场景（约5分钟）</div>
    </div>
    <p class="mb-2">现在，想象你已经实现了财富自由。</p>
    <p class="mb-2">你拿起手机，打开银行APP。账户余额显示的数字，让你忍不住笑了出来。</p>
    <p class="mb-2">那个数字，是你一直想要的数字。你盯着它看了好一会儿，心里满满的都是安心。</p>
    <p class="mb-2">你不用再为钱发愁了。想买什么就买什么，想去哪里就去哪里。</p>
    <p class="mb-2">今天你想给自己买一件喜欢了很久的东西。你毫不犹豫地下单了，连价格都没多看一眼。</p>
    <p class="mb-2">下午，你去了一家很喜欢的咖啡馆，坐在靠窗的位置，点了最贵的那杯咖啡和一块蛋糕。</p>
    <p class="mb-2">阳光洒在你身上，你慢悠悠地喝着咖啡，看着窗外的人来人往。</p>
    <p class="mb-2">你心里很清楚：钱永远够花，而且越来越多。你有选择的自由。</p>
    <p class="mb-4">感受这份富足、这份自由、这份安心。就好像它已经是真的一样。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(136,200,152,0.2)">
      <div class="text-[10px] font-medium mb-1" style="color:#5A9C6A">✨ 第四阶段：循环锚点（约5分钟）</div>
    </div>
    <p class="mb-2">现在，从这个场景里，选出一个最让你心动的小动作。</p>
    <p class="mb-2">也许是你看到账户余额的那一刻，也许是你毫不犹豫下单的瞬间，也许是你悠闲喝咖啡的画面。</p>
    <p class="mb-2">找到那个动作，然后反复播放它。</p>
    <p class="mb-2">你看到那个数字了... 又看到了... 再一次看到了...</p>
    <p class="mb-2">每一次播放，都让那种富足的感觉更强烈一点。</p>
    <p class="mb-2">你越相信，它就越真实。</p>
    <p>💰 带着这份丰盛的感觉，慢慢入睡吧～钱宝宝正在来找你的路上。</p>
  `,
  '美貌自信': `
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8859C">🌙 第一阶段：身体放松（约2分钟）</div>
    ...
    <p class="mb-2">找一个舒服的姿势躺下来，闭上眼睛，轻轻地呼吸。</p>
    <p class="mb-2">从脚趾开始，一点一点往上放松。让全身的肌肉都柔软下来。</p>
    <p class="mb-2">放松你的脸，放松你的眉头，放松你的下巴。整张脸都变得柔软、舒展。</p>
    <p class="mb-4">你感觉很轻，很放松。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(184,169,201,0.12)">
      <div class="text-[10px] font-medium mb-1" style="color:#8B7E9C">☁️ 第二阶段：进入半梦半醒（约3分钟）</div>
    </div>
    <p class="mb-2">继续深呼吸。每一次吸气，都吸进光和美；每一次呼气，都呼出所有的不自信。</p>
    <p class="mb-2">你越来越困，越来越放松。眼皮越来越沉。</p>
    <p class="mb-4">就在这个似睡非睡的状态里。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(232,184,208,0.2)">
      <div class="text-[10px] font-medium mb-1" style="color:#D48BB0">✨ 第三阶段：构建场景（约5分钟）</div>
    </div>
    <p class="mb-2">现在，想象你站在一面镜子前。镜子里的你，美得发光。</p>
    <p class="mb-2">你的皮肤通透又有光泽，像剥了壳的鸡蛋一样。</p>
    <p class="mb-2">你的眼睛又大又亮，像星星一样，笑起来弯弯的，特别好看。</p>
    <p class="mb-2">你的五官精致立体，每一处都刚刚好。你看着镜子里的自己，忍不住笑了。</p>
    <p class="mb-2">你穿上了最喜欢的那件衣服，把身材衬托得完美极了。</p>
    <p class="mb-2">你走在街上，所有人都忍不住回头看你。你能感受到他们欣赏的目光。</p>
    <p class="mb-2">但你并不在意，因为你知道自己很美。你走路带风，自信又从容。</p>
    <p class="mb-2">你喜欢你自己，你爱你自己的样子。</p>
    <p class="mb-4">感受这份美丽、这份自信、这份自我接纳。就好像它已经是真的一样。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(245,230,200,0.25)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8955A">✨ 第四阶段：循环锚点（约5分钟）</div>
    </div>
    <p class="mb-2">现在，从这个场景里，选出一个最让你心动的瞬间。</p>
    <p class="mb-2">也许是你看到镜子里的自己笑了的那一刻，也许是你自信地走在街上的画面。</p>
    <p class="mb-2">找到那个瞬间，然后反复播放它。</p>
    <p class="mb-2">你笑了... 又笑了... 再一次笑了...</p>
    <p class="mb-2">每一次播放，都让那种自信的感觉更强烈一点。</p>
    <p>✨ 带着这份闪耀的感觉，慢慢入睡吧～你本来就很美。</p>
  `,
  '情绪疗愈': `
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(201,216,232,0.25)">
      <div class="text-[10px] font-medium mb-1" style="color:#6B8BA8">🌙 第一阶段：身体放松（约2分钟）</div>
    </div>
    <p class="mb-2">找一个舒服的姿势躺下来，闭上眼睛，轻轻地呼吸。</p>
    <p class="mb-2">从脚趾开始，一点一点往上放松。让全身的肌肉都柔软下来。</p>
    <p class="mb-2">如果心里有什么不舒服的感觉，没关系，允许它在那里。不用推开它。</p>
    <p class="mb-4">你很安全，你很放松。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(184,169,201,0.12)">
      <div class="text-[10px] font-medium mb-1" style="color:#8B7E9C">☁️ 第二阶段：进入半梦半醒（约3分钟）</div>
    </div>
    <p class="mb-2">继续深呼吸。每一次吸气，都吸进光和爱；每一次呼气，都呼出所有的沉重。</p>
    <p class="mb-2">你越来越困，越来越放松。眼皮越来越沉。</p>
    <p class="mb-4">就在这个似睡非睡的状态里。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(136,200,152,0.2)">
      <div class="text-[10px] font-medium mb-1" style="color:#5A9C6A">🌿 第三阶段：构建场景（约5分钟）</div>
    </div>
    <p class="mb-2">现在，想象你身处一个最安全、最温暖的地方。</p>
    <p class="mb-2">也许是一片柔软的草地，阳光暖暖地照在你身上。</p>
    <p class="mb-2">也许是一片宁静的海边，海浪轻轻拍打着沙滩。</p>
    <p class="mb-2">也许是一间温馨的小木屋，壁炉里的火在噼啪作响。</p>
    <p class="mb-2">找到属于你的那个安全的地方。在那里，你是完全安全的。</p>
    <p class="mb-2">你可以放下所有的防备，所有的面具。你可以做最真实的自己。</p>
    <p class="mb-2">你可以哭，可以笑，可以发呆，可以什么都不做。一切都是被允许的。</p>
    <p class="mb-2">阳光照在你身上，暖暖的。风轻轻吹过，很温柔。</p>
    <p class="mb-2">你感觉心里的伤口在慢慢愈合，就像花儿在慢慢绽放。</p>
    <p class="mb-4">感受这份深深的平静、这份治愈、这份自我接纳。</p>
    
    <div class="mb-3 p-3 rounded-xl" style="background:rgba(245,230,200,0.25)">
      <div class="text-[10px] font-medium mb-1" style="color:#B8955A">✨ 第四阶段：循环锚点（约5分钟）</div>
    </div>
    <p class="mb-2">现在，从这个场景里，选出一个最让你安心的画面。</p>
    <p class="mb-2">也许是阳光洒在你脸上的感觉，也许是海浪的声音，也许是壁炉的火光。</p>
    <p class="mb-2">找到那个画面，然后反复播放它。</p>
    <p class="mb-2">你感受到那份温暖了... 又感受到了... 再一次感受到了...</p>
    <p class="mb-2">每一次播放，都让那种平静的感觉更深一点。</p>
    <p>🧘 带着这份安宁的感觉，慢慢入睡吧～一切都会好起来的。</p>
  `,
};
...
// 显化入门7课
const COURSES = [
  { title: '第1课：自我概念 - 你是谁就会吸引什么', summary: '显化的核心不是改变外面，而是改变你对自己的看法。',
    content: `
      ...
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">为什么自我概念是显化的核心？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">因为你永远无法得到超出你"自我概念"的东西。如果你内心觉得"我不配"，就算好东西来了，你也会潜意识地把它推开。</p>
      ...
      <div class="p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
        ...
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75">写下10条"我是..."的正面肯定语，每天早晚各念一遍。</p>
      </div>
    ` },
  { title: '第2课：活在终点 - 感觉就是秘密', summary: '活在愿望已经实现的状态里。',
    content: `
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">潜意识听不懂语言，只听得懂感觉。你有什么样的感觉，就会吸引什么样的现实。</p>
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">怎么做？</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
    ...
    ` },
  { title: '第3课：精神节食 - 小心你的每一个念头', summary: '你的注意力在哪里，能量就流向哪里。',
    content: `
      ...
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li>坚持：21天养成新的思维习惯</li>
      </ol>
    ` },
  { title: '第4课：SATS - 睡眠状态下的显化', summary: '睡前半梦半醒时，是进入潜意识的黄金窗口。',
    content: `
  ...
  { title: '第6课：行动 - 灵感行动不是硬逼自己', summary: '行动不是努力，是状态对齐后的自然流动。',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">显化需要行动吗？</h4>
    ...
    ` },
  { title: '第7课：复盘 - 显化是可以练习的技能', summary: '每一次显化都是在积累"我能行"的证据。',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">为什么要复盘？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人说"显化不准"，是因为他们只记得没成的，忘了成的。复盘能帮你积累"我总能星愿成真"的信念。</p>
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">复盘什么？</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li>大小显化都记录：哪怕是"想喝奶茶就有人请"这种小事</li>
        <li>记录你当时的状态：你是怎么想的？什么感觉？</li>
        <li>总结规律：什么样的状态下，你显化得最快？</li>
...
const BOOKS = [
  { title: '《感觉就是秘密》', author: '内维尔·戈达德', color1: '#B8A9C9', color2: '#8B7E9C',
    summary: '显化圣经级著作，核心一句话：改变你的感觉，就能改变你的现实。',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">内维尔·戈达德（Neville Goddard）是20世纪最伟大的显化导师之一，出生于巴巴多斯，后移居美国纽约。他原本是一名舞蹈演员，后来遇到了他的导师阿卜杜拉，开始研究意识法则。他一生写了十多本书，做了上千场演讲，影响了无数人，被后人称为「显化界的教父」。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">这听起来有点难以接受，对不对？「难道我被人欺负也是我的错吗？」不是「错」，是「创造」。不是你活该被欺负，是你潜意识里的某些信念，让你吸引了这样的经历。而既然是你创造的，你就可以改变它。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人学吸引力法则，以为「想」什么就能吸引什么。他们每天想「我要发财」「我要变美」，但生活没什么变化。为什么？因为内维尔说：不是「想法」创造现实，是「感觉」创造现实。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">宇宙听不懂你的「话」，它读的是你的「心」。你心里是什么感觉，你就会吸引什么。你感觉贫穷，就会吸引贫穷的经历；你感觉孤独，就会吸引孤独的经历；你感觉被爱，就会吸引被爱的经历。</p>
      ...
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点三：潜意识是土壤</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">内维尔把意识分成两部分：意识和潜意识。意识是「园丁」，潜意识是「土壤」。你在潜意识里种下什么种子（感觉），它就会长出什么果实（现实）。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">潜意识有几个特点：①它不分好坏，你给它什么它就接受什么；②它不懂得「不」「没有」「别」这些否定词，你说「我不要生病」，它听到的是「生病」；③它是靠「感觉」来沟通的，不是靠语言；④它24小时不停工作，从不休息。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>问题是：大多数人不知道自己在潜意识里种了什么种子。</b>他们每天抱怨、焦虑、担心、嫉妒、怨恨，这些负面的感觉，就像毒种子一样，种在潜意识的土壤里，然后长出各种各样的「问题」。他们还奇怪：「为什么我的人生这么不顺？」</p>
      <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>好消息是：</b>土壤是中性的。它会长出毒草，也会长出鲜花。关键在于你种什么。从今天开始，有意识地给你的潜意识种下「好种子」——爱、感恩、喜悦、满足、丰盛的感觉。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>为什么活在终点这么重要？</b>因为宇宙回应的是你的「状态」，不是你的「愿望」。你处于「我没有」的状态，就会持续创造「没有」的现实。你处于「我已经有了」的状态，就会创造「拥有」的现实。</p>
      ...
      <ol class="text-sm space-y-1 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li><b>用终点状态说话。</b>把「我想要」改成「我有」，把「我希望」改成「我知道」。比如不说「我希望能找到对象」，要说「我的对象超级爱我」。</li>
        <li><b>用终点状态思考。</b>遇到事情时，问自己：「已经拥有的我会怎么想？会怎么做？」然后就那么想、那么做。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🌙 核心方法二：SATS睡前冥想</h4>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>为什么这个状态这么重要？</b>因为在这个状态下，你的「意识门卫」（也就是评判、分析、怀疑的那部分）睡着了，这时候你给潜意识输入的东西，会直接被接收，没有任何抗拒。就像土壤在晚上最容易吸收养分一样。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>为什么精神节食这么重要？</b>因为你的注意力在哪里，能量就流向哪里。你天天想负面的东西，你就会吸引更多负面的经历。你天天想正面的东西，你就会吸引更多正面的经历。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>具体怎么做：</b></p>
      <ol class="text-sm space-y-1 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>觉察你的念头。</b>大多数时候，我们的念头是自动运行的，我们根本没意识到自己在想什么。第一步就是「看见」你的念头。</li>
        <li><b>给念头分类。</b>这个念头是正面的？还是负面的？是我想要的？还是我不想要的？</li>
        <li><b>负面念头来了，不抗拒，替换它。</b>不要骂自己「我怎么又想坏事了」，那样只会给它更多能量。轻轻地把它替换成一个正面的念头。</li>
      ...
      <ul class="text-sm space-y-2 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li><b>误区二：每天焦虑地检查「显化了没」。</b>检查就是在说「我还没有」，会把愿望推得更远。</li>
        <li><b>误区三：急于求成，三天没效果就放弃。</b>显化需要时间发酵。就像种子种下去，你不能每天挖出来看。</li>
        ...
        <li><b>误区六：显化就是什么都不用做，等着天上掉馅饼。</b>不对。当你真的进入状态，你会有灵感、会有行动的冲动。行动是显化的一部分，不是靠行动「挣」来的，是行动自然发生。</li>
      </ul>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">A：问自己三个问题：①我真的进入「已经拥有」的感觉了吗？还是只是在脑子里「想」？②我是不是天天在检查「显化了没」？③我是不是只在练的时候才想，平时又打回原形了？找到问题，调整方法，继续坚持。</p>
      <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：显化有时间限制吗？多久能见效？</b></p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">A：没有固定时间。越小的事、你越不执着的事，显化越快。越大的事、你越焦虑的事，显化越慢。关键不在于时间，在于你有没有真的进入「已经拥有」的状态。</p>
      <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：如果我想显化的事情涉及到别人，可以吗？</b></p>
      <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">A：可以，但有一个前提：不要违背别人的自由意志。你可以显化「一个爱我的人」，但不要强迫某个特定的人爱你。因为强迫别人，最终痛苦的是你自己。</p>
      ...
      <div class="p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
        ...
        <ol class="text-xs space-y-1 list-decimal list-inside" style="color:var(--theme-text); opacity:0.75">
          ...
          <li>第8-14天：活在终点练习——每天5分钟进入终点状态</li>
          <li>第15-21天：SATS睡前冥想——每晚带着愿望实现的感觉入睡</li>
        </ol>
  ...
  { title: '《天赋的力量》', author: '内维尔·戈达德', color1: '#A898BC', color2: '#7B6B90',
    ...
    content: `
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">《天赋的力量》是内维尔·戈达德晚年的著作，比《感觉就是秘密》更深入、更形而上。如果说《感觉就是秘密》讲的是「方法」，这本书讲的就是「本质」——你到底是谁？你为什么能显化？</p>
      ...
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li>把显化当成「工具」——显化是你本来就有的能力，不是一个需要学习的技能</li>
      </ul>
    ...
    ` },
  { title: '《潜意识的力量》', author: '约瑟夫·墨菲', color1: '#9DB5C8', color2: '#6B8BA8',
    summary: '潜意识是你人生的总设计师，学会和它合作，你就能创造奇迹。',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">约瑟夫·墨菲（Joseph Murphy）是著名的潜意识权威、演讲家和作家。他花了近50年研究人类的潜意识，写了30多本书。《潜意识的力量》是他最著名的代表作，全球销量超过千万册。</p>
      
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 核心观点</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">你的潜意识是无穷的力量。它24小时不停工作，它控制着你95%的行为和决定。它像一片肥沃的土地，你种下什么种子（想法），它就会长出什么果实（现实）。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">意识是「园丁」，潜意识是「土壤」。你在潜意识里种下什么，你就会在现实中收获什么。问题是：大多数人种下的都是恐惧、焦虑、怀疑的种子，却奇怪为什么收获的是痛苦和失败。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 核心方法一：睡前暗示</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">睡前是进入潜意识的黄金窗口。当你快要睡着时，你的意识处于「休眠」状态，这时候你说的话、想的事，会直接进入潜意识。所以睡前千万不要想烦恼的事，要想美好的事！</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 核心方法二：重复肯定</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">不断重复正面信念，它就会渗透到你的潜意识里。就像水滴石穿，一开始你可能不相信，但说得多了，潜意识就会把它当成「事实」。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>正确的肯定语公式：</b>用现在时 + 用正面词 + 注入情感。比如不说「我不会再穷了」，要说「我越来越富有」。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 核心方法三：视觉化</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">在脑海中播放已经实现的画面，越细节越好。潜意识分不清「真实」和「想象」，只要你想象得足够逼真、足够有感觉，它就会把它当成真的，然后帮你实现它。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 常见误区</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li>用「否定词」——潜意识听不懂「不」，说「我不紧张」只会让你更紧张</li>
        <li>一边说肯定语一边怀疑——这等于没说，甚至更糟</li>
        <li>急于求成——潜意识的改变需要时间，就像种子发芽需要时间</li>
        <li>只在「有问题」的时候才想起用潜意识——平时就要养护它</li>
      </ul>
      ...
      <div class="p-3 rounded-xl" style="background:rgba(201,216,232,0.25)">
        ...
        <p class="text-xs leading-relaxed" style="color:var(--theme-text); opacity:0.75">选一个你最想改变的方面，写一句3-5个字的简短肯定语。每天睡前重复10遍，说的时候想象它已经是真的。坚持21天，看看你会有什么变化～</p>
      </div>
    ` },
  { title: '《有求必应》', author: '亚伯拉罕·希克斯', color1: '#E8C87A', color2: '#D4A85A',
    ...
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 关于这本书</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">亚伯拉罕·希克斯（Abraham Hicks）是由埃丝特·希克斯传导的非物质存在的 teachings。《有求必应》是最核心的一本书，它提出了著名的「22级情绪刻度表」，告诉你情绪不是随机的，而是你与本源能量对齐程度的精准指示器。</p>
      
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 核心观点</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">情绪是你的导航系统。好的感觉说明你在对齐你想要的，坏的感觉说明你偏离了。你不需要「做」什么来显化，你只需要「感觉好」——当你感觉好的时候，你想要的一切都会自然流向你。</p>
  ...
  { title: '《失落的幸福经典》', author: '佛罗伦斯·西恩', color1: '#E8B8D0', color2: '#D48BB0',
    ...
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">佛罗伦斯·西恩（Florence Scovel Shinn）是20世纪初美国最著名的灵性导师之一。她的书语言非常轻松、幽默，充满了真实的小故事。《失落的幸福经典》是她的代表作，薄薄一本，但影响了无数人。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">佛罗伦斯最有名的一句话是：「你说的话，就是你人生的咒语。」你每天说的话，都在给你的人生「下命令」。所以说话要非常小心，只说你想要的，不说你不想要的。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 核心方法一：话语的力量</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">你的每一句话都是一个肯定语。不要说「我好穷」「我好胖」「我好倒霉」——这些话都会变成现实。要说「我越来越富有」「我越来越美」「我总是很幸运」。</p>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">当你有一个「突然想做某事」的冲动时，立刻去做。那是宇宙在给你指路。佛罗伦斯说，很多人显化不成功，就是因为他们「想太多、做太少」——等他们想明白了，机会已经走了。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 核心方法三：游戏心态</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">把人生当成一场游戏，不要太当真。你越放松、越好玩，显化就越快。你越紧张、越焦虑，显化就越慢。就像玩游戏的时候，你越放松，越容易通关。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 常见误区</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li>说话不注意——随口抱怨的话也会「显化」</li>
        <li>太认真、太用力——越用力越推远</li>
        <li>忽略直觉——直觉是最快的显化路径</li>
  ...
  { title: '《秘密》', author: '朗达·拜恩', color1: '#D4A5B8', color2: '#B87590',
    summary: '把吸引力法则带给全世界的现象级畅销书。',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 关于这本书</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">2006年，一部叫《秘密》的纪录片横空出世，然后是同名书籍，迅速风靡全球，销量超过3000万册。作者朗达·拜恩是一位澳大利亚电视制作人，她在人生最低谷的时候发现了「吸引力法则」，然后用它改变了自己的人生。</p>
      
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 核心观点</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">吸引力法则：同类相吸。你关注什么，就会吸引什么到你的生命里。你想好事，好事就来；你想坏事，坏事就来。就像磁铁一样，你的思想会把和它同频的东西吸引过来。</p>
      ...
      <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>第二步：相信</b>——相信它已经是你的了。不是「它会来」，而是「它已经来了」。相信是吸引力法则中最重要的一步。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>第三步：接收</b>——感受已经拥有的感觉。你感觉越好，你和你想要的东西就越同频，它就来得越快。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">🔑 进阶技巧：感恩</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">感恩是最快的「频率提升器」。当你感恩的时候，你处于最高频的状态。每天感恩你已经拥有的，你就会吸引更多值得感恩的东西。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 常见误区</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li>以为只要「想想」就行——关键是「感觉」和「相信」</li>
        <li>一边想好事一边担心——担心就是在吸引你担心的事</li>
        <li>三天没效果就放弃——显化需要时间，就像种子发芽需要时间</li>
  ...
  { title: '《零极限》', author: '乔·维泰利', color1: '#A898BC', color2: '#7B6B90',
    ...
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 关于这本书</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">《零极限》讲的是夏威夷疗法（Ho'oponopono），一种古老的夏威夷疗愈方法。它的核心只有四句话：「对不起」「请原谅我」「谢谢你」「我爱你」。就这么简单，但它的效果却不可思议。</p>
  ...
  { title: '《思考致富》', author: '拿破仑·希尔', color1: '#88C898', color2: '#5A9C6A',
    ...
    content: `
      ...
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li><b>自我暗示</b>：每天重复你的目标，让它进入潜意识</li>
      ...
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">希尔在书中说，所有伟大的成功者都有「第六感」——也就是直觉。他们会跟随自己的直觉做决定，而不是只靠逻辑分析。直觉其实就是你的潜意识在给你传递信息。</p>
   ...
   { title: '《当下的力量》', author: '埃克哈特·托利', color1: '#A8D0C8', color2: '#6BA89C',
     summary: '活在当下，是所有灵性教导的核心。你的痛苦，都来自于你不在当下。',
     content: `
       <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">埃克哈特·托利（Eckhart Tolle）是当代最伟大的灵性导师之一。他年轻时经历过一次彻底的觉醒，从长期的抑郁和焦虑中解脱出来。之后他开始分享自己的领悟，《当下的力量》成为了全球畅销书，被翻译成30多种语言，影响了数千万人。</p>
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>显化的秘密：</b>为什么很多人显化不成功？因为他们一直在想「未来我要得到什么」，这等于在说「我现在没有」。而当你活在当下，你就处于「存在」的状态，不是「想要」的状态。存在的状态，才是显化最快的状态。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">臣服不是放弃行动，是放弃「对结果的执着」。你可以很努力地去做一件事，但你不焦虑结果。你享受做事的过程，你信任宇宙的安排。你尽力了，然后把结果交给宇宙。</p>
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>关键提示：</b>当你发现自己又跟着想法跑了，不要批评自己。轻轻地把注意力带回来就好。每一次「带回来」，都是一次觉醒。</p>
       ...
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 常见误区</h4>
       <ul class="text-sm space-y-2 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
         <li><b>误区一：</b>「活在当下就是不用努力了」——不对。活在当下是更高效地努力，因为你不内耗了，全部能量都用在当下的行动上。</li>
         ...
         <li><b>误区五：</b>「只有打坐冥想才算练习」——不对。生活中的每一件事都是练习。吃饭、走路、洗碗、工作，都可以是修行。</li>
       </ul>
       ...
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：活在当下和显化有什么关系？</b></p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">A：显化的核心是「状态」。当你活在当下，你就处于「存在」的状态，这是最高频的状态。在这种状态下，你的愿望会自然地流向你，因为你不再用「想要」「焦虑」「怀疑」把它们推远了。</p>
       ...
       <div class="p-3 rounded-xl" style="background:rgba(168,208,200,0.2)">
         ...
         <p class="text-xs mt-2" style="color:var(--theme-text); opacity:0.75">坚持21天，你会发现你的内心变得越来越平静，显化也会越来越顺利～</p>
       </div>
     ` },
   { title: '《被讨厌的勇气》', author: '岸见一郎 / 古贺史健', color1: '#F0C878', color2: '#D4A050',
     ...
     content: `
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>和显化的关系：</b>当你有了共同体感觉，你就不再需要从别人那里「求」认可了。你知道你是有价值的，你不需要证明给任何人看。这种「我足够好」的感觉，就是显化的最佳状态。</p>
       ...
       <ul class="text-sm space-y-2 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
         ...
         <li><b>误区三：</b>「阿德勒心理学否定过去，太极端了」——不是否定过去的影响，是否定「过去决定一切」。过去有影响，但你不是过去的奴隶。你现在的选择，更重要。</li>
       ...
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：被讨厌的勇气和显化有什么关系？</b></p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">A：显化最大的卡点之一，就是「在意别人的眼光」。你想做一件事，但你怕别人说你「异想天开」「不切实际」。当你有了被讨厌的勇气，你就不再被别人的看法限制了。你敢想、敢做、敢成为你自己，显化自然就快了。</p>
   ...
   { title: '《生命的重建》', author: '露易丝·海', color1: '#F0B8C8', color2: '#D48098',
     summary: '爱自己，是一切疗愈的开始。你的身体和你的人生，都是你思想的结果。',
     content: `
       <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">露易丝·海（Louise Hay）是全球知名的心灵导师、作家和演讲家。她的人生经历非常坎坷：从小被父母虐待，5岁被性侵，十几岁就离家出走，十几岁就生了孩子又不得不送人，后来又得了癌症。但她靠自己的力量，从身体到心灵都彻底疗愈了。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">露易丝·海最核心的观点就是：你生命中发生的一切，都是你自己创造的。不是说你「故意」创造了痛苦，而是你潜意识里的信念，吸引了相应的人和事来到你的生命里。</p>
       ...
       <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
         ...
         <li><b>女性问题：</b>不接纳自己的女性身份、压抑女性能量</li>
       </ul>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>注意：</b>不是说身体问题都是「想出来的」，也不是让你不去看医生。身体问题需要医学治疗，但同时，如果你能看到它背后的心理根源，疗愈会更彻底、更快。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>比如：</b>如果你小时候妈妈总是忽略你，你就会觉得「我是不值得被关注的」，长大之后，你就会总是吸引忽略你的人。不是因为你倒霉，是因为你的潜意识在「重复」熟悉的模式。</p>
       ...
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点四：爱自己，是一切疗愈的开始</h4>
       ...
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点五：镜子练习——最有效的疗愈方法</h4>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>第8-14天：加入肯定语</b>——除了「我爱你」，再加上你最需要的肯定语。比如「我值得被爱」「我值得拥有美好的一切」「我接纳我自己原本的样子」。每一句说5遍。</p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>第15-21天：深度疗愈</b>——看着镜子里的自己，和小时候的自己对话。对那个小小的你说：「我在这里，我陪着你，我爱你，你安全了。」可以一边说一边哭，没关系，眼泪是疗愈的一部分。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>第二步：把每一条负面信念改成正面肯定语。</b>比如「我不够好」改成「我值得世间一切美好」；「赚钱很难」改成「钱宝宝轻松地流向我」。要用现在时，要用正面的词。</p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>第三步：每天读、每天说。</b>把这些正面肯定语写在便签上，贴在你每天都能看到的地方。每天早晚各读一遍，读的时候尽量去感受那句话的真实感。</p>
       ...
       <ul class="text-sm space-y-2 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
         ...
         <li><b>误区五：</b>「疗愈是一次性的，一次就好」——不对。疗愈是一个过程，会有反复。有时候你觉得好了，过段时间又难受了，这很正常。这不是退步，是更深层的东西浮现出来了，继续爱自己就好。</li>
       </ul>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">❓ 常见问题</h4>
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：我做镜子练习的时候会哭，正常吗？</b></p>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">A：非常正常。哭是疗愈的一部分。那些眼泪，是你压抑了很久的情绪。让它们流出来就好。哭完你会觉得轻松很多。</p>
       ...
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：生命的重建和显化有什么关系？</b></p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">A：显化的核心是「你是谁」，你就会吸引什么。当你真正爱自己、接纳自己、觉得自己值得的时候，你自然会吸引美好的人和事。你不需要「努力」去显化，你只需要成为那个对的人，一切都会自然到来。</p>
   ...
   { title: '《秘密副作用》', author: '李欣频', color1: '#C8A8D0', color2: '#9878B0',
     summary: '你以为你在显化，其实你在逃避。揭穿10个显化误区，带你看到真正的卡点。',
     content: `
       <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">👤 作者介绍</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">李欣频是台湾著名的广告人、作家、旅行家。她写过很多书，涉及创意、旅行、心灵成长等多个领域。《秘密副作用》是她最有代表性的作品之一——她不是来「教你怎么显化」的，她是来「揭穿显化的假象」的。</p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">很多人学了吸引力法则之后，反而更焦虑了：「我怎么还没显化？」「是不是我信念不够强？」「是不是我哪里做错了？」李欣频说：你越急着显化，越显化不了。因为你在「急」的状态里，就是在说「我还没有」。这本书，就是帮你看到你自己都没察觉的那些「显化卡点」。</p>
       
       <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 核心观点一：你以为你在「求」，其实你在「逃」</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人想要显化某样东西，以为自己是在「追求美好」，但其实，他们是在「逃避痛苦」。比如：</p>
       <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>问题在哪里？</b>「逃避」的能量是恐惧的能量。你越怕什么，就越会吸引什么。因为你的注意力放在了「我不要的东西」上，而宇宙听不懂「不」，它只会听到你在想什么，然后给你更多。</p>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点二：你不是在「创造」，你是在「填补匮乏」</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">李欣频说：很多人学显化，其实是因为他们觉得「我现在不够好」「我现在的人生不够好」，所以我要「创造」一个更好的人生。但这种「我不够好」的感觉，本身就是最大的卡点。</p>
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>那怎么办？</b>先停下来，不要急着「显化」什么。先看看你现在的人生，有没有什么是你已经拥有、却被你忽略了的？有没有什么是你已经很幸福、却习以为常的？感恩你已经拥有的，你的杯子才会慢慢变满。</p>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点三：你设定的「目标」，可能是你的「牢笼」</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人会说：「我要在X年内赚到X万」「我要在X岁之前结婚」「我要考上X大学」。他们以为这是「明确的目标」，有助于显化。但李欣频说：太具体的目标，反而会限制你。</p>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>为什么？</b>因为你能想到的「最好」，是基于你过去的经验和认知。但宇宙能给你的，远远超出你能想象的。如果你死死抓住你设定的那个目标，你可能会错过更好的。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人学显化，是因为他们「有问题要解决」——缺钱、缺爱、不开心。他们学显化，是为了「解决问题」。但李欣频说：你越关注「问题」，就会创造越多的「问题」。</p>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>为什么？</b>因为当你把某件事定义为「问题」，你就给了它能量。你天天想「我怎么解决这个问题」，你就是在天天喂养这个问题。它会变得越来越大，越来越难解决。</p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>那怎么办？</b>把注意力从「问题」移开，放到「你想要的状态」上。不是「我要解决缺钱的问题」，而是「我享受丰盛的感觉」。不是「我要解决单身的问题」，而是「我享受被爱和爱人的感觉」。</p>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">💡 核心观点五：「正面思考」不是强迫自己只想好的</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人学了吸引力法则之后，就开始强迫自己「只能想好事，不能想坏事」。一有负面想法，就批评自己：「我怎么又想坏事了，这样会显化不好的东西！」结果反而更焦虑了。</p>
       ...
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>怎么做：</b>你想显化某样东西，先问问自己：「如果我得到了它，我能逃避什么？」「我是因为热爱而想要，还是因为恐惧而想要？」</p>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>举个例子：</b>你想显化很多钱。问自己：「如果我有了很多钱，我能逃避什么？」答案可能是：「我就不用再担心没钱了」「我就不用被别人看不起了」「我就可以证明我自己了」。</p>
       ...
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 方法二：「终点状态」切换法</h4>
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>为什么有效？</b>因为同频相吸。你处于什么频率，就会吸引什么频率的人和事。你先进入「开心」「安心」「满足」的频率，那些能让你开心、安心、满足的人和事，自然会被你吸引过来。</p>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 方法三：「删除目标」练习</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>怎么做：</b>把你所有的「显化目标」都写在一张纸上，然后——把那张纸撕掉。告诉宇宙：「我不要这些了，我把选择权交给你。你给我的，一定是最好的。」</p>
       ...
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8"><b>注意：</b>不是「放弃」，是「放下执念」。你还是可以努力、还是可以追求你想要的，但你不焦虑结果、不执着于「必须是这样」。你尽力了，然后信任宇宙的安排。</p>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 方法四：「每日调频」——把自己调到「已经拥有」的频率</h4>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>早上：</b>醒来第一件事，想3件你感恩的事。不用是什么大事，「今天天气真好」「我睡得很好」「有早餐吃」都可以。感恩是最快的调频器。</p>
       ...
       <ul class="text-sm space-y-2 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
         ...
         <li><b>误区二：</b>「目标越具体，显化越快」——不一定。太具体的目标会限制你，宇宙可能有更好的安排。</li>
         <li><b>误区三：</b>「只能想正面的，不能想负面的」——不对。越压抑负面想法，它们力量越大。允许它们存在，但不跟随它们。</li>
         <li><b>误区四：</b>「显化就是什么都不用做，等着天上掉馅饼」——不对。显化是「内外一致」，内在调整好了，外在的行动会自然发生。你会有灵感、会有动力、会想做事。</li>
         <li><b>误区五：</b>「没显化就是我信念不够强」——不对。可能不是信念的问题，是你方向错了，或者你想要的东西其实不是你真正想要的。</li>
       </ul>
       
       <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">❓ 常见问题</h4>
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：如果我什么目标都不要了，那我会不会什么都得不到？</b></p>
       <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">A：恰恰相反。当你放下「必须得到什么」的执念，你反而会得到更多、更好的。因为你不再用你的「小脑袋」限制宇宙了。宇宙能给你的，比你能想到的，好一万倍。</p>
       ...
       <p class="text-sm mb-2" style="color:var(--theme-text); opacity:0.8"><b>Q：这本书和其他显化书有什么不一样？</b></p>
       <p class="text-sm mb-4" style="color:var(--theme-text); opacity:0.8">A：大多数显化书是「教你怎么显化」，这本书是「帮你看到你为什么显化不了」。它像一面镜子，照出你自己都没察觉的卡点。很多人读完之后会说：「原来我一直在自欺欺人。」看见就是改变的开始。</p>
...
const GUIDES = [
  { title: 'SP恋爱显化', icon: '💖', color: 'pink',
    ...
    ` },
  { title: '财富事业显化', icon: '💰', color: 'amber',
    summary: '吸引更多金钱，提升事业运',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">核心原理</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">金钱是能量，它会流向感觉自己值得拥有财富的人。</p>
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">具体步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>清理金钱卡点</b>：找出你对金钱的负面信念</li>
        <li><b>建立新的金钱观</b>：钱是好的，钱是轻松的，钱爱我</li>
        <li><b>感恩练习</b>：对每一笔花出去和进来的钱说谢谢</li>
        <li><b>活在终点</b>：想象你已经财富自由的生活</li>
        <li><b>跟随灵感行动</b>：赚钱的灵感来了就去做</li>
      </ol>
    ` },
  { title: '美貌自信显化', icon: '✨', color: 'rose',
    ...
    content: `
      ...
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li><b>肯定语</b>：每天听美貌相关的肯定语</li>
        <li><b>爱自己的行动</b>：认真护肤、好好吃饭、运动</li>
      </ol>
    ` },
  { title: '原生家庭疗愈', icon: '🏠', color: 'purple',
    summary: '疗愈童年创伤，和父母和解',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">核心原理</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">原生家庭的模式会无意识地重复在你现在的生活里。看见它、疗愈它，你才能真正自由。</p>
      ...
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        ...
        <li><b>内在小孩疗愈</b>：回去抱抱小时候的自己</li>
        <li><b>与父母和解</b>：不是原谅他们，是放过自己</li>
        <li><b>重新养育自己</b>：做自己的好父母</li>
      </ol>
    ` },
  { title: '考试学习显化', icon: '📚', color: 'blue',
    summary: '考试上岸、提升学习效率',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">核心原理</h4>
...
// 显化方法大全
const METHODS = [
  { id: 'living_end', name: '活在终点', icon: '🎯', color: '#D4A5B8',
    summary: '以愿望已经实现的状态去生活',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">宇宙回应的是你的「状态」，不是你的「愿望」。不是你想要什么就给你什么，而是你是什么状态，就给你什么状态对应的东西。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">就像收音机：你调到什么频率，就收到什么节目。你想要「富有」的节目，你就得先调到「富有」的频率。不是等节目来了再调频率，是先调频率，节目自然就来了。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>清晰化终点</b>：你的愿望实现后，具体是什么样子？越细节越好。你住在哪里？你每天做什么？你和谁在一起？你的心情怎么样？</li>
        <li><b>找到「终点感觉」</b>：愿望实现后，你最核心的感觉是什么？是安心？是满足？是喜悦？找到那个感觉，它是你最宝贵的东西。</li>
        <li><b>找一个「终点小动作」</b>：愿望实现后你会做的一个小动作。比如摸一下戒指、看一眼银行余额、拥抱一下那个人。</li>
        <li><b>每天「进入状态」5分钟</b>：闭上眼睛，做那个小动作，感受那种「已经拥有」的感觉。每天至少5分钟。</li>
        <li><b>用终点状态说话</b>：把「我想要」改成「我有」，把「我希望」改成「我知道」。比如不说「我希望能找到对象」，要说「我的对象超级爱我」。</li>
        <li><b>用终点状态思考</b>：遇到事情时，问自己：「已经拥有的我会怎么想？会怎么做？」然后就那么想、那么做。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>表演式活在终点</b>：嘴上说「我很有钱」，心里却焦虑得要死——没用的，宇宙读的是心</li>
        <li><b>24小时逼自己</b>：不用逼自己每时每刻都活在终点，每天有几分钟真的感受到就够了</li>
        <li><b>天天检查「显化了没」</b>：检查就是在说「我还没有」，会把愿望推远</li>
        <li><b>只在「做练习」的时候活在终点</b>：平时又打回原形，等于白练</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
        <div class="text-xs font-medium mb-1" style="color:#B8859C">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>从小事开始练。比如「今天有人请我喝奶茶」，练熟了再练大事。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>选一个小愿望，每天花5分钟进入终点状态。连续7天，看看会不会发生。</p>
      </div>
    ` },
  { id: 'self_concept', name: '自我概念修正', icon: '👑', color: '#B8A9C9',
    summary: '你是谁，就会吸引什么',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 为什么自我概念最重要？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">你永远无法得到超出你「自我概念」的东西。如果你内心觉得「我不配」，就算好东西来了，你也会潜意识地把它推开。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">自我概念就像一个「设定值」。你的体重有一个设定值，你的收入有一个设定值，你的感情状态也有一个设定值。不管外界怎么变，你最后都会回到那个设定值上。要改变结果，先改变设定值。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>觉察：找出你的负面信念</b>——拿一张纸，写下你对自己的所有负面信念。比如「我不够好」「我不值得被爱」「我赚不到大钱」。想到什么写什么，不用评判。</li>
        <li><b>拆解：这些信念从哪里来？</b>——每一个负面信念，都有一个来源。可能是小时候爸妈说的话，可能是某次失败的经历，可能是别人对你的评价。看见它的来源，你就会发现：它不是事实，只是一个旧故事。</li>
        <li><b>替换：把每一个负面信念改成正面肯定语</b>——比如「我不够好」改成「我值得世间一切美好」；「我赚不到大钱」改成「我轻松就能赚到很多钱」。注意：要用现在时，要用正面词。</li>
        <li><b>重复：每天念、每天听</b>——每天早晚各念10遍，或者录下来反复听。重复是改变潜意识的钥匙。</li>
        <li><b>验证：找证据证明新信念是真的</b>——每天找3个证据，证明你的新自我概念是对的。比如新信念是「我很受欢迎」，证据可以是「今天同事对我笑了」「朋友圈有人给我点赞」。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>念的时候不相信</b>——没关系，先从「愿意相信」开始，慢慢就会真的相信</li>
        <li><b>三天打鱼两天晒网</b>——自我概念是几十年形成的，改变需要时间，坚持21天再说</li>
        <li><b>只改表面不改核心</b>——比如只想改「我要变美」，但核心信念「我不值得被爱」没动，效果就有限</li>
        <li><b>因为「没效果」而放弃</b>——改变是渐进的，某一天你会突然发现：咦，我怎么变了？</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(184,169,201,0.12)">
        <div class="text-xs font-medium mb-1" style="color:#8B7E9C">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>把肯定语写在便签上，贴在你每天都能看到的地方（镜子、手机壁纸、电脑桌面）。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>选一个你最想改变的自我概念，写一句对应的肯定语。每天早晚各念10遍，连续21天。</p>
      </div>
    ` },
  { id: 'sats', name: 'SATS冥想', icon: '🌙', color: '#9DB5C8',
    summary: '睡前半梦半醒时的强效显化',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">SATS = State Akin To Sleep，类似睡眠的状态。睡前半梦半醒时，你的意识（也就是「评判者」）处于休眠状态，这时候你给潜意识输入的东西，会直接被接收，没有任何抗拒。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">这就是为什么「睡前想什么，什么就容易成真」。古人说「日有所思，夜有所梦」，其实反过来也成立：夜有所梦，日有所成。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>准备阶段</b>：躺下来，调整到最舒服的姿势。关掉手机，确保不会被打扰。可以放一点轻柔的音乐，也可以安静。</li>
        <li><b>放松身体（约2分钟）</b>：从脚趾开始，一点一点往上放松。脚趾放松、脚掌放松、小腿放松、大腿放松、腹部放松、胸部放松、手臂放松、肩膀放松、脖子放松、脸部放松、头皮放松。每放松一个部位，就感觉它变得沉重、温暖。</li>
        <li><b>进入状态（约3分钟）</b>：继续深呼吸。你会发现自己越来越困，快要睡着了，但还有一丝清醒。不要睡着，保持在这个「半梦半醒」的状态。</li>
        <li><b>构建场景（约5分钟）</b>：在脑海中构建一个愿望实现后的简短场景。不用很长，10秒就够了。比如：你收到了录取通知书、你和喜欢的人拥抱、你看到银行卡里的数字。用第一视角，调动所有感官：看到什么？听到什么？摸到什么？闻到什么？心里什么感觉？</li>
        <li><b>循环场景（直到睡着）</b>：把这个简短的场景反复播放，就像循环播放一段短视频。每播放一遍，就强化一遍感觉。直到你自然睡着。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>场景太长太复杂</b>——不用想完整的一天，一个10秒的小场景就够了</li>
        <li><b>第三视角看自己</b>——要用第一视角，用你自己的眼睛去看</li>
        <li><b>画面不清晰就焦虑</b>——画面不重要，感觉才重要。画面模糊没关系，感觉到位了就行</li>
        <li><b>还没进入状态就开始想</b>——先放松，等身体真的放松了再开始</li>
        <li><b>做着做着睡着了</b>——没关系！这很正常，睡着反而更好，说明你真的进入状态了</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(201,216,232,0.25)">
        <div class="text-xs font-medium mb-1" style="color:#6B8BA8">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>选一个「锚点动作」，比如握手、摸戒指、签字。每次循环场景的时候，都重复这个动作。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>今晚就试一次！选一个小愿望，睡前花5-10分钟做SATS。连续做7天，看看效果～</p>
      </div>
    ` },
  { id: 'revision', name: '修正法', icon: '🕊️', color: '#88C898',
    summary: '在想象中改写过去的负面记忆',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">过去不决定未来，你对过去的看法才影响现在。一件事发生了就过去了，但你对它的「解读」和「感觉」会一直留在你心里，持续影响你现在的生活。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">修正法就是：在想象中改写一件让你受伤的事，给它一个美好的结局。当你真的在「感觉」层面改写了它，它对你的负面影响就会消失。就像你改了一个旧文件，旧版本就不存在了。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>选一件事</b>：选一件让你不舒服、遗憾、受伤的事。<b>新手从小事开始</b>，不要一上来就处理最深的创伤。比如「今天被领导说了一句」就可以。</li>
        <li><b>放松身体</b>：闭上眼睛，深呼吸，让身体放松下来。可以先做5分钟的呼吸放松。</li>
        <li><b>回到场景</b>：在想象中回到那个场景，看到当时的自己，看到当时发生的事。不用回避，就只是看着它。</li>
        <li><b>改写结局</b>：把事情的发展改成你想要的样子，越细节越好。比如领导批评你，改成领导表扬你；比如被人拒绝，改成对方欣然同意。</li>
        <li><b>感受新结局</b>：感受那个美好结局带来的轻松、释然、满足的感觉。在那个感觉里多待一会儿。</li>
        <li><b>重复3-5遍</b>：把改写后的场景反复播放3-5遍，每一遍都加深那种美好的感觉。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>一上来就处理大创伤</b>——从小事开始练，练熟了再处理大事</li>
        <li><b>用脑子「想」而不是用心「感受」</b>——关键是感觉，不是逻辑</li>
        <li><b>觉得「这是自欺欺人」</b>——你对过去的「解读」本来就是主观的，换一个解读有何不可？</li>
        <li><b>做一次就期待完全好</b>——深的伤口需要多次清理，每次做都会好一点</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(136,200,152,0.2)">
        <div class="text-xs font-medium mb-1" style="color:#5A9C6A">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>每天晚上睡觉前，把当天发生的「不好」的小事都修正一遍。养成习惯，你会发现你的生活越来越顺。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>今晚就选一件最近让你不舒服的小事，做一次修正法练习。做完之后，感受一下心里是不是轻松了一点？</p>
      </div>
    ` },
  { id: 'mental_diet', name: '精神节食', icon: '🧠', color: '#E8C87A',
    summary: '监控你的每一个念头',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">就像身体需要健康的食物一样，你的精神也需要健康的「念头食物」。你每天想什么，你就会变成什么。你的注意力在哪里，能量就流向哪里。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">大多数人每天脑子里有几万个念头，其中80%都是负面的。这些负面念头就像垃圾食品，吃多了精神就会「生病」——焦虑、抑郁、自我怀疑。精神节食就是：给你的念头「排毒」，只让美好的想法留下。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>觉察</b>：注意到自己在想负面的事情。这是最难的一步，因为大多数时候我们的念头是「自动」的。可以设置几个「提醒点」：每次看手机的时候、每次吃饭的时候、每次上厕所的时候，问自己：「我现在在想什么？」</li>
        <li><b>叫停</b>：一旦发现自己在想负面的事情，立刻对自己说：「停！我不继续想这个了。」可以在心里想象一个「停止」的标志，或者直接说「取消」。</li>
        <li><b>替换</b>：立刻换成一个正面的想法或画面。比如你在想「他不爱我」，立刻换成「他超级爱我」的画面。不用管「是不是真的」，先换了再说。</li>
        <li><b>坚持21天</b>：负面思维是几十年的习惯，改变需要时间。坚持21天，你会发现你的思维模式真的变了。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>因为「做不到」而自责</b>——一开始肯定做不到，没关系，每一次觉察都是胜利</li>
        <li><b>压抑负面情绪</b>——不是不让你有情绪，是不让你「反复咀嚼」负面想法。情绪来了就感受它，然后放它走</li>
        <li><b>只在「大事」上注意</b>——小事才是关键！每天那些小小的负面念头，积累起来威力巨大</li>
        <li><b>几天没效果就放弃</b>——21天养成一个习惯，坚持21天再说</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(245,230,200,0.25)">
        <div class="text-xs font-medium mb-1" style="color:#B8955A">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>手上戴一个橡皮筋，每次想负面事情的时候，就弹自己一下。痛觉会帮你快速打断负面思维。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>今天做一个「念头觉察」练习。设置3个闹钟，每次闹钟响的时候，记录一下你刚才在想什么。晚上看看，你今天有多少念头是正面的？多少是负面的？</p>
      </div>
    ` },
  { id: 'visualization', name: '视觉化', icon: '🎬', color: '#D4A5B8',
    summary: '在脑海中播放愿望实现的电影',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">潜意识分不清「真实」和「想象」。如果你能在想象中足够逼真地「看到」一件事，潜意识就会把它当成真的，然后帮你把它变成现实。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">这就是为什么运动员会在赛前「过一遍」动作——他们在脑子里练习，效果和真实练习差不多。你的大脑会为你「已经看到」的东西做准备。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 详细操作步骤</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>第一视角</b>：用你自己的眼睛去看，不是看别人的电影，也不是看「另一个自己」。你看到的应该是你自己的手、自己的脚、自己眼前的景象。</li>
        <li><b>多感官</b>：不仅「看」，还要调动所有感官。听到什么声音？摸到什么质感？闻到什么味道？甚至尝到什么味道？感官越多，越真实。</li>
        <li><b>找锚点动作</b>：找一个简单的动作作为「锚点」，比如握手、拥抱、签字、开门。每次视觉化的时候都重复这个动作，它会帮你更快进入状态。</li>
        <li><b>从小场景开始</b>：不用想完整的一天，一个10秒的小场景就够了。场景越短，你越容易集中注意力。</li>
        <li><b>加入情绪</b>：最重要的不是画面，是感觉。你心里是什么感觉？喜悦？满足？安心？把那种感觉放大。</li>
        <li><b>反复播放</b>：把这个小场景反复播放，就像循环播放一段视频。每次播放，感觉都会加深一点。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>画面不清晰就焦虑</b>——画面不重要，感觉才重要。有些人天生画面感强，有些人弱，没关系</li>
        <li><b>场景太长太复杂</b>——贪多嚼不烂，一个10秒的场景反复播放，比一个10分钟的场景效果好</li>
        <li><b>第三视角看自己</b>——一定要第一视角！第三视角效果差很多</li>
        <li><b>一边想一边怀疑</b>——「这会不会是假的？」——怀疑就是在抵消效果</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(240,213,224,0.15)">
        <div class="text-xs font-medium mb-1" style="color:#B8859C">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>如果画面感不好，可以先用「文字」写下来，读几遍，再闭上眼睛想。文字也能帮你构建场景。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>选一个小愿望，花10分钟写一个「愿望实现的场景」，越细节越好。然后每天读一遍，再闭上眼睛想3分钟。</p>
      </div>
    ` },
  { id: 'affirmations', name: '肯定语', icon: '💖', color: '#F0D5E0',
    summary: '用正面话语重塑你的潜意识',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">潜意识听不懂逻辑，但听得懂「重复」和「感觉」。你不断重复一句话，同时注入感觉，潜意识就会把它当成事实，然后帮你把它变成现实。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">很多人说肯定语没用，是因为他们方法不对。不是念得越多越好，是你「相信」的程度越深越好。一句你相信的肯定语，比一百句你怀疑的管用得多。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 正确用法</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>用现在时</b>：「我是」「我有」，不是「我将会」。说「我将会变美」等于在说「我现在不美」。</li>
        <li><b>用正面词</b>：说「我很瘦」，不说「我不胖」。潜意识听不懂「不」，你说「我不胖」，它听到的是「我胖」。</li>
        <li><b>阶梯式上升</b>：从你能相信的程度开始，逐步提高。比如你现在月入5000，不要一上来就说「我月入百万」——你自己都不信。先从「我月入8000」开始，相信了再往上加。</li>
        <li><b>带着感觉说</b>：不是念经，是真的感受到那句话的真实。说「我很富有」的时候，真的去感受那种富有的感觉。</li>
        <li><b>睡前听效果最好</b>：睡前半梦半醒时，意识最薄弱，这时候听肯定语，直接进入潜意识。可以录下来，睡前循环播放。</li>
        <li><b>配合视觉化</b>：说肯定语的时候，同时在脑海中看到对应的画面，效果加倍。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>一边念一边怀疑</b>——这等于白念，甚至更糟，因为你在强化「这不是真的」</li>
        <li><b>贪多求快</b>——一次选50条肯定语，每条念一遍，不如选3条，每条用心念10遍</li>
        <li><b>用否定词</b>——「我不焦虑」「我不胖」「我不缺钱」都是错误的</li>
        <li><b>三天打鱼两天晒网</b>——肯定语需要重复，每天坚持，21天才能看到明显变化</li>
        <li><b>只说不做</b>——肯定语是帮你调整状态，状态对了，行动会自然来</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(240,213,224,0.2)">
        <div class="text-xs font-medium mb-1" style="color:#B8859C">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>把肯定语录成音频，睡前循环播放。睡着的时候潜意识还在听，效果加倍。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>选一个你最想改变的方面，写3句肯定语。每天早晚各念10遍，念的时候尽量去感受那种感觉。坚持21天。</p>
      </div>
    ` },
  { id: 'scripting', name: '脚本法', icon: '📝', color: '#C9D8E8',
    summary: '写下来，让愿望更具体',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">写的过程就是「给潜意识编程」的过程。当你把一个愿望详细地写下来，你就在给潜意识发送一个清晰的指令：「我要这个。」</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">为什么写下来比只想更有效？因为写的时候，你同时动用了视觉、触觉、运动觉，多个感官一起参与，给潜意识的印象更深。而且写下来的过程中，你会把模糊的愿望变得具体清晰。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 怎么写？</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>用现在时写</b>：就像这件事正在发生一样，或者已经发生了一样。不用「我将要」，用「我是」「我有」「我正在」。</li>
        <li><b>用第一人称</b>：「我看到...」「我听到...」「我感觉到...」。用你自己的视角去写。</li>
        <li><b>越细节越好</b>：环境是什么样的？有什么人？你们在说什么？天气怎么样？你穿什么衣服？你手里拿着什么？细节越多，越真实。</li>
        <li><b>重点写感觉</b>：你心里是什么感觉？喜悦？满足？安心？骄傲？把那种感觉详细地写出来。感觉是显化的关键。</li>
        <li><b>写完读一遍</b>：带着感觉读一遍。读完之后，说一句「就是这样」或者「已经完成了」。</li>
        <li><b>然后放下</b>：写完就放下，不要天天拿出来看，更不要焦虑「怎么还没实现」。相信它已经在来的路上了。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">⚠️ 新手常见坑</h4>
      <ul class="text-sm space-y-1 list-disc list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>写得太笼统</b>——「我想要幸福的生活」太笼统了，具体是什么样的幸福？越具体越好</li>
        <li><b>用将来时</b>——「我将会...」等于在说「我现在还没有」</li>
        <li><b>写完天天看</b>——天天看就是在检查「实现了没」，就是在说「我还没有」</li>
        <li><b>只写不感受</b>——写的时候要真的去感受那种感觉，不是完成任务</li>
      </ul>
      
      <div class="p-3 rounded-xl" style="background:rgba(201,216,232,0.25)">
        <div class="text-xs font-medium mb-1" style="color:#6B8BA8">💡 小技巧 + 配套练习</div>
        <p class="text-xs mb-2" style="color:var(--theme-text); opacity:0.75"><b>技巧：</b>可以写「愿望实现的那一天」，从早上醒来到晚上睡觉，完整的一天。就像写日记一样，写你那一天做了什么、见了什么人、心情怎么样。</p>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75"><b>练习：</b>选一个你最想实现的愿望，写一篇「愿望实现的一天」，至少300字。写完读一遍，然后把它收起来，相信它已经在来的路上了～</p>
      </div>
    ` },
  { id: 'bedohave', name: 'BE-DO-HAVE模型', icon: '⚡', color: '#B8A9C9',
    summary: '先成为，再行动，再拥有',
    content: `
      <h4 class="font-title text-base mb-3" style="color:var(--theme-text)">💡 原理是什么？</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">大多数人的顺序是错的：他们以为「等我有了钱（HAVE），我就能做我想做的事（DO），然后我就会快乐（BE）」。但宇宙的顺序是反过来的：先BE（成为那个状态），然后DO（在那个状态下行动），最后自然会HAVE（拥有你想要的）。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8">比如：不是「等我有钱了，我就会自信」，而是「先做一个自信的人（BE），然后以自信的方式行动（DO），最后自然会拥有财富（HAVE）」。</p>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📝 怎么用这个模型？</h4>
      <ol class="text-sm space-y-2 list-decimal list-inside mb-3" style="color:var(--theme-text); opacity:0.8">
        <li><b>BE：先成为</b>——问自己：「已经拥有我想要的东西的那个人，是什么状态的？」她的心态是什么样的？她怎么看自己？她每天是什么感觉？找到那个状态，先进入那个状态。</li>
        <li><b>DO：再行动</b>——问自己：「在那个状态下的我，会做什么？」她会怎么说话？她会怎么做事？她会怎么对待自己？然后就那么去做。不是等你「有了」才那么做，是现在就那么做。</li>
        <li><b>HAVE：自然拥有</b>——当你BE了、DO了，HAVE是自然而然的结果。不用追，它会自己来。</li>
      </ol>
      
      <h4 class="font-title text-sm mb-2" style="color:var(--theme-text)">📌 举个例子</h4>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>错误顺序：</b>等我瘦了（HAVE），我就穿漂亮衣服（DO），然后我就会自信（BE）。</p>
      <p class="text-sm mb-3" style="color:var(--theme-text); opacity:0.8"><b>正确顺序：</b>先做一个自信的人（BE），然后穿漂亮衣服、好好打扮自己（DO），然后自然会变瘦变美（HAVE）。</p>
      
      <div class="p-3 rounded-xl" style="background:rgba(184,169,201,0.15)">
        <div class="text-xs font-medium mb-1" style="color:#8B7E9C">💡 配套练习</div>
        <p class="text-xs" style="color:var(--theme-text); opacity:0.75">拿一张纸，左边写「我想拥有什么」，中间写「拥有了它之后我会做什么」，右边写「拥有了它之后我会成为什么样的人（什么状态）」。然后，从今天开始，就以右边那个状态去生活～</p>
      </div>
    ` },
];
...
const MOVIE_LIBRARY = {
  selfGrowth: [
    ...
    { title: '风雨哈佛路', year: '2003', summary: '出身贫民窟的女孩靠自己的努力考上哈佛大学的真实故事。', insight: '你的出身不决定你的未来，你的选择才决定。当你真的想要某样东西，整个宇宙都会帮你。不是环境限制了你，是你对自己的认知限制了你。', audience: '觉得自己起点低、想改变命运、缺乏动力的人' },
    { title: '垫底辣妹', year: '2015', summary: '全年级倒数第一的辣妹用一年时间考上日本顶尖大学的真实故事。', insight: '相信是一种强大的力量。当有人相信你，你就会开始相信自己。而当你相信自己，奇迹就会发生。别人说你不行，不代表你真的不行。', audience: '觉得自己笨、学不会、不相信自己能做到的人' },
    ...
    { title: '楚门的世界', year: '1998', summary: '一个男人发现自己的整个人生都是一场真人秀的故事。', insight: '你看到的世界，是别人想让你看到的世界。你以为的「现实」，可能只是你被灌输的信念。当你开始质疑，你就开始觉醒了。', audience: '感觉人生像被安排、想觉醒、想突破限制的人' },
    ...
    { title: '放牛班的春天', year: '2004', summary: '一位音乐老师用音乐改变了一群问题少年的故事。', insight: '没有「坏孩子」，只有不被看见的孩子。当你被真正看见和接纳，你就会改变。每一个灵魂都值得被温柔以待，包括你自己的。', audience: '童年缺爱、觉得自己不被接纳、想疗愈内在小孩的人' },
    { title: '三傻大闹宝莱坞', year: '2009', summary: '三个大学好友用自己的方式对抗教育体制、找到人生方向的故事。', insight: '成功不是追来的，是当你做自己热爱的事时，自然到来的。不要问「我怎么成功」，要问「我热爱什么」。热爱是最高级的显化加速器。', audience: '不知道自己要什么、被成功学焦虑、想找到热爱的人' },
    ...
    { title: '寻梦环游记', year: '2017', summary: '一个男孩在亡灵世界找到家人和音乐梦想的故事。', insight: '家人的爱，是你最强大的后盾。真正的死亡，是被遗忘。而你被爱着，所以你永远不会真正消失。家族系统的力量，比你想象的更强大。', audience: '与家人关系不好、想疗愈家族创伤、寻找归属感的人' },
    ...
    { title: '怪兽电力公司', year: '2001', summary: '怪兽世界靠吓唬小孩获取电力，最后发现笑声比尖叫声能量更大。', insight: '恐惧是最低频的能量，爱和快乐才是最高频的。你以为你需要「恐惧」来驱动自己，但其实「快乐」的力量大得多。改变你的动机，你就改变了你的世界。', audience: '靠焦虑驱动、总是担心、想从恐惧模式切换到爱模式的人' },
    ...
    { title: '心灵奇旅', year: '2020', summary: '一个灵魂在投胎前寻找人生目标，最终发现活着本身就是意义。', insight: '人生不是必须要有「目标」才有意义。活着本身，就是最大的意义。你不需要「成为什么」「做到什么」才有价值，你存在本身就足够有价值。', audience: '找不到人生意义、焦虑迷茫、觉得自己一事无成的人' },
    ...
    { title: '冰雪奇缘', year: '2013', summary: '艾莎从害怕自己的魔法到接纳并掌控它的故事。', insight: '你的「不同」不是诅咒，是天赋。当你不再害怕自己的力量，你就真正自由了。你不需要压抑自己来迎合别人，你本来的样子就很美。', audience: '压抑真实自我、害怕自己的力量、不敢做自己的人' },
    ...
    { title: '蜘蛛侠：平行宇宙', year: '2018', summary: '多个宇宙的蜘蛛侠聚在一起，小黑蛛迈尔斯找到自己身份的故事。', insight: '每个人都可以是蜘蛛侠——意思是，每个人都有属于自己的英雄之路。你不需要跟别人一样，你有你自己的节奏。相信自己的那一跳，你就会飞起来。', audience: '觉得自己不够好、想找到自我价值、不自信的人' },
    { title: '奇迹男孩', year: '2017', summary: '一个面部有缺陷的男孩第一次上学、最终赢得所有人尊重的故事。', insight: '你的外表不定义你，你的内心才定义你。当你接纳了自己的「不一样」，别人也会接纳你。善良是一种选择，选择善良的人，最强大。', audience: '自卑、觉得自己不好看、不被接纳的人' },
    ...
    { title: '菊次郎的夏天', year: '1999', summary: '一个不靠谱的大叔陪一个小男孩去找妈妈的夏天故事。', insight: '大人也只是长大了的小孩，每个人心里都住着一个孩子。治愈别人的同时，你也在被治愈。爱出者爱返，福往者福来。', audience: '想疗愈内在小孩、觉得自己缺爱、想变得柔软的人' },
    ...
    { title: '龙猫', year: '1988', summary: '两姐妹在乡下和森林里的龙猫成为朋友的温暖故事。', insight: '相信的人，才能看见奇迹。孩子之所以能看见龙猫，是因为他们百分百相信。当你像孩子一样纯粹地相信，奇迹就会发生。', audience: '不再相信奇迹、变得「现实」、想找回童心的人' },
    ...
    { title: '哈尔的移动城堡', year: '2004', summary: '一个被诅咒变成老婆婆的女孩进入魔法师哈尔的移动城堡的故事。', insight: '当你不再在意外表，你反而获得了真正的自由。爱一个人，是爱他真实的样子，不是你期待他成为的样子。而你被爱，也是因为你真实的样子。', audience: '容貌焦虑、不自信、在感情里迷失自我的人' },
    { title: '魔女宅急便', year: '1989', summary: '一个小魔女离开家去独立生活、靠飞行能力开快递业务的故事。', insight: '每个人都有自己的「魔法」，你只需要找到它，然后用它来服务世界。当你做你热爱的事，你就不会觉得是在「工作」。', audience: '迷茫、找不到自己的天赋、想独立生活的人' },
    { title: '崖上的波妞', year: '2008', summary: '一条小鱼想变成人类和小男孩在一起的故事。', insight: '当你足够想要，你就会变成你想成为的样子。纯粹的愿望，有改变一切的力量。爱就是最大的魔法。', audience: '不相信爱情、觉得自己不配被爱、想找回纯粹感的人' },
    ...
    { title: '岁月的童话', year: '1991', summary: '一个都市女孩去乡下度假、回忆童年、重新思考人生的故事。', insight: '你以为你忘了的童年记忆，其实一直在影响你。看见过去的自己，你才能理解现在的自己。疗愈童年，就是疗愈现在。', audience: '迷茫、想了解自己、想疗愈童年的人' },
    ...
    { title: '风雨哈佛路', year: '2003', summary: '出身贫民窟的女孩靠自己的努力考上哈佛大学的真实故事。', insight: '你的出身不决定你的未来，你的选择才决定。当你真的想要某样东西，整个宇宙都会帮你。不是环境限制了你，是你对自己的认知限制了你。你可以选择继续在泥沼里抱怨，也可以选择爬出来。爬出来的过程可能很疼，但每一步都算数。你走过的每一步，都在塑造未来的你。', audience: '觉得自己起点低、想改变命运、缺乏动力的人' },
    { title: '垫底辣妹', year: '2015', summary: '全年级倒数第一的辣妹用一年时间考上日本顶尖大学的真实故事。', insight: '相信是一种强大的力量。当有人相信你，你就会开始相信自己。而当你相信自己，奇迹就会发生。别人说你不行，不代表你真的不行。说你不行的人，只是他们自己做不到而已。你的人生，你自己说了算。', audience: '觉得自己笨、学不会、不相信自己能做到的人' },
    ...
    { title: '钢琴家', year: '2002', summary: '一个犹太钢琴家在二战中艰难生存的真实故事。', insight: '在最黑暗的时刻，只要你还有热爱的东西，你就能活下去。音乐、艺术、热爱……这些东西是你灵魂的锚。不管环境多糟糕，守住你心里的那束光。', audience: '处于低谷、找不到活下去的意义的人' },
    ...
    { title: '绿皮书', year: '2018', summary: '一个黑人钢琴家和一个白人司机的公路旅行，改变了彼此的人生。', insight: '改变偏见，只需要一次真正的「看见」。当你真正了解一个人，你就会放下偏见。理解和包容，是最好的疗愈。', audience: '有偏见、容易评判别人和自己的人' },
    { title: '触不可及', year: '2011', summary: '一个瘫痪的富豪和一个刚出狱的护工成为朋友。', insight: '真正的朋友，是两个灵魂的平等对话，不是身份和地位的匹配。你不需要完美，也值得被爱。', audience: '孤独、觉得没人懂自己、渴望真友谊的人' },
    ...
    { title: '奔腾年代', year: '2003', summary: '一匹矮小的赛马和它的骑手、驯马师一起创造奇迹。', insight: '别人觉得你不行，不代表你真的不行。有时候，「不被看好」反而是一种优势——因为你没有包袱，你可以全力以赴。', audience: '不被看好、想逆袭、缺乏信心的人' },
    ...
    { title: '光辉岁月', year: '2000', summary: '一支混合种族的橄榄球队在黑人显化教练带领下夺冠的真实故事。', insight: '当大家目标一致，种族、肤色、背景都不重要。团结的力量，可以战胜一切偏见。', audience: '在团队中、被歧视、想找到归属感的人' },
    { title: '卡特显化教练', year: '2005', summary: '一个篮球显化教练用严格的纪律改变了一群问题少年的人生。', insight: '真正的成功不是赢了多少场比赛，是你变成了什么样的人。纪律不是束缚，是自由。对自己狠一点，你会感谢现在的自己。', audience: '缺乏自律、想改变自己的年轻人' },
  ...
  love: [
    ...
    { title: '爱在黎明破晓前', year: '1995', summary: '两个陌生人在火车上相遇，聊了一整晚的故事。', insight: '真正的连接，是灵魂的共鸣，不是条件的匹配。当你做真实的自己时，对的人自然会被你吸引。好的对话，就是最好的前戏。', audience: '想要灵魂伴侣、觉得遇不到懂自己的人的人' },
    ...
    { title: '电子情书', year: '1998', summary: '现实中是竞争对手的两个人，在网上却是灵魂伴侣。', insight: '你讨厌的人，可能恰恰是最懂你的人。不要被第一印象和标签限制。灵魂的连接，比现实的身份更重要。', audience: '注重外在条件、忽略灵魂共鸣的人' },
    ...
    { title: '简爱', year: '2011', summary: '一个家庭女教师和庄园主的平等爱情故事。', insight: '好的爱情，是平等的。你不需要卑微，也不需要高傲。你和他，灵魂是平等的。你是谁，比你拥有什么更重要。', audience: '在感情里自卑、觉得自己配不上的人' },
    ...
    { title: '人鬼情未了', year: '1990', summary: '丈夫被杀后变成鬼魂，守护在妻子身边的故事。', insight: '真正的爱，不会因为死亡而消失。你的灵魂永远记得你爱过的人。爱比死亡更强大。', audience: '不相信永恒的爱、经历过生离死别的人' },
    ...
    { title: '暮光之城', year: '2008', summary: '一个人类女孩和吸血鬼相爱的奇幻爱情故事。', insight: '真正的爱，可以跨越一切障碍——种族、年龄、甚至生死。当你真的爱一个人，你愿意为他等待，也愿意为他改变。', audience: '相信灵魂伴侣、渴望深刻爱情的人' },
    ...
    { title: '不能说的秘密', year: '2007', summary: '一个钢琴男生和一个神秘女生的穿越爱情故事。', insight: '有些相遇，是命中注定的。你以为的「巧合」，其实都是缘分。能遇见彼此，就已经很幸运了。', audience: '相信缘分、喜欢宿命感爱情的人' },
    ...
    { title: '断背山', year: '2005', summary: '两个牛仔之间跨越二十年的爱情故事。', insight: '有些爱，只能藏在心里。但它不会因为被隐藏就不存在。真正的爱，和性别无关，只和灵魂有关。', audience: '不被世俗接纳、在感情里有压力的人' },
    ...
    { title: '爱在黎明破晓前', year: '1995', summary: '两个陌生人在火车上相遇，聊了一整晚的故事。', insight: '真正的连接，是灵魂的共鸣，不是条件的匹配。当你做真实的自己时，对的人自然会被你吸引。好的对话，就是最好的前戏。你不需要伪装成别人喜欢的样子，做你自己，对的人自然会留下来。', audience: '想要灵魂伴侣、觉得遇不到懂自己的人的人' },
    { title: '爱在日落黄昏时', year: '2004', summary: '九年后，两人在巴黎重逢，再一次聊了一下午。', insight: '有些人，你以为错过了，但缘分还会把你们带回来。如果你们是同频的，不管绕多少圈，都会再遇见。时间和距离都不是问题，灵魂的吸引才是最强大的力量。', audience: '心里有放不下的人、相信缘分的人' },
    { title: '爱在午夜降临前', year: '2013', summary: '又一个九年，两人结婚生子，面对真实的婚姻生活。', insight: '爱情不只有浪漫，还有柴米油盐和争吵。但真正的爱，是吵完架还想继续在一起。完美的爱情不存在，但真实的爱情更珍贵。', audience: '对婚姻失望、感情进入平淡期的人' },
    { title: '泰坦尼克号', year: '1997', summary: '一段发生在泰坦尼克号上的跨越阶级的凄美爱情。', insight: '真正的爱，会让你成为你自己。Jack赢了那张船票，是他这辈子最幸运的事——因为他遇见了Rose，也让Rose找回了自己。爱一个人，是让她自由。', audience: '渴望轰轰烈烈的爱情、觉得生活平淡的人' },
    { title: '罗马假日', year: '1953', summary: '一个出逃的公主和一个记者在罗马度过一天的爱情故事。', insight: '真正的爱情，不一定非要拥有。有些相遇，哪怕只有一天，也足以铭记一生。爱不是占有，是成全。', audience: '占有欲强、在感情里抓太紧的人' },
    ...
    { title: '人鬼情未了', year: '1990', summary: '丈夫被杀后变成鬼魂，守护在妻子身边。', insight: '真正的爱，不会因为死亡而消失。你的灵魂永远记得你爱过的人。爱比死亡更强大。', audience: '不相信永恒的爱、经历过生离死别的人' },
    { title: '诺丁山', year: '1999', summary: '一个普通书店老板和一个大明星相爱的故事。', insight: '爱情不分身份地位。当你真心喜欢一个人，你就有勇气站在她面前。你不需要完美，你只需要真诚。', audience: '自卑、觉得自己配不上喜欢的人的人' },
    { title: 'BJ单身日记', year: '2001', summary: '一个有点胖、有点笨的普通女孩的爱情故事。', insight: '你不需要完美才能被爱。真实的你，就足够好了。爱你的人，会爱你的全部，包括你的不完美。', audience: '不自信、觉得自己不够好、单身焦虑的人' },
    { title: '恋爱假期', year: '2006', summary: '两个失恋的女人交换房子度假，各自遇到新的爱情。', insight: '换个环境，换个心情，你就会遇到新的人。不要困在过去的悲伤里，走出去，新的爱情在等你。', audience: '刚失恋、走不出来、想换个心情的人' },
  ...
  career: [
    { title: '当幸福来敲门', year: '2006', summary: '一个穷途末路的单亲爸爸靠努力逆袭成为股票经纪人的真实故事。', insight: '当你真的想要什么，整个宇宙都会帮你。你经历的每一次「失去」，都是在为「得到」腾位置。低谷不是终点，是反弹的起点。', audience: '处于事业低谷、想搞钱、想逆袭的人' },
    { title: '华尔街之狼', year: '2013', summary: '股票经纪人乔丹·贝尔福特从暴富到堕落的真实故事。', insight: '金钱不是目的，是工具。如果你赚钱的动机是「恐惧」和「匮乏」，那多少钱都不够。真正的富有，是内心的丰盛。', audience: '想搞钱但动机不对、被金钱焦虑驱动的人' },
    ...
    { title: '飞行家', year: '2004', summary: '霍华德·休斯——既是天才又是疯子的航空大亨传奇一生。', insight: '你的「疯狂」，可能恰恰是你的天赋。当你对一件事有极致的热爱，你就能创造奇迹。但记得，平衡也很重要。', audience: '有梦想、想创业、追求极致的人' },
    ...
    { title: '华尔街', year: '1987', summary: '一个年轻股票经纪人在金钱和道德之间选择的故事。', insight: '「贪婪是好的」这句话，最终会让你付出代价。赚钱很重要，但有些东西比钱更重要——比如你的底线和你的灵魂。', audience: '搞金融/销售、容易在金钱中迷失的人' },
    ...
    { title: '钢铁侠', year: '2008', summary: '一个军火商被绑架后，造出钢铁侠战衣改变人生。', insight: '你经历的「灾难」，可能恰恰是你觉醒的契机。你以为的「失去」，其实是「得到」的开始。', audience: '经历挫折、想找到人生方向的人' },
    ...
    { title: '奇迹男孩', year: '2017', summary: '面部有缺陷的男孩上学并赢得尊重的故事。', insight: '你不需要靠外表赢得尊重，你靠的是你的品格和善良。当你接纳了自己的不一样，世界也会接纳你。', audience: '自卑、觉得自己不够好、职场新人' },
    ...
    { title: '垫底辣妹', year: '2015', summary: '年级倒数第一的女孩用一年考上顶尖大学。', insight: '相信是一种强大的力量。当有人相信你，你就会开始相信自己。而当你相信自己，奇迹就会发生。', audience: '觉得自己笨、学不会、想考证/升学的人' },
    ...
    { title: '华尔街之狼', year: '2013', summary: '股票经纪人乔丹·贝尔福特从暴富到堕落的真实故事。', insight: '金钱不是目的，是工具。如果你赚钱的动机是「恐惧」和「匮乏」，那多少钱都不够。真正的富有，是内心的丰盛。靠恐惧驱动赚来的钱，最终会以某种方式流走。', audience: '想搞钱但动机不对、被金钱焦虑驱动的人' },
    ...
    { title: '华尔街', year: '1987', summary: '一个年轻股票经纪人在金钱和道德之间选择。', insight: '「贪婪是好的」这句话，最终会让你付出代价。赚钱很重要，但有些东西比钱更重要——比如你的底线和你的灵魂。', audience: '搞金融/销售、容易在金钱中迷失的人' },
    { title: '猫鼠游戏', year: '2002', summary: '一个天才骗子和FBI探员猫鼠游戏的真实故事。', insight: '你的聪明才智，用在正道上，会让你很成功；用在歪道上，只会让你越陷越深。天赋要用在对的地方。', audience: '聪明但没用对地方、想走捷径的人' },
    { title: '战争之王', year: '2005', summary: '一个军火商的发家史和堕落史。', insight: '你可以赚很多钱，但如果你的钱是建立在别人的痛苦上，你永远不会真正快乐。心安，比钱多更重要。', audience: '对赚钱方式有疑惑、价值观冲突的人' },
    { title: '钢铁侠', year: '2008', summary: '一个军火商被绑架后，造出钢铁侠战衣改变人生。', insight: '你经历的「灾难」，可能恰恰是你觉醒的契机。你以为的「失去」，其实是「得到」的开始。', audience: '经历挫折、想找到人生方向的人' },
  ...
  healing: [
    { title: '海蒂和爷爷', year: '2015', summary: '一个孤儿女孩和爷爷在阿尔卑斯山生活的温暖故事。', insight: '大自然是最好的疗愈师。当你觉得累了，就去看看山、看看云、看看树。你不需要做什么，你只需要「在」。', audience: '焦虑内耗、城市病、想找回平静的人' },
    ...
    { title: '海街日记', year: '2015', summary: '四姐妹在镰仓一起生活的温暖日常故事。', insight: '家人的陪伴，是最好的疗愈。哪怕什么都不做，只是在一起吃饭、聊天、看海，就很治愈了。', audience: '孤独、缺爱、渴望温暖连接的人' },
    { title: '心灵奇旅', year: '2020', summary: '一个灵魂在投胎前寻找人生目标，最终发现活着本身就是意义。', insight: '人生不是必须要有「目标」才有意义。活着本身，就是最大的意义。你不需要「成为什么」才有价值，你存在本身就足够有价值。', audience: '找不到人生意义、焦虑迷茫、内耗的人' },
    { title: '寻梦环游记', year: '2017', summary: '男孩在亡灵世界找到家人和音乐梦想。', insight: '真正的死亡，是被遗忘。只要你还记得，爱你的人就永远活着。家族的爱，是你最强大的后盾。', audience: '经历失去、想念逝去的亲人、想疗愈家族创伤的人' },
    ...
    { title: '龙猫', year: '1988', summary: '两姐妹在乡下和森林里的龙猫成为朋友。', insight: '相信的人，才能看见奇迹。孩子之所以能看见龙猫，是因为他们百分百相信。当你像孩子一样纯粹地相信，奇迹就会发生。', audience: '不再相信美好、变得「现实」、想找回童心的人' },
    ...
    { title: '哈尔的移动城堡', year: '2004', summary: '被诅咒变成老婆婆的女孩进入魔法师哈尔的城堡。', insight: '当你不再在意外表，你反而获得了真正的自由。爱一个人，是爱他真实的样子。你被爱，也是因为你真实的样子。', audience: '容貌焦虑、不自信、在感情里迷失的人' },
    { title: '魔女宅急便', year: '1989', summary: '小魔女离开家独立生活，靠飞行开快递。', insight: '每个人都有自己的「魔法」，你只需要找到它。当你做你热爱的事，你就不会觉得是在「工作」。', audience: '迷茫、找不到天赋、想独立生活的人' },
    { title: '崖上的波妞', year: '2008', summary: '小鱼想变成人类和小男孩在一起。', insight: '当你足够想要，你就会变成你想成为的样子。纯粹的愿望，有改变一切的力量。爱就是最大的魔法。', audience: '不相信纯粹的爱、变得复杂、想找回简单的人' },
    ...
    { title: '岁月的童话', year: '1991', summary: '都市女孩去乡下度假，回忆童年、思考人生。', insight: '你以为你忘了的童年记忆，其实一直在影响你。看见过去的自己，你才能理解现在的自己。疗愈童年，就是疗愈现在。', audience: '迷茫、想了解自己、想疗愈童年的人' },
    ...
    { title: '声之形', year: '2016', summary: '一个曾经霸凌过听障女孩的男生长大后想赎罪的故事。', insight: '犯错不可怕，可怕的是不敢面对。道歉和原谅，是最好的疗愈。原谅别人，也是放过自己。', audience: '有愧疚感、无法原谅自己或他人的人' },
    ...
    { title: '菊次郎的夏天', year: '1999', summary: '不靠谱的大叔陪小男孩去找妈妈的夏天。', insight: '大人也只是长大了的小孩。治愈别人的同时，你也在被治愈。爱出者爱返，福往者福来。', audience: '想疗愈内在小孩、觉得自己缺爱的人' },
    { title: '小鞋子', year: '1997', summary: '贫穷的兄妹共用一双鞋子上学的温暖故事。', insight: '你拥有的不多，但你拥有的已经足够让你幸福。幸福不是拥有得多，是计较得少。', audience: '匮乏感强、总觉得自己不够、焦虑的人' },
    { title: '奇迹男孩', year: '2017', summary: '面部有缺陷的男孩上学并赢得尊重。', insight: '善良是一种选择，选择善良的人最强大。你不需要完美，你只需要善良。当你接纳了自己，世界也会接纳你。', audience: '自卑、不接纳自己、被欺负的人' },
    ...
    { title: '绿皮书', year: '2018', summary: '一个黑人钢琴家和一个白人司机的公路旅行。', insight: '改变偏见，只需要一次真正的「看见」。当你真正了解一个人，你就会放下偏见。理解和包容，是最好的疗愈。', audience: '有偏见、容易评判别人和自己的人' },
    { title: '触不可及', year: '2011', summary: '一个瘫痪的富豪和一个刚出狱的护工成为朋友。', insight: '真正的朋友，是两个灵魂的平等对话，不是身份和地位的匹配。你不需要完美，也值得被爱。', audience: '孤独、觉得没人懂自己、渴望真友谊的人' },
    ...
    { title: '楚门的世界', year: '1998', summary: '男人发现自己的人生是一场真人秀。', insight: '你以为的「现实」，可能只是你被灌输的信念。当你开始质疑，你就开始觉醒了。', audience: '感觉人生像被安排、想觉醒、想突破限制的人' },
    ...
    { title: '一条狗的使命', year: '2017', summary: '一只狗转世几次，最终回到最初的主人身边。', insight: '生命是轮回的，爱也是。你以为失去了的，会以另一种方式回来。爱不会消失，它只是换了个样子。', audience: '经历过失去、不相信永恒的人' },
    ...
    { title: '布达佩斯大饭店', year: '2014', summary: '一个传奇门童和他的门生的冒险故事。', insight: '在混乱的世界里，保持你的优雅和善良。这是你对这个世界最好的反抗。', audience: '觉得世界很糟、容易悲观、想保持内心美好的人' },
    ...
    { title: '美食、祈祷和恋爱', year: '2010', summary: '一个女人在意大利、印度、巴厘岛寻找自我。', insight: '你不需要靠别人来完整你。你可以一个人吃美食、一个人旅行、一个人找到内心的平静。你自己，就足够完整。', audience: '刚分手、想找回自我、在感情里迷失的人' },
    ...
    { title: '海蒂和爷爷', year: '2015', summary: '一个孤儿女孩和爷爷在阿尔卑斯山生活的温暖故事。', insight: '大自然是最好的疗愈师。当你觉得累了，就去看看山、看看云、看看树。你不需要做什么，你只需要「在」。别人说的「应该」不一定适合你，你知道什么让你开心，就去做什么。你的快乐，是你人生最好的指南针。', audience: '焦虑内耗、城市病、想找回平静的人' },
    ...
    { title: '你的名字', year: '2016', summary: '两个少年少女在梦中交换身体。', insight: '你要找的人，也在找你。你们的缘分，早就写好了。相信你会遇见对的人，你就一定会遇见。', audience: '单身、期待爱情、相信缘分的人' },
    { title: '天气之子', year: '2019', summary: '一个少年和一个能控制天气的少女的故事。', insight: '你以为你需要「拯救世界」，但其实你最需要拯救的，是你自己的心。比起天气晴朗，你更重要。', audience: '总是为别人着想、忽略自己感受的人' },
    { title: '声之形', year: '2016', summary: '曾经霸凌过听障女孩的男生长大后想赎罪。', insight: '犯错不可怕，可怕的是不敢面对。道歉和原谅，是最好的疗愈。原谅别人，也是放过自己。', audience: '有愧疚感、无法原谅自己或他人的人' },
    { title: '菊次郎的夏天', year: '1999', summary: '不靠谱的大叔陪小男孩去找妈妈的夏天。', insight: '大人也只是长大了的小孩。治愈别人的同时，你也在被治愈。爱出者爱返，福往者福来。', audience: '想疗愈内在小孩、觉得自己缺爱的人' },
...
function finishTutorial() {
  ...
  localStorage.setItem('cosmos_tutorial_done', '1');
...
function playTypeSound() {
  ...
  playSound('type');
  typingSoundTimeout = setTimeout(() => { typingSoundTimeout = null; }, 60);
}
...
function updateTimeAndWeather() {
  ...
  if (emojiEl) emojiEl.textContent = isNight ? (weather === 'rainy' ? '🌧️' : weather === 'cloudy' ? '☁️' : '🌙') : WEATHER_EMOJIS[weather];
  if (textEl) textEl.textContent = isNight ? '夜晚' : WEATHER_NAMES[weather];
  if (settingEl) settingEl.textContent = state.weather === 'auto' ? '自动（随情绪）' : WEATHER_NAMES[state.manualWeather];
}
...
function openModule(name) {
  ...
  if (name === 'library') { switchTab('library'); return; }
  if (name === 'sky') { switchTab('me'); return; }
  if (name === 'wishwall') renderWishWall();
  ...
  if (name === '369') { showPage('369'); init369(); return; }
  if (name === '55x5') { showPage('55x5'); init55x5(); return; }
  if (name === 'signs') { showPage('signs'); initSigns(); return; }
  if (name === 'wheel') { showPage('wheel'); initWheel(); return; }
  if (name === '68sec') { showPage('68sec'); init68sec(); return; }
  ...
  if (name === 'treasurebox') { showPage('treasurebox'); initTreasureBox(); return; }
...
function renderJournalTab() {
  document.getElementById('journal-stat-wishes').textContent = state.wishes.length;
  document.getElementById('journal-stat-purify').textContent = state.purify.total || 0;
  document.getElementById('journal-stat-flowers').textContent = (state.garden.flowers || []).filter(f => f.done).length;
  ...
  document.getElementById('journal-stat-days').textContent = days;
...
function playAffirmCategory(cat) {
  ...
  affirmPlayer.idx = 0;
  document.getElementById('affirm-player').classList.remove('hidden');
  document.getElementById('now-playing-cat').textContent = catData.name;
  showAffirmText();
  startAffirmPlay();
}
function playAffirmSubcat(cat, sub) {
  ...
  affirmPlayer.idx = 0;
  document.getElementById('affirm-player').classList.remove('hidden');
  document.getElementById('now-playing-cat').textContent = catData.name + ' · ' + subData.name;
  showAffirmText();
  startAffirmPlay();
}
function showAffirmText() {
  if (affirmPlayer.list.length === 0) return;
  document.getElementById('now-playing-text').textContent = affirmPlayer.list[affirmPlayer.idx];
...
function toggleAffirmPlay() {
  if (affirmPlayer.playing) {
    ...
    document.getElementById('affirm-play-btn').textContent = '▶️';
  } else {
    startAffirmPlay();
  }
}
...
function logDiet(type) {
  ...
  document.getElementById('diet-negative').textContent = t.negative;
  document.getElementById('diet-caught').textContent = t.caught;
  document.getElementById('diet-replaced').textContent = t.replaced;
...
function openBadgeWall() { showToast('🏆 完成成就解锁徽章～'); }
...
function initSettingsUI() {
  // 音量
  document.getElementById('vol-music-val').textContent = state.volumes.music + '%';
  document.querySelector('#vol-music-val + input').value = state.volumes.music;
  // 找到三个滑块并设置值
  ...
  // 密码状态
  document.getElementById('password-status').textContent = state.password ? '已设置' : '未设置';
  const pwdToggle = document.getElementById('toggle-password');
  if (state.passwordEnabled) pwdToggle.classList.add('on');

  // 时间
  document.getElementById('meditation-time').value = state.meditationTime;
  document.getElementById('affirm-time').value = state.affirmTime;
}
...
function setupPassword() {
  ...
  pinTemp = '';
  updatePinDots();
  document.getElementById('pin-hint').textContent = '请设置4位密码';
  ...
  if (pinCurrent.length === 4) {
    setTimeout(() => {
      if (pinMode === 'set') {
        ...
        pinMode = 'confirm';
        updatePinDots();
        document.getElementById('pin-hint').textContent = '请再次输入密码确认';
        ...
        if (pinCurrent === pinTemp) {
          ...
          document.getElementById('pin-hint').textContent = '两次输入不一致，请重新设置';
          pinCurrent = '';
          pinTemp = '';
          pinMode = 'set';
          updatePinDots();
...
function togglePassword() {
  ...
  el.classList.toggle('on');
  document.getElementById('password-status').textContent = state.passwordEnabled ? '已开启' : '已关闭';
  playSound('ding');
}

function saveReminderTime() {
  state.meditationTime = document.getElementById('meditation-time').value;
  state.affirmTime = document.getElementById('affirm-time').value;
  saveState();
  showToast('提醒时间已保存 ⏰');
}
...
function clearCache() {
  if (confirm('确定要清除所有数据吗？这将删除你所有的记录哦～')) {
    localStorage.removeItem('cosmos_island_state_v3');
    location.reload();
  }
}
...
function renderGrowth() {
  const start = state.startDate ? new Date(state.startDate) : new Date();
  const days = Math.max(1, Math.ceil((Date.now() - start.getTime()) / (1000 * 60 * 60 * 24)));
  document.getElementById('growth-days').textContent = days;
  document.getElementById('growth-wishes').textContent = state.wishes.length;
  document.getElementById('growth-manifested').textContent = state.wishes.filter(w => w.done).length;
  document.getElementById('growth-purify').textContent = state.purify.total || 0;
...
function checkDailyReset() {
  ...
  if (lastReset !== today) {
    state.todayDone = {};
    state.purify.todayCount = 0;
    state.mentalDiet.todayCount = 0;
    state.garden.todayCount = 0;
...
// 发送原生通知（优先使用 Service Worker，支持页面关闭时推送）
...
function renderTestQ() {
  ...
  c.innerHTML = `
    ...
    <h3 class="font-title text-base mb-5 text-center" style="color:var(--theme-text)">${q.q}</h3>
...
function calcPersona(scores) {
  ...
  if (topDiff < total * 0.05) {
    ...
    const map = {
      ...
      'charm+stable': 'camellia',
    };
    if (map[pair]) return map[pair];
  }

  if (top === 'charm') return second === 'action' ? 'rose' : 'camellia';
...
function finishTest() {
  ...
  if (testState.type === 'personality' || testState.type === 'personality_deep') {
    ...
    const isNew = !state.unlockedPersonas.includes(pid);
    if (isNew) state.unlockedPersonas.push(pid);
    if (!state.mainPersona) state.mainPersona = pid;
    ...
    const total = action + create + empathy + stable + charm;
    const aPct = Math.round(action/total*100);
    const cPct = Math.round(create/total*100);
    const ePct = Math.round(empathy/total*100);
    const sPct = Math.round(stable/total*100);
    const chPct = Math.round(charm/total*100);
  ...
  document.getElementById('test-content').innerHTML = resultHtml;
  triggerConfetti();
  playSound('bloom');
}
...
function renderTower() {
  ...
  document.getElementById('purify-day').textContent = streak;
  document.getElementById('purify-progress').style.width = Math.min(streak / 21 * 100, 100) + '%';
  document.getElementById('purify-total').textContent = state.purify.total || 0;
  document.getElementById('purify-today').textContent = state.purify.todayCount || 0;
  document.getElementById('purify-streak').textContent = streak;
  ...
  document.getElementById('purify-tip').textContent = tips[streak % tips.length];
  renderPurifyStats();
}
...
function nextCBTStep(step) {
  // 验证当前步骤
  if (step === 2) {
    const event = document.getElementById('cbt-event').value.trim();
  ...
  if (step === 5) {
    ...
    document.getElementById('cbt-suggestion').textContent = d.affirm;
    document.getElementById('cbt-alternative').value = d.affirm;
    saveCBTDraft();
  }
  if (step === 6) {
    const alt = document.getElementById('cbt-alternative').value.trim();
    if (!alt) { showToast('写下你的替代想法吧～'); return; }
    // 开始净化动画
    const thought = document.getElementById('cbt-thought').value.trim();
    document.getElementById('cbt-neg-display').textContent = thought;
    document.getElementById('cbt-pos-display').textContent = alt;
    cbtState.result = {
      event: document.getElementById('cbt-event').value.trim(),
      thought,
      distortions: cbtState.selectedDistortions.map(i => COGNITIVE_DISTORTIONS[i].name),
      evidence: document.getElementById('cbt-evidence-input').value.trim(),
      alternative: alt,
    };
    ...
    setTimeout(() => {
      ...
      playSound('shatter');
      document.getElementById('purify-status-text').textContent = '负面信念正在碎裂...';
    }, 300);
    
    setTimeout(() => {
      document.getElementById('neg-crystal-stage').classList.add('hidden');
      document.getElementById('purify-status-text').textContent = '✨ 净化完成 ✨';
      document.getElementById('pos-crystal-stage').classList.remove('hidden');
      document.getElementById('cbt-complete-btn').classList.remove('hidden');
      playSound('bloom');
    }, 1500);
  }
...
function completeCBTPurify() {
  ...
  setTimeout(() => {
    ...
    document.getElementById('cbt-step1').classList.remove('hidden');
    document.getElementById('cbt-event').value = '';
    document.getElementById('cbt-thought').value = '';
    document.getElementById('cbt-evidence-input').value = '';
    document.getElementById('cbt-alternative').value = '';
    document.querySelectorAll('.distortion-option').forEach(el => {
      el.style.borderColor = 'transparent';
      el.style.background = 'rgba(184,169,201,0.08)';
    });
    document.getElementById('neg-crystal-stage').classList.remove('hidden');
    document.getElementById('pos-crystal-stage').classList.add('hidden');
    document.getElementById('cbt-complete-btn').classList.add('hidden');
    document.getElementById('cbt-neg-crystal').classList.remove('shattering');
    document.getElementById('purify-status-text').textContent = '星光水晶正在碎裂...';
...
function startRevision(type) {
  ...
  document.getElementById('revision-title').textContent = '🕊️ 修正法 · ' + type;
  document.getElementById('revision-text').innerHTML = REVISION_GUIDES[type] || REVISION_GUIDES['原生家庭'];
  revisionTime = 0;
  updateRevisionTimer();
  document.getElementById('revision-area').scrollIntoView({ behavior: 'smooth', block: 'center' });
...
function updateRevisionTimer() {
  ...
  document.getElementById('revision-timer').textContent =
...
function stopRevision() {
  revisionRunning = false;
  clearInterval(revisionInterval);
  document.getElementById('revision-toggle-btn').innerHTML = '▶️ 开始';
}
...
function saveRevisionNote() {
  ...
  document.getElementById('revision-note-status').textContent = '保存中...';
  revisionNoteTimer = setTimeout(() => {
    ...
    saveState();
    document.getElementById('revision-note-status').textContent = '✓ 已保存';
    setTimeout(() => {
...
function createWishStar() {
  const be = document.getElementById('wish-be').value.trim();
  const do_ = document.getElementById('wish-do').value.trim();
  const have = document.getElementById('wish-have').value.trim();
  ...
  const wish = {
    ...
    be, do: do_, have,
    sight: document.getElementById('wish-sight').value.trim(),
    sound: document.getElementById('wish-sound').value.trim(),
    touch: document.getElementById('wish-touch').value.trim(),
    feel: document.getElementById('wish-feel').value.trim(),
    firstAction: document.getElementById('wish-first-action').value.trim(),
    done: false,
    date: getTodayStr(),
...
function renderWishList() {
  ...
  document.getElementById('wish-count').textContent = state.wishes.length;
...
function startSATS(type) {
  document.getElementById('sats-area').classList.remove('hidden');
  document.getElementById('sats-title').textContent = '🌙 SATS · ' + type;
  satsTime = 0;
  satsCurrentStep = 1;
  updateSATSStep(1);
  updateSATSTimer();
  document.getElementById('sats-area').scrollIntoView({ behavior: 'smooth', block:'center' });
  playSound('chime');
}
...
function updateSATSStep(step) {
  ...
  const stepTexts = {
    ...
    2: `
      ...
      <p class="mb-2">在这个状态下，你的潜意识最容易接受新的信念...</p>
    ...
    3: `
      ...
      <p class="text-xs opacity-60">（越细节越真实，显化越快）</p>
    `,
    4: `
    ...
    5: `
      ...
      <p class="mb-2">带着这份美好的感觉，它已经种在了你的潜意识里...</p>
  ...
  document.getElementById('sats-text').innerHTML = stepTexts[step] || guides;
}
...
function updateSATSTimer() {
  ...
  document.getElementById('sats-timer').textContent =
...
function stopSATS() {
  satsRunning = false;
  clearInterval(satsInterval);
  document.getElementById('sats-toggle-btn').innerHTML = '▶️ 开始';
}
...
function saveSATSScene() {
  ...
  satsSaveTimer = setTimeout(() => {
    ...
    const title = document.getElementById('sats-title')?.textContent?.replace('🌙 SATS · ', '') || 'SATS冥想';
...
function completeSATS() {
  ...
  saveState();
  addEnergy(40, 'SATS冥想');
  document.getElementById('sats-area').classList.add('hidden');
  stopSATS();
...
function setEmotionLevel(level) {
  ...
  document.getElementById('emotion-level-text').textContent = name;
  const guide = EMOTION_GUIDES[band];
  document.getElementById('emotion-guide').innerHTML = `
...
function getMDReplacement(neg) {
  ...
  let allAffirms = [];
  ['heal', 'self'].forEach(c => {
    Object.values(AFFIRMATIONS[c].subs).forEach(sub => { allAffirms = allAffirms.concat(sub.list); });
  });
...
function processMDDiet(neg) {
  ...
  // 显示替换结果
  document.getElementById('md-neg-text').textContent = neg;
  document.getElementById('md-pos-text').textContent = pos;
  document.getElementById('md-result').classList.remove('hidden');
  document.getElementById('md-result').classList.add('animate-soft-pop');
...
function renderMDDiet() {
  ...
  document.getElementById('md-day').textContent = md.streak || 0;
  document.getElementById('md-progress').style.width = Math.min((md.streak || 0) / 21 * 100, 100) + '%';
  document.getElementById('md-today-count').textContent = md.todayCount || 0;
  document.getElementById('md-total-count').textContent = md.total || 0;
  document.getElementById('md-streak').textContent = md.streak || 0;
...
function doEmotionPractice(type) {
  const practices = {
    'EFT敲击': '用手指轻轻敲击眉心、太阳穴、锁骨下，每处敲7次，同时说"虽然我有这个情绪，但我深深地爱并接纳我自己"。',
...
function renderAffirmList(cat) {
  ...
  if (cat === 'saved') {
    ...
    if (saved.length === 0) {
      el.innerHTML = `<div class="col-span-full text-center py-8 text-sm" style="color:var(--theme-text); opacity:0.4">还没有收藏的肯定语，点击卡片就可以收藏哦～ 💖</div>`;
      return;
    }
...
function openAffirmModal() {
  document.getElementById('affirm-modal').classList.add('show');
}
function closeAffirmModal() {
  document.getElementById('affirm-modal').classList.remove('show');
}
...
function addCustomAffirm() {
  ...
  if (!text) { showToast('写下你的肯定语呀～'); return; }
...
function renderActionList() {
  ...
  document.getElementById('today-action-count').textContent = todayActions.length;
  ...
  el.innerHTML = todayActions.map(a => `
    <div class="p-3 rounded-xl flex items-center gap-2" style="background:rgba(255,255,255,0.6); ${a.done ? 'opacity:0.6' : ''}">
      ...
      <span class="flex-1 text-sm ${a.done ? 'line-through' : ''}" style="color:var(--theme-text)">${a.text}</span>
...
function renderFlowerGrid() {
  ...
  document.getElementById('flower-count').textContent = total;
  const cells = 30;
  let html = '';
  const persona = PERSONAS.find(x => x.id === state.mainPersona) || PERSONAS[0];
...
function renderWinList() {
  ...
  el.innerHTML = done.slice(0, 5).map(a => `
    <div class="p-2.5 rounded-xl" style="background:linear-gradient(to right, rgba(136,200,152,0.15), rgba(184,216,200,0.1))">
      <div class="text-sm" style="color:var(--theme-text)">✨ ${a.text}</div>
      ${a.feel ? `<div class="text-xs mt-1" style="color:var(--theme-text); opacity:0.6">感受：${a.feel}</div>` : ''}
    </div>
  `).join('');
}
...
function renderGardenStats() {
  ...
  document.getElementById('stat-love').textContent = countByType.love || 0;
  document.getElementById('stat-money').textContent = countByType.money || 0;
  document.getElementById('stat-beauty').textContent = countByType.beauty || 0;
  document.getElementById('stat-heal').textContent = countByType.heal || 0;
}

function renderGardenBadges() {
  const el = document.getElementById('garden-badges');
  const gBadges = BADGES.filter(b => ['flower_10', 'flower_50', 'first_manifest'].includes(b.id));
...
function renderDiary() {
  document.getElementById('diary-total').textContent = state.diaries.length;
  document.getElementById('diary-streak').textContent = state.diaryStreak || 0;
  newDiaryPrompt();
}
...
function selectDiaryTemplate(tpl, btn) {
  ...
  btn.classList.add('active');
  const labels = { gratitude: '感恩日记', future: '未来日记', success: '星愿成真日志' };
  const placeholders = {
    gratitude: '今天我感恩的3件小事：\n1. \n2. \n3. ',
    future: '（以愿望已经实现的你写今天）\n\n今天是美好的一天...',
    success: '今天我星愿成真的事：\n\n（哪怕是小事也要记下来哦～）',
  };
  document.getElementById('diary-template-label').textContent = labels[tpl] || '日记';
...
function saveDiary() {
  ...
  if (!content) { showToast('写点什么吧公主～'); return; }
  ...
  if (state.lastDiaryDate !== today) {
    if (state.lastDiaryDate) {
      const diff = Math.floor((new Date(today) - new Date(state.lastDiaryDate)) / (1000*60*60*24));
  ...
  if (state.diaries.length === 0) {
    ...
    el.innerHTML = state.diaries.map((d, i) => `
      <div class="p-3 rounded-xl cursor-pointer card-hover" style="background:linear-gradient(135deg, rgba(240,213,224,0.15), rgba(184,169,201,0.08))" onclick="viewDiary(${i})">
        <div class="text-xs mb-1" style="color:var(--theme-text); opacity:0.5">📅 ${d.date}</div>
        <div class="text-xs line-clamp-2" style="color:var(--theme-text); opacity:0.8">${d.content.substring(0, 60)}${d.content.length > 60 ? '...' : ''}</div>
      </div>
    `).join('');
  }
...
function viewDiary(i) {
  ...
  el.innerHTML = `
    ...
    <div class="letter-paper p-4 min-h-[300px] page-turn-anim" style="background:linear-gradient(180deg, #FFFEFF, #FAF5F7)">
      ...
      <div class="text-sm whitespace-pre-wrap leading-7" style="color:var(--theme-text)">${d.content}</div>
    </div>
  `;
  playSound('page');
}
...
function newDiaryPrompt() {
  ...
  document.getElementById('diary-prompt').textContent = prompt;
  diaryPromptIdx++;
}
...
function switchLibTab(tab, btn) {
  ...
  btn.classList.add('active');
  currentLibTab = tab;
  document.getElementById('lib-course').classList.toggle('hidden', tab !== 'course');
  document.getElementById('lib-books').classList.toggle('hidden', tab !== 'books');
  document.getElementById('lib-methods').classList.toggle('hidden', tab !== 'methods');
  document.getElementById('lib-guide').classList.toggle('hidden', tab !== 'guide');
  document.getElementById('lib-plans').classList.toggle('hidden', tab !== 'plans');
  document.getElementById('lib-media').classList.toggle('hidden', tab !== 'media');
  playSound('page');
}
  ...
  document.getElementById('course-detail-content').innerHTML = `
    ...
    <div class="flex gap-2 mt-4">
      ...
      <button onclick="markCourseDone(${i})" class="soft-btn btn-primary flex-1 py-2 text-sm font-title">
        ${state.courseProgress.includes(i) ? '✅ 已学完' : '✨ 学完了 +15能量'}
      </button>
...
function openBookReader(index) {
  ...
  document.getElementById('total-pages').textContent = bookPages.length;
  ...
  // 显示模态框
  document.getElementById('book-reader-modal').classList.add('show');
  playSound('page');
...
function closeBookReader() {
  ...
  saveBookProgress(book.title, currentPage);
  document.getElementById('book-reader-modal').classList.remove('show');
...
function extractAuthorIntro(book) {
  ...
  return `<p>内维尔·戈达德（Neville Goddard）是20世纪最伟大的显化导师之一，出生于巴巴多斯，后移居美国。他的 teachings 影响了无数人，被称为「显化界的教父」。</p>`;
}
...
function extractCoreIdeas(book) {
  ...
  // 如果没提取到，用默认的
  if (ideas.length === 0) {
    ideas.push({ title: '意识创造现实', content: `<p class="mb-3">意识是原因，现实是结果。你外在的世界，只是你内在意识的投射。不是你看到了才相信，而是你相信了才会看到。</p><p>改变你的意识，就能改变你的现实。这是所有显化法则的基础。</p>` });
  }
  return ideas;
}
...
function renderLibPlansList() {
  ...
  const plans = [
    ...
    { key: 'sp', icon: '💖', title: '7天SP恋爱计划', desc: '针对特定的人的7天练习', color: '#D4A5B8' },
...
function renderMedia() {
  switchMediaTab('movies', document.querySelector('#lib-media .chip-soft'));
}
...
function renderMovieLibrary() {
  ...
  const categories = [
    ...
    { key: 'healing', label: '🧘 疗愈治愈', color: '#B8A9C9' },
  ];
...
function openMovieDetail(index, category) {
  ...
  document.getElementById('book-detail-content').innerHTML = `
    ...
    <div class="space-y-3">
      ...
      <div class="p-3 rounded-xl" style="background:rgba(184,169,201,0.15)">
        <div class="text-xs font-title mb-1" style="color:var(--theme-text); opacity:0.6">✨ 显化角度解析</div>
...
function renderWishWall() {
  ...
  document.getElementById('ww-done').textContent = done;
  document.getElementById('ww-rate').textContent = rate + '%';
  ...
  grid.innerHTML = wishes.map((w, i) => {
    const title = w.title || w.be || w.have || w.do || '我的愿望';
    return `
    <div class="wish-plaque ${w.done ? 'done' : ''}" onclick="openWishDetail(${i})" style="transform: rotate(${(i % 5 - 2) * 2}deg)">
      ...
      <div class="wish-plaque-body">
        ...
        ${w.done ? '<div class="text-[9px] mt-0.5" style="color:#D97706">✨ 已显化</div>' : ''}
      </div>
...
function openWishDetail(i) {
  ...
  if (!w) return;
  const title = w.title || w.be || w.have || w.do || '我的愿望';
  const desc = w.desc || [w.be && `BE：${w.be}`, w.do && `DO：${w.do}`, w.have && `HAVE：${w.have}`].filter(Boolean).join('\n');
  document.getElementById('wd-title').textContent = w.done ? '✨ 已显化的愿望' : '🌠 进行中的愿望';
  
  const progressHtml = (w.progress || []).map((p, pi) => `
    <div class="p-2 rounded-lg mb-2" style="background:rgba(184,169,201,0.08)">
      <div class="text-[10px] mb-0.5" style="color:var(--theme-text); opacity:0.5">${p.date}</div>
      <div class="text-xs" style="color:var(--theme-text)">${p.text}</div>
    </div>
  `).join('') || '<div class="text-xs text-center py-2" style="color:var(--theme-text); opacity:0.4">还没有进度记录～</div>';

  document.getElementById('wish-detail-content').innerHTML = `
    <div class="p-4 rounded-xl mb-4" style="background:linear-gradient(135deg, ${w.done ? 'rgba(245,230,200,0.3)' : 'rgba(212,181,199,0.2)'}, rgba(184,169,201,0.1))">
      <div class="text-xs mb-2" style="color:var(--theme-text); opacity:0.6">${w.date || ''}</div>
    ...
    ${!w.done ? `
    <div class="mb-4">
      <div class="text-xs font-medium mb-2" style="color:var(--theme-text)">📝 显化进度记录</div>
    ...
    `}
    <button onclick="deleteWish(${i})" class="soft-btn w-full py-2 text-xs" style="background:rgba(245,213,213,0.2); color:#B87590">
      删除这个愿望
    </button>
  `;
  document.getElementById('wish-detail-modal').classList.add('show');
  playSound('page');
}

function closeWishDetail() {
  document.getElementById('wish-detail-modal').classList.remove('show');
}
...
function markWishDone(i) {
  if (!confirm('确定这个愿望已经显化了吗？✨')) return;
...
function closeHabitModal() { document.getElementById('habit-modal').classList.remove('show'); }
...
function selectHabitFreq(freq, el) {
  ...
  el.classList.add('active');
  document.getElementById('habit-weekdays').classList.toggle('hidden', freq !== 'custom');
  playSound('sparkle');
}
...
function addHabit() {
  ...
  const reminder = document.getElementById('habit-reminder-input').value || null;
...
function renderHabits() {
  ...
  if (habits.length === 0) {
    ...
    document.getElementById('habit-calendar-section').classList.add('hidden');
    return;
  }
  ...
  document.getElementById('habit-calendar-section').classList.remove('hidden');
  renderHabitCalendar();
}
...
function renderHabitCalendar() {
  ...
  document.getElementById('habit-cal-title').textContent = `${year}年${month+1}月`;
  ...
  for (let d = 1; d <= daysInMonth; d++) {
    ...
    // 统计当天打卡数
    const checked = habits.filter(h => h.checkins[dateStr]).length;
...
function updateFortuneCard() {
  ...
  document.getElementById('fortune-summary').textContent = '今日显化指数：' + starsStr;
  document.getElementById('fortune-color').textContent = '幸运色：' + f.color.name;
  document.getElementById('fortune-number').textContent = '幸运数字：' + f.number;
}
...
const TAROT_CARDS = [
  { id: 0, name: '愚者', emoji: '🃏', keyword: '新开始',
    meaning: '<p class="mb-2">愚者是大阿卡纳的第一张牌，代表无限的可能性和全新的开始。他站在悬崖边，却毫不畏惧，因为他相信宇宙会托住他。</p><p class="mb-2">正位的愚者，意味着你正站在人生的一个新起点。也许是一段新的关系、一份新的工作、一个新的想法。你带着纯真和勇气，准备踏上未知的旅程。</p><p>愚者提醒你：有时候，不需要准备得万无一失再出发。带着好奇心和信任，勇敢地迈出第一步，宇宙会为你开路。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，愚者正位意味着一个全新的机会正在向你招手——可能是一份新工作、一个新项目、一次创业的机会，或者一个你之前从未想过的方向。</p><p class="mb-2">你可能会觉得有点忐忑，因为一切都是陌生的。但愚者告诉你：这是宇宙给你的礼物。不要因为「我没经验」「我可能做不好」就退缩。很多伟大的事业，都是从「试试看」开始的。</p><p class="mb-2">如果你正在考虑转行或者跳槽，这张牌是一个积极的信号——勇敢去尝试吧，新的领域会给你带来意想不到的成长。</p><p>记住：你不需要准备好一切再出发，你可以在路上慢慢学习。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是适合「冒险」的一天。做一件你平时不会做的事——走一条不同的路、吃一家没吃过的餐厅、跟一个陌生人说句话、学一个新技能……</p><p class="mb-2">宇宙想告诉你：不要把自己困在舒适区里。外面的世界很大、很精彩，等着你去探索。你越敢尝试，你的人生就越丰富。</p><p class="mb-2">今天如果有人邀请你做什么新鲜事，别犹豫，答应就对了。那个「试试看」的念头，可能会带你去到一个你从未想象过的地方。</p><p>保持开放和好奇，今天会有小惊喜等着你哦 ✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「停下来」。不要急着做决定，不要急着行动，先给自己一点时间，好好想一想。</p><p class="mb-2">宇宙想提醒你：勇敢不等于冲动。有些事情，晚几天做决定，不会有什么损失。但如果一时冲动做错了决定，可能要花很久来弥补。</p><p class="mb-2">今天可以做一些「脚踏实地」的事——整理房间、做计划、学习新东西、跟有经验的人聊聊天。这些事情会帮你找回方向感。</p><p>别急，你还有的是时间。慢一点，稳一点，反而走得更远 🌸</p>'
      }
    },
  ...
  { id: 1, name: '魔术师', emoji: '✨', keyword: '创造力',
    meaning: '<p class="mb-2">魔术师一手举着权杖指天，一手指地，代表「天上地下，惟我独尊」的星愿力量。他的桌上摆着四元素的象征——权杖、圣杯、宝剑、星币，代表他拥有一切所需的资源。</p><p class="mb-2">正位的魔术师，意味着你拥有实现目标所需的一切资源和能力。你有才华、有创意、有意志力，只要你想，你就能创造。</p><p>这张牌是显化能力最强的牌之一。它告诉你：你的想法有强大的力量，你可以把你想要的变成现实。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，魔术师正位是一张超级好的牌——它意味着你拥有实现目标所需的一切资源和能力。你有才华、有创意、有意志力，只要你想，你就能创造。</p><p class="mb-2">如果你在考虑创业、跳槽、或者启动一个新项目，这张牌是一个强烈的「go」信号。你桌上的「四元素」都齐了——你缺的不是资源，是行动。</p><p class="mb-2">这张牌是显化能力最强的牌之一。它告诉你：你的想法有强大的力量，你可以把你想要的变成现实。</p><p>现在就行动起来吧，你比你想象的更有力量 ✨</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「主动创造」的一天。不要等好事发生在你身上，主动去创造好事。</p><p class="mb-2">宇宙想告诉你：你有能力让今天变得很棒。想让谁开心，就主动去联系他。想做成什么事，就主动去做。想让心情好，就主动去做让你开心的事。</p><p class="mb-2">今天你就是自己人生的「魔术师」——你手里有所有你需要的工具，你只需要挥动你的「权杖」（也就是行动起来）。</p><p>去创造属于你的美好一天吧 ✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「整理」和「聚焦」。把你分散的精力收回来，专注在一件最重要的事情上。</p><p class="mb-2">宇宙想提醒你：你很有能力，但你的能力如果分散在太多地方，就发挥不出效果。就像放大镜——只有把阳光聚焦在一点上，才能点燃纸张。</p><p class="mb-2">今天也适合「诚实面对自己」。你最近有没有在骗自己？有没有什么事情你明明知道不对，但还在继续做？</p><p>诚实地面对自己，然后重新出发。你会找回你的力量的 🌸</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 2, name: '女祭司', emoji: '🌙', keyword: '直觉',
    meaning: '<p class="mb-2">女祭司静静地坐在两根柱子之间，手里拿着卷轴，背后是平静的湖水。她代表着潜意识、直觉和内在的智慧。她不说话，但她什么都知道。</p><p class="mb-2">正位的女祭司，意味着答案就在你心里。你不需要向外求，静下来，你就能听见内心的声音。</p><p>这张牌提醒你：多花时间独处和冥想。相信你的直觉，它比你的头脑更聪明。有些答案，需要用心去感受，而不是用脑子去分析。</p>',
    advice: '多花时间独处和冥想，相信你的直觉。有些答案不需要向外求，静下来就能听见。关注你的梦，关注你心里的「知道」。',
    ...
    scenes: {
      upright: {
        love: '<p class="mb-2">在感情方面，女祭司正位代表着一种「深度连接」的感情。它不是轰轰烈烈的热恋，而是那种「你不说，我也懂」的默契和灵魂共鸣。</p><p class="mb-2">如果你是单身，女祭司告诉你：不要急，对的人正在来的路上。在他到来之前，先好好跟自己相处。当你越了解自己、越接纳自己，你就越容易认出那个对的人。</p><p class="mb-2">如果你已经有伴侣，女祭司意味着你们的关系正在进入一个更深的层次。你们开始真正地了解彼此，不只是表面的喜欢，而是灵魂层面的共鸣。</p><p>好的感情，是两个完整的灵魂在对话。先成为你自己，再遇见对的人。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「倾听自己」的一天。找一个安静的时间，跟自己待一会儿。</p><p class="mb-2">宇宙想告诉你：你心里有一个声音，它一直都在，只是平时太吵了你听不到。今天试着静下来，听听它想说什么。它可能是一个直觉、一个念头、一个「我知道」的感觉。</p><p class="mb-2">今天也适合做一些「安静」的事——看书、冥想、写日记、发呆、晒太阳……不用逼自己「有产出」，有时候「什么都不做」反而是最有价值的。</p><p>静下来，你就什么都知道了 🌙</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「把注意力收回来」。不要太在意外界的声音，多听听自己心里的想法。</p><p class="mb-2">宇宙想提醒你：你已经知道答案了，只是你不敢相信。你心里的那个「嗯？」「好像是这样？」「我觉得……」，那就是你的直觉在说话。</p><p class="mb-2">今天可以做一件事：找一个安静的地方，闭上眼睛，问自己一个你最近一直在纠结的问题。然后，听听你心里冒出来的第一个答案。</p><p>那个答案，就是对的 🌙</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 3, name: '皇后', emoji: '👑', keyword: '丰饶',
    meaning: '<p class="mb-2">皇后坐在华丽的宝座上，周围是盛开的花朵和茂盛的森林。她代表着母性、丰饶、创造力和爱。她被爱和丰盛包围着，她本身就是爱和丰盛的化身。</p><p class="mb-2">正位的皇后，意味着你正处于一个充满创造力和丰盛的时期。你被爱包围着，你也有能力去爱别人。</p><p>这张牌提醒你：好好滋养自己。当你成为爱本身，一切美好的事物都会向你涌来。爱自己，照顾好自己的身体和情绪，你值得被好好对待。</p>',
    advice: '爱自己，照顾好自己的身体和情绪。当你成为爱本身，一切都会向你涌来。享受生活中的美好，你值得被好好宠爱。',
    reversedMeaning: '<p class="mb-2">逆位的皇后，可能意味着你忽略了自己，总是在照顾别人，却忘了照顾自己。也可能代表你在关系中过度依赖，或者你感到不被爱、不被重视。</p><p>你和「女性能量」失去了连接。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，皇后正位意味着你的事业会进入一个「丰盛」的阶段——你的努力会得到回报，你的才华会被看见，你的收入也会稳步增长。</p><p class="mb-2">皇后代表「创造力」和「滋养」——如果你做的是创意类、艺术类、服务类、或者跟「美」相关的工作，这段时间你会非常有灵感，做出来的东西会很受欢迎。</p><p class="mb-2">皇后也提醒你：工作很重要，但照顾好自己也很重要。不要为了工作把身体搞垮了，也不要忘了享受生活。劳逸结合，才能走得更远。</p><p>你值得拥有既成功又美好的生活，事业和生活可以兼得。</p>',
        emotion: '<p class="mb-2">在情绪方面，皇后正位代表着一种温柔、丰盛、被滋养的状态。你最近心情很好，你很会照顾自己的情绪，你也能感受到来自周围人的爱和善意。</p><p class="mb-2">你有一种「柔软的力量」——你不是强势的、对抗的，你是温柔的、包容的，但同时你也很有力量。就像水一样，看似柔软，却能穿石。</p><p class="mb-2">这种状态下的你，吸引力是最强的。因为你本身就是爱、就是丰盛、就是美好，所以一切美好的事物都会向你涌来。</p><p>继续好好爱自己、好好滋养自己吧，你值得世间所有的美好 🌸</p>',
        guide: '<p class="mb-2">今日指引：今天是「宠爱自己」的一天。做一件让你自己开心的、被滋养的事。</p><p class="mb-2">宇宙想告诉你：你已经很努力了，你值得被好好对待——尤其是被你自己。今天不要想「我应该做什么」，想想「我想要做什么」。想吃什么就去吃，想买什么就去买，想躺平就躺平。</p><p class="mb-2">今天也适合跟你的女性朋友聚会、跟妈妈聊天、或者做一些「很女生」的事——做美甲、敷面膜、买束花给自己……</p><p>好好爱自己，你就是自己的皇后 👑</p>'
      },
      reversed: {
        ...
        career: '<p class="mb-2">在事业方面，皇后逆位可能意味着你在工作中过度付出、不懂得拒绝——什么活都接，什么忙都帮，结果自己累得要死，还不被珍惜。</p><p class="mb-2">也可能代表你的创造力被压抑了——你做的工作不是你喜欢的，或者你的想法总是被否定，你感觉自己像一个干活的机器，没有灵魂。</p><p class="mb-2">皇后逆位提醒你：工作很重要，但你自己更重要。学会说「不」，学会保护自己的时间和精力。你不需要通过「拼命工作」来证明你的价值。</p><p>照顾好你自己，你的创造力和热情才会回来。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天的关键词是「回春」——把注意力放回自己身上，好好滋养一下自己。</p><p class="mb-2">宇宙想提醒你：你已经付出太多了，你需要「充电」了。就像手机没电了要充电一样，你的能量也需要补充。今天什么都不用「做」，只要「感受」就好。</p><p class="mb-2">可以做的事：睡个懒觉、泡个热水澡、敷个面膜、吃点好吃的、看个喜欢的剧、跟好朋友聊聊天……总之，怎么舒服怎么来。</p><p>你值得被好好宠爱，尤其是被你自己 💕</p>'
      }
    },
    positionInterpretation: {
      past: '过去的你，曾经体验过满满的爱和丰盛——也许是一段被好好爱着的感情，也许是一个你很有成就感的创作，也许是你学会了好好爱自己的那段时光。那段经历让你知道：被爱、被滋养是什么感觉。',
  ...
  { id: 4, name: '皇帝', emoji: '🏰', keyword: '权威',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「建立秩序」的一天。做计划、立规矩、理清楚思路。</p><p class="mb-2">宇宙想告诉你：你想要的东西，不会凭空掉下来。你需要为它搭建一个「架子」，它才能放得上来。今天就来搭这个架子吧——把你的目标写下来，拆解成具体的步骤，然后安排好时间。</p><p class="mb-2">今天也适合「立边界」——哪些事你可以接受，哪些事你不能接受；哪些人可以靠近你，哪些人需要保持距离。清晰的边界会让你更有力量。</p><p>温柔而坚定，你就是自己人生的国王 👑</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「松一松」。如果你最近一直在硬撑、一直在强迫自己、一直在控制一切，今天试着放松一点。</p><p class="mb-2">宇宙想提醒你：你不需要掌控一切。有些事情，你放手了，反而会更好。就像手里的沙子，你握得越紧，漏得越快。</p><p class="mb-2">今天可以做的事：把你的「待办清单」删掉几条，给自己放半天假；对一件你平时会管的事说「随便吧」；允许自己「浪费」一点时间。</p><p>张弛有度，才能走得更远。今天，就做一个「不那么用力」的人吧 🌸</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 5, name: '教皇', emoji: '⛪', keyword: '传统',
    ...
    reversedMeaning: '<p class="mb-2">逆位的教皇，可能意味着你对传统的体系失去了信心，或者你在显化挑战权威。也可能代表你在精神上感到迷茫，找不到方向。</p><p>或者，你太教条了，被规则束缚住了。</p>',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「学习」和「请教」的一天。如果你有什么困惑，去找一个你信任的人聊聊吧。</p><p class="mb-2">宇宙想告诉你：你不需要什么都自己扛。有时候，别人的一句话，就能点醒你。去找一个比你有经验的人，问问他的建议。或者，找一本你一直想读的书，今天就读起来。</p><p class="mb-2">今天也适合「仪式感」——做一件有仪式感的事，点个香薰、泡杯茶、写日记、冥想……仪式感会让你心里很安定。</p><p>学习和成长，是一辈子的事。今天又进步了一点点，真好 ✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「打破常规」。做一件你平时不会做的事，或者换一个角度看问题。</p><p class="mb-2">宇宙想提醒你：不是所有的「规则」都是对的，不是所有的「传统」都要遵守。你可以有你自己的想法，你可以走你自己的路。</p><p class="mb-2">如果你最近一直在听别人的意见，今天试着听一听你自己的。你心里怎么想的？你真正想要的是什么？不要管别人怎么说，你的人生你说了算。</p><p>勇敢一点，活出你自己的样子。你本来就很特别 ✨</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 6, name: '恋人', emoji: '💞', keyword: '爱情',
    ...
    scenes: {
      upright: {
        love: '<p class="mb-2">在感情方面，恋人牌正位当然是超级好的消息！它代表着爱情、和谐、吸引和灵魂伴侣。如果你是单身，很快就会遇到那个对的人——你们彼此吸引、价值观一致、在一起特别开心。</p><p class="mb-2">你们的相遇可能很有戏剧性，或者有「命中注定」的感觉。你会觉得：「哇，原来世界上真的有这么懂我的人。」</p><p class="mb-2">如果你已经有伴侣，恋人牌意味着你们的感情会进入一个更甜蜜的阶段——你们会更加了解彼此、更加珍惜对方。你们的关系是平等的、互相尊重的、充满爱的。</p><p>恋人牌也提醒你：好的爱情，是两个完整的人在一起变得更好。不是缺了一半找另一半，而是两个完整的圆，一起滚得更远 💞</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「爱」的一天。去表达你的爱，去感受你的爱。</p><p class="mb-2">宇宙想告诉你：今天是表达爱意的好日子。告诉你爱的人你爱他，感谢出现在你生命里的人，也别忘了感谢你自己。爱要大声说出来，对方才听得到。</p><p class="mb-2">如果你面前有一个选择，今天也是做决定的好日子。跟随你的心，不要想太多。心知道答案。</p><p>今天也适合「宠爱自己」——做一件让你心里暖暖的事，吃点好吃的，买点喜欢的东西，跟喜欢的人聊聊天。</p><p>爱与被爱，都是世界上最美好的事 💕</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「做决定」和「坦诚沟通」。如果你有什么一直纠结的事，今天就把它想清楚，然后做个决定。</p><p class="mb-2">宇宙想提醒你：你不可能什么都要。选择一个，就意味着放弃另一个。这很正常，也不可惜。因为你选择的那个，就是最好的。</p><p class="mb-2">如果你跟某个人有误会或者矛盾，今天也是说开的好日子。坦诚地聊一聊，把你的真实感受说出来。很多时候，说开了，就没事了。</p><p>勇敢一点，不管是做选择还是表达爱。你比你想象的更有力量 💪</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 7, name: '战车', emoji: '⚔️', keyword: '胜利',
    ...
    scenes: {
      upright: {
        love: '<p class="mb-2">在感情方面，战车正位代表着「主动争取」和「克服困难」。如果你喜欢一个人，不要等，主动出击吧！战车告诉你：你有能力追到你喜欢的人。</p><p class="mb-2">如果你正在经历一段有阻碍的感情——比如异地、家人反对、或者有第三方干扰——战车意味着你有力量去克服这些困难。只要你们目标一致、一起努力，没有什么能阻挡你们。</p><p class="mb-2">如果你已经有伴侣，战车意味着你们会一起面对生活中的显化挑战，你们是「战友」也是「爱人」。你们的关系，会在共同克服困难的过程中变得更加牢固。</p><p>好的爱情不只有风花雪月，还有并肩作战的义气。一起往前走，什么都难不倒你们 ⚔️</p>',
        career: '<p class="mb-2">在事业方面，战车正位是一张「胜利」的牌——它意味着你会克服所有困难，最终取得成功。不管你现在面临多大的显化挑战，只要你坚持下去，你就一定能赢。</p><p class="mb-2">战车代表「意志力」和「行动力」——你有明确的目标，你有强大的动力，你有不达目的不罢休的决心。这样的你，没有什么做不成的。</p><p class="mb-2">如果你在考虑一个新的项目或者新的机会，战车告诉你：冲！虽然过程可能会有点辛苦，但结果一定会很好。你的努力不会白费。</p><p>胜利属于坚持到最后的人。你比你想象的更强大，冲鸭 💪</p>',
        emotion: '<p class="mb-2">在情绪方面，战车正位代表着一种「斗志昂扬」的状态——你最近充满了能量和动力，你知道你想要什么，你也知道该怎么得到它。</p><p class="mb-2">你可能刚从一段低谷期走出来，你重新找回了你的力量和勇气。你不再害怕困难，你知道你有能力面对一切显化挑战。</p><p class="mb-2">这种「我可以」的感觉非常棒。它不是盲目的自信，而是经历过风雨之后的笃定——你知道你不会被打倒，因为你已经被打倒过很多次了，但每一次你都站了起来。</p><p>继续保持这份斗志吧。你想要的，都在前面等着你。</p>',
        guide: '<p class="mb-2">今日指引：今天是「冲锋」的一天。有什么一直想做但不敢做的事，今天就去做吧！</p><p class="mb-2">宇宙想告诉你：你比你想象的更强大。不要怕困难，不要怕失败，不要怕被拒绝。你有能力得到你想要的一切，只要你敢要、敢冲、敢坚持。</p><p class="mb-2">今天也适合「做计划」——把你的大目标拆成小步骤，然后一步一步去实现。有方向的努力，才是有效的努力。</p><p>冲吧，我的战士！胜利在前面等着你 🏆</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「踩刹车」。如果你最近一直在冲、一直在拼、一直在硬撑，今天停下来，歇一歇。</p><p class="mb-2">宇宙想提醒你：不是所有事情都要靠「硬刚」来解决。有时候，柔能克刚；有时候，退一步海阔天空；有时候，慢就是快。</p><p class="mb-2">今天可以做的事：睡个懒觉、看看剧、发发呆、什么都不做。让你的身体和你的心，都好好休息一下。</p><p>休息不是浪费时间，休息是为了走更远的路。今天，就好好休息吧 🌸</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 8, name: '力量', emoji: '🦁', keyword: '内在力量',
    meaning: '<p class="mb-2">力量牌描绘了一位温柔的女子，她轻轻抚摸着狮子的嘴巴，狮子在她面前温顺得像一只小猫。她不是靠蛮力制服狮子，而是靠爱、耐心和内在的力量。</p><p class="mb-2">正位的力量牌，告诉你：真正的力量来自内心，不是控制，不是强硬，而是温柔的坚定。你有能力面对任何显化挑战，因为你内心有足够的勇气和力量。</p><p>这张牌提醒你：用温柔而坚定的方式面对显化挑战。你比你想象的更强大。</p>',
    advice: '用温柔而坚定的方式面对显化挑战。你比你想象的更强大。真正的力量不是征服别人，而是掌控自己。',
    reversedMeaning: '<p class="mb-2">逆位的力量牌，可能意味着你感到自己很脆弱，没有力量面对显化挑战。也可能代表你在压抑自己的情绪和愤怒，或者你用错了力量的方式——比如发脾气、控制别人。</p><p>你和你内在的「狮子」失去了连接。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，力量牌正位意味着你有能力面对工作中的任何显化挑战。你不是靠强势和压迫来获得成功，你靠的是耐心、毅力和内在的力量。</p><p class="mb-2">如果你遇到了一个很难搞的客户、或者一个很棘手的项目，力量牌告诉你：不要急，慢慢来。用你的耐心和智慧，一点一点地解决问题。最后你会发现，原来这么难的事，你也搞定了。</p><p class="mb-2">力量牌也代表「软实力」——沟通能力、共情能力、情绪管理能力。这些能力，有时候比硬实力更重要。</p><p>温柔但有力量，坚定但不尖锐。这才是最高级的职场智慧。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天的关键词是「温柔的坚定」。用温柔的方式，做坚定的事。</p><p class="mb-2">宇宙想告诉你：你不需要大喊大叫来证明你的力量，你也不需要通过打败别人来证明你厉害。真正的力量是——你温柔，但没人敢欺负你；你善良，但你有底线。</p><p class="mb-2">今天如果遇到让你生气的事，试着不用发脾气的方式来解决。深呼吸，然后温柔但坚定地说出你的想法。</p><p>你本身就很有力量，不需要靠张牙舞爪来证明 ✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「温柔地对待自己」。如果最近你一直在逼自己、一直在硬撑，今天停下来，对自己好一点。</p><p class="mb-2">宇宙想提醒你：你不需要一直做个「强者」。你可以脆弱、可以难过、可以需要人陪。这些都不丢人。</p><p class="mb-2">今天做一件「宠爱自己」的事——吃点好吃的、看个喜欢的剧、睡个懒觉、或者什么都不做就发发呆。</p><p>对自己温柔一点，你已经做得很好了 💕</p>'
      }
    },
    positionInterpretation: {
      past: '过去的你，曾经靠自己的内在力量度过了一段很难的日子。那段经历可能很痛苦，但它让你变得更强大了。你现在的温柔和坚定，都是那段日子给你的礼物。',
      present: '现在的你，正在学习如何「温柔而有力量」地生活。你可能在面对一些显化挑战，你有时候会怀疑自己能不能行。但你可以的——你心里的那只「狮子」一直在，只是你需要学会怎么和它相处。',
      future: '未来的你，会活成一个真正「有力量」的人——不是强势的、咄咄逼人的力量，而是温柔的、坚定的、从骨子里透出来的力量。你不怒自威，你温柔但没人敢欺负你。那时候的你，真的很美。'
    }
  },
  { id: 9, name: '隐士', emoji: '🏔️', keyword: '内省',
    meaning: '<p class="mb-2">隐士站在高高的山顶上，手里提着一盏灯，灯里有一颗六芒星。他远离人群，在孤独中寻找真理。他代表着内省、独处、寻求真理和内在指引。</p><p class="mb-2">正位的隐士，意味着是时候静下来，和自己对话了。你需要一些独处的时间，向内探索，寻找你内心的答案。</p><p>这张牌提醒你：你寻找的答案不在外面，在你心里。给自己一些安静的时间，听听你灵魂的声音。</p>',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「独处日」。给自己一点时间，一个人待一会儿。</p><p class="mb-2">宇宙想告诉你：你不需要一直「有用」，你不需要一直社交，你不需要一直热闹。你可以安安静静地一个人待着，什么都不做，什么都不想。</p><p class="mb-2">今天可以做的事：一个人散步、一个人喝咖啡、一个人看书、一个人发呆……总之，就是和自己好好待一会儿。</p><p>你心里有一盏灯，静下来，你就能看到它的光 🏮</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「走出来」。如果你最近把自己封闭太久了，今天出去走走吧。</p><p class="mb-2">宇宙想告诉你：外面的世界没有那么可怕。去见见朋友，去晒晒太阳，去感受一下人间的烟火气。你会发现，生活还是很美好的。</p><p class="mb-2">今天也适合「求助」——如果你有什么解决不了的问题，去找人聊聊吧。也许别人一句话就能点醒你。</p><p>不要什么都自己扛。你值得被帮助，也值得被爱 🌸</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 10, name: '命运之轮', emoji: '🎡', keyword: '命运',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，命运之轮正位是超级好的消息——它意味着「转运」了！你之前的努力和积累，现在开始要看到结果了。</p><p class="mb-2">可能会有一个意外的机会降临到你面前——也许是一个新项目、一个新职位、或者一个新的合作机会。抓住它！这是命运给你的礼物。</p><p class="mb-2">命运之轮也提醒你：事业是有周期的。有上升期就有低谷期，有忙碌的时候就有清闲的时候。在上升期的时候抓住机会多做事，在低谷期的时候好好休息、积累能量。</p><p>风水轮流转，今年到你家。准备好迎接你的好运了吗？🍀</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「转运日」！准备好迎接变化和惊喜吧～</p><p class="mb-2">宇宙想告诉你：你之前的努力没有白费，你的好运正在来的路上。今天可能会有意外的好消息、意外的机会、或者意外的相遇。保持开放，接住它！</p><p class="mb-2">今天也适合「做新的尝试」——想做很久但没做的事，今天就去做吧。说不定，这就是你命运的转折点呢。</p><p>命运之轮开始转动了，你的好运要来了 ✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「停下来反思」。如果你最近觉得不顺、觉得倒霉，今天就来好好想一想：为什么会这样？</p><p class="mb-2">宇宙想提醒你：没有无缘无故的「好运」和「坏运」。你现在的处境，是你过去的选择和行为造成的。想改变未来，就要改变现在。</p><p class="mb-2">今天也适合「打破惯性」——做一件你平时不会做的事，打破你固有的模式。哪怕只是很小的一件事，也是一个新的开始。</p><p>改变命运，从改变一个小习惯开始。你可以的 💪</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 11, name: '正义', emoji: '⚖️', keyword: '公正',
    meaning: '<p class="mb-2">正义女神一手持剑，一手持天平，端坐在宝座上。她代表着公正、真理、因果和平衡。她不偏不倚，你付出什么，就会收获什么。</p><p class="mb-2">正位的正义牌，意味着你会得到公平的结果。如果你一直在努力，你的付出会得到回报。如果你有法律相关的事情，结果会对你有利。</p><p>这张牌提醒你：做对的事，说真话。保持内心的平衡和正直，宇宙会给你公平的回报。因果不虚，你的每一个选择都在创造你的未来。</p>',
    advice: '做对的事，说真话。保持内心的平衡和正直，宇宙会给你公平的回报。你付出什么，就会收获什么。',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「做对的事」的一天。不管别人怎么做，你守住你的原则和底线。</p><p class="mb-2">宇宙想告诉你：不要为了一时的利益而做违背良心的事，不要为了讨好别人而说违心的话。做你认为对的事，哪怕暂时会吃亏，长远来看，你一定是赚的。</p><p class="mb-2">今天如果有什么需要做决定的事，问问你自己：「这件事，我做了之后，能问心无愧吗？」如果答案是「能」，那就去做。</p><p>正直是最好的护身符。做一个堂堂正正的人，你会走得很远 ⚖️</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「反省」和「承担」。想一想，最近有没有什么事，你做得不太对？有没有什么责任，你一直在逃避？</p><p class="mb-2">宇宙想提醒你：逃避解决不了问题，只会让问题越积越大。勇敢地面对它，承担你该承担的责任。你会发现，其实也没什么大不了的。</p><p class="mb-2">今天也适合「放下」——放下对「公平」的执念。这个世界本来就不是绝对公平的，接受这一点，你会轻松很多。</p><p>但行好事，莫问前程。你做的每一件好事，都算数 🌟</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 12, name: '倒吊人', emoji: '🙃', keyword: '暂停',
    meaning: '<p class="mb-2">倒吊人被倒吊在树上，但他的表情很平静，甚至有点喜悦。他头上的光环代表着开悟和智慧。他代表着暂停、放手、新视角和牺牲。</p><p class="mb-2">正位的倒吊人，意味着是时候停下来了。不是所有时候都要前进，有时候停下来、换个角度看问题，反而能看到不一样的风景。</p><p>这张牌提醒你：有时候停下来不是浪费时间，而是为了更好地出发。换个角度，世界会变样。有些事情，你越想抓住，它跑得越快；放手了，反而留下来了。</p>',
    ...
    scenes: {
      upright: {
        ...
        emotion: '<p class="mb-2">在情绪方面，倒吊人正位代表着一种「静观」的状态。你最近可能遇到了一些让你很痛苦的事，但你没有崩溃，也没有逃避，你只是静静地「待着」，看着你的情绪来来去去。</p><p class="mb-2">你学会了「不跟情绪较劲」——它来就让它来，它走就让它走。你不抗拒，也不追随。你就像一个旁观者，看着你的情绪像云一样飘来飘去。</p><p class="mb-2">这种状态非常高级。很多人遇到痛苦就拼命挣扎，结果越陷越深。而你，学会了「跟痛苦和平共处」。这是非常了不起的成长。</p><p>痛苦不是来伤害你的，是来让你觉醒的。你已经在路上了 ✨</p>',
        guide: '<p class="mb-2">今日指引：今天适合「倒过来」想问题。遇到想不通的事，反过来想一想；遇到解不开的结，换个角度看一看。</p><p class="mb-2">宇宙想告诉你：不是所有时候都要往前冲的。有时候，停下来、慢下来、甚至退一步，反而能看到更多。就像倒吊人一样，换个角度，世界完全不一样。</p><p class="mb-2">今天也适合「放手」——有些事，你抓得越紧，它跑得越快。松开手，它反而留下来了。</p><p>该停的时候停，该放的时候放。顺其自然，是最大的智慧 🍃</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「行动起来」。如果你有什么一直想做但没做的事，今天就开始做吧。</p><p class="mb-2">宇宙想提醒你：你已经「想」得够久了。再想下去，也不会有新的答案。先做起来，做着做着，答案就出来了。</p><p class="mb-2">今天也适合「换个角度」——如果你一直在钻牛角尖，今天试着从相反的方向想一想。也许你会发现，原来事情根本不是你想的那样。</p><p>别再等了，也别再想了。行动起来，就是最好的答案 💪</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 13, name: '死神', emoji: '🌑', keyword: '结束',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「断舍离」的一天。清理掉那些不再服务于你的人和事，给新的东西腾出空间。</p><p class="mb-2">宇宙想告诉你：有些东西，该放手了。也许是一段不健康的关系，也许是一份不喜欢的工作，也许是一个过时的信念。它们已经「死了」，你抓着它们，只是在占地方。</p><p class="mb-2">今天可以做的事：清理手机通讯录、清理衣柜、清理没用的东西、清理让你不开心的人际关系……清理完你会发现，心里轻松了很多。</p><p>旧的不去，新的不来。腾出手来，才能接住新的礼物 🎁</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「告别」。跟过去的自己告个别，跟那些让你不开心的人和事告个别。</p><p class="mb-2">宇宙想提醒你：你已经抓着那些「死去」的东西够久了。是时候放手了。放手不是认输，是放过自己。</p><p class="mb-2">今天可以做一个「告别仪式」——写一封信给过去的自己/过去的人/过去的事，然后把它烧掉或者撕掉。告诉自己：都过去了，我要往前走了。</p><p>再见，旧的我。你好，新的人生 ✨</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 14, name: '节制', emoji: '🕊️', keyword: '平衡',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天的关键词是「平衡」。看看你的生活，哪里失衡了？把它调回来。</p><p class="mb-2">宇宙想告诉你：不是越快越好，也不是越多越好。刚刚好，才是最好的。工作太多了就休息一下，玩得太疯了就收一收。找到属于你的那个「平衡点」。</p><p class="mb-2">今天也适合「慢慢来」——不管做什么，都别急。慢慢做，细细品，你会发现很多平时注意不到的美好。</p><p>慢一点，稳一点，反而走得更远。今天，就做一个「不慌不忙」的人吧 🌿</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「调节奏」。如果你最近太快了，今天就慢下来；如果你最近太慢了，今天就动起来。</p><p class="mb-2">宇宙想提醒你：人生是一场马拉松，不是百米冲刺。跑得快的，不一定能跑到最后。跑得稳的，才是最后的赢家。</p><p class="mb-2">今天也适合「找平衡」——看看你的生活，哪里缺了就补哪里。工作太多就补生活，社交太多就补独处，想太多就补行动。</p><p>找到你的「刚刚好」，然后稳稳地走下去。你会走得很远很远 🌿</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 15, name: '恶魔', emoji: '😈', keyword: '束缚',
    ...
    reversedMeaning: '<p class="mb-2">逆位的恶魔牌，意味着你正在挣脱束缚。你看见了你的执念，并且决定离开它。这是一个好的迹象——你正在觉醒。</p><p>也许你刚离开了一段有毒的关系，也许你戒掉了一个坏习惯，也许你终于从执念中走出来了。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，恶魔牌正位意味着你被「物质」和「欲望」捆绑了——你为了钱做着不喜欢的工作，你为了名利牺牲了健康和快乐，你明明知道不对，但你停不下来。</p><p class="mb-2">也可能代表你在工作中遇到了「有毒」的环境——控制欲强的老板、勾心斗角的同事、让你很压抑的氛围。你想走，但你又舍不得，因为钱或者因为「稳定」。</p><p class="mb-2">恶魔牌提醒你：链子是松的，你随时可以走。你以为你被困住了，但其实困住你的，是你自己的执念和恐惧。</p><p>钱很重要，但快乐和健康更重要。不要为了钱，把自己的灵魂卖了。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「看见执念」的一天。看一看，你被什么困住了？你对什么上了瘾？你抓着什么不肯放手？</p><p class="mb-2">宇宙想告诉你：你以为你被困住了，但其实链子一直是松的。你随时都可以走出来，只要你愿意。</p><p class="mb-2">今天可以做一件事：想一想，你最近最放不下的是什么？然后问自己：「如果我放下了，会怎么样？」也许你会发现，放下了，天不会塌下来，反而会更轻松。</p><p>你是自由的。一直都是 😈✨</p>'
      },
      reversed: {
        ...
        career: '<p class="mb-2">在事业方面，恶魔牌逆位意味着你正在「解脱」——你可能辞掉了一份不喜欢的工作、离开了一个有毒的环境、或者摆脱了对金钱的执念。</p><p class="mb-2">你终于明白了：钱很重要，但快乐和健康更重要。你不再愿意为了钱出卖自己的灵魂，你要做你真正喜欢的事。</p><p class="mb-2">这个过程可能会有一点害怕——毕竟离开了熟悉的环境，未来是未知的。但请相信，这是你做过的最正确的决定之一。</p><p>勇敢地往前走吧。自由的人生，比什么都珍贵 ✨</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「解放日」！放下一件你一直抓着不放的事，跟过去的自己告个别。</p><p class="mb-2">宇宙想告诉你：你已经做得很好了。你已经从那段黑暗的时期里走出来了，你很棒。</p><p class="mb-2">今天可以做一件「庆祝自由」的事——买个小礼物送给自己、去吃一顿好吃的、或者只是好好地睡一觉。庆祝你重获新生。</p><p>自由的感觉，真好。去拥抱你的新生活吧 🎉</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 16, name: '高塔', emoji: '🗼', keyword: '突变',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，高塔牌正位意味着「突然的变化」——可能是突然被辞退、公司突然倒闭、项目突然失败、或者一个你以为很稳的机会突然没了。你可能觉得天塌下来了。</p><p class="mb-2">但请相信，这不是坏事。那份工作/那个项目，可能早就不适合你了，只是你一直舍不得走。宇宙用这种「强制」的方式把你推出来，是为了让你去更好的地方。</p><p class="mb-2">很多人都是在被辞退之后，才找到了真正热爱的事业；很多公司都是在倒闭之后，才催生了更伟大的创业。</p><p>塞翁失马，焉知非福。现在的「失去」，是为了给更好的「得到」腾位置。</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天可能会有一些「意外」发生。别害怕，那是宇宙在帮你清理。</p><p class="mb-2">宇宙想告诉你：有些东西，你舍不得扔，宇宙就帮你扔。有些人，你舍不得离开，宇宙就帮你离开。不是宇宙残忍，是宇宙知道，那些东西/人已经配不上现在的你了。</p><p class="mb-2">如果今天发生了什么让你震惊的事，深呼吸，告诉自己：一切的发生都是为了我的最高利益。现在我可能不懂，但总有一天我会明白。</p><p>塔倒了，是为了让你看到更广阔的天空。拥抱变化吧 ⚡✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「主动改变」。如果你知道有些事该结束了，今天就做个了断吧。</p><p class="mb-2">宇宙想提醒你：主动改变，比被动改变要好得多。你主动选择的，再难也是你说了算；被动接受的，再容易也会让你觉得无力。</p><p class="mb-2">今天可以做一件「断舍离」的事——辞掉不喜欢的工作、删掉不联系的人、扔掉没用的东西、或者放下一个执念。</p><p>主动的人生，才是自由的人生。去做你人生的主人吧 💪</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 17, name: '星星', emoji: '⭐', keyword: '希望',
    meaning: '<p class="mb-2">星星牌出现在高塔之后，就像暴风雨过后的星空。一位女子跪在水边，一手往地上倒水，一手往水里倒，天上有七颗星星在闪闪发光。</p><p class="mb-2">正位的星星牌，意味着希望、灵感、宁静和疗愈。黑暗过后，希望的星光永远在。你正在从创伤中走出来，你的内心正在慢慢愈合。</p><p>这张牌是一张非常治愈的牌。它告诉你：一切都会好起来的。你是被宇宙眷顾的。你的愿望会实现，只是需要一点时间。</p>',
    advice: '保持希望，相信美好的事情正在发生。你是被宇宙眷顾的。在安静中等待，星星会为你指引方向。',
    ...
    scenes: {
      upright: {
        love: '<p class="mb-2">在感情方面，星星牌正位是一张充满「希望」的牌。如果你是单身，星星牌告诉你：不要放弃希望，对的人正在来的路上。你现在可能觉得孤独，但再等等，他很快就到了。</p><p class="mb-2">如果你正在经历感情的低谷，星星牌是宇宙给你的安慰——一切都会好起来的。现在的痛只是暂时的，等你走出来，你会遇到更好的人、更好的爱情。</p><p class="mb-2">如果你已经有伴侣，星星牌意味着你们的关系会进入一个「治愈」的阶段——之前的矛盾和误会会慢慢化解，你们的感情会变得更纯粹、更美好。</p><p>星星会为你指引方向。不要放弃希望，美好的事情正在发生 ⭐</p>',
        ...
        guide: '<p class="mb-2">今日指引：今天是「许愿日」。对着星星许个愿吧，它会帮你实现的。</p><p class="mb-2">宇宙想告诉你：你不是一个人，你一直被守护着、被爱着。你的愿望宇宙听到了，它正在为你安排。不要急，也不要放弃。</p><p class="mb-2">今天适合做一些「安静」的事——看星星、写愿望、冥想、发呆……在安静中，你会听到宇宙的指引。</p><p>许个愿吧，星星会听到的 ✨🌠</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「给自己一点光」。如果你最近觉得很丧、看不到希望，今天就做一件让自己开心的小事吧。</p><p class="mb-2">宇宙想告诉你：你不是一个人，你没有被抛弃。只是现在乌云比较厚，你暂时看不到星星而已。但星星一直都在，从来没有离开过。</p><p class="mb-2">今天可以做的事：买束花给自己、点个好吃的外卖、看个搞笑的视频、跟好朋友聊聊天……先让自己开心一点点，就一点点。</p><p>慢慢来，会好起来的。我陪着你 🌟</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 18, name: '月亮', emoji: '🌕', keyword: '潜意识',
    meaning: '<p class="mb-2">月亮高悬在夜空中，下面是两只狗（或狼）在对月嚎叫，水里有一只小龙虾正在往上爬。月亮代表着潜意识、直觉、幻象和梦境。一切都朦朦胧胧的，看不真切。</p><p class="mb-2">正位的月亮牌，意味着事情可能不是你看到的样子。有很多隐藏的东西，你需要用心去感受，而不是用眼睛去看。</p><p>这张牌提醒你：相信你的直觉，它在指引你。关注你的梦，关注你心里的「感觉」。有些真相需要用心去感受，而不是用头脑分析。</p>',
    ...
    scenes: {
      upright: {
        ...
        career: '<p class="mb-2">在事业方面，月亮牌正位意味着「不确定」和「信息不透明」——你可能在做一个项目，但你不知道前景怎么样；你可能收到了一个offer，但你不知道靠不靠谱；你可能想创业，但心里没底。</p><p class="mb-2">月亮牌也代表「潜意识的创造力」——如果你做的是创意类、艺术类、或者需要灵感的工作，现在是非常好的时期。你的潜意识里有很多宝藏，只是你还没挖出来。</p><p class="mb-2">月亮牌提醒你：在看不清方向的时候，相信你的直觉。你的第一感觉、你的「我觉得」，往往是对的。</p><p>不用急着做决定。等迷雾散去，答案自然会浮现。</p>',
        emotion: '<p class="mb-2">在情绪方面，月亮牌正位代表着「不安」和「迷茫」——你最近可能情绪起伏很大，一会儿开心一会儿难过，你自己都不知道为什么。你心里有很多的不确定和不安全感。</p><p class="mb-2">也可能代表你最近「梦很多」——你的潜意识正在通过梦跟你说话。那些奇怪的、让你印象深刻的梦，都有它的意义。</p><p class="mb-2">没关系，这些都是正常的。月亮的光芒本来就是朦胧的，情绪本来就是流动的。不用逼自己「一定要开心」「一定要想清楚」。</p><p>允许自己迷茫，允许自己不安。迷雾终会散去，月亮也有阴晴圆缺。一切都是正常的 🌙</p>',
        guide: '<p class="mb-2">今日指引：今天适合「倾听直觉」。有什么拿不准的事，问问你的心。</p><p class="mb-2">宇宙想告诉你：你的头脑可能会骗你，但你的直觉不会。你心里的那个「第一反应」「第一个念头」「那种说不出来的感觉」，往往就是答案。</p><p class="mb-2">今天也适合「关注你的梦」——昨晚做了什么梦？梦里有什么让你印象深刻的画面？那些都是你的潜意识在跟你说话。</p><p>静下来，听听你心里的声音。它一直都在，只是平时太吵了你听不到 🌙</p>'
      },
      reversed: {
        ...
        emotion: '<p class="mb-2">在情绪方面，月亮牌逆位代表着「拨云见日」——你之前的不安、迷茫、焦虑，正在慢慢散去。你开始想清楚一些事，你开始平静下来了。</p><p class="mb-2">你可能会有一种「哦，原来是这样啊」的感觉。之前困扰你的情绪，现在你终于知道是怎么回事了。看见了，就好办了。</p><p class="mb-2">但也要注意：不要因为「想清楚了」就开始过度理性，把自己的感受都压抑下去。理性很重要，感受也很重要。</p><p>你正在慢慢好起来。继续往前走，天快亮了 🌅</p>',
        guide: '<p class="mb-2">今日指引：今天是「拨云见日」的一天。之前想不通的事，今天可能突然就想通了。</p><p class="mb-2">宇宙想告诉你：你之前的迷茫和不安，都是暂时的。答案一直都在，只是被迷雾遮住了。现在，迷雾正在散去，你慢慢就能看到了。</p><p class="mb-2">今天也适合「做决定」——如果你之前一直在纠结某件事，今天你可能会突然有答案。相信那个答案。</p><p>迷雾散了，路就清晰了。勇敢地往前走吧 ✨</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 19, name: '太阳', emoji: '☀️', keyword: '快乐',
    meaning: '<p class="mb-2">太阳当空照，地上的孩子骑着白马，手里拿着向日葵。一切都光明、温暖、快乐、充满活力。太阳牌是大阿卡纳中最积极的牌之一。</p><p class="mb-2">正位的太阳牌，意味着快乐、成功、活力和光明。一切都在往好的方向发展。你充满了能量和热情，你想做的事情都会成功。</p><p>这张牌提醒你：尽情享受当下的美好吧！你值得所有的快乐和成功。像孩子一样，开心地笑，尽情地玩。生活可以很简单、很快乐。</p>',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「太阳日」！去做一件让你开心的事，像孩子一样，毫无顾忌地笑一次。</p><p class="mb-2">宇宙想告诉你：你值得所有的快乐。不要总觉得「我还不够好所以不配开心」「等我成功了再开心」。不，你现在就值得开心，就因为你是你。</p><p class="mb-2">今天也适合「晒太阳」——出去走走，晒晒太阳，感受阳光洒在脸上的感觉。你就是自己的太阳，你走到哪里，哪里就有光。</p><p>今天也要开开心心的哦 ☀️😊</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「找回快乐」。做一件你小时候很喜欢、但很久没做的事。</p><p class="mb-2">宇宙想告诉你：快乐不是等来的，是自己找的。不要等「成功了」再开心，不要等「有钱了」再开心，不要等「遇到对的人」再开心。现在就可以开心。</p><p class="mb-2">今天可以做的事：吃个冰淇淋、看个动画片、吹个泡泡、晒晒太阳……做一件很傻很开心的事。</p><p>快乐是一种选择，也是一种能力。从今天开始，练习开心吧 ☀️</p>'
      }
    },
    positionInterpretation: {
  ...
  { id: 20, name: '审判', emoji: '📯', keyword: '觉醒',
    meaning: '<p class="mb-2">审判日到来，天使吹响号角，死者从坟墓里复活，接受最后的审判。这张牌代表着觉醒、重生、召唤和宽恕。</p><p class="mb-2">正位的审判牌，意味着你正在经历一个觉醒的时刻。你突然想通了一些事情，你决定放下过去，重新开始。你听到了灵魂的召唤，你要去做你真正想做的事。</p><p>这张牌提醒你：放下对自己的评判，原谅过去的自己。每一天都是新的开始。你正在重生，你正在成为更新版本的自己。</p>',
    ...
    scenes: {
      upright: {
        love: '<p class="mb-2">在感情方面，审判牌正位代表着「复合」和「重生」。如果你心里还想着某个人，审判牌是一个好消息——你们可能会重新联系、重新开始。这一次，会比以前更好。</p><p class="mb-2">也可能代表你在感情中「觉醒」了——你突然想通了很多事，你放下了过去的伤害和执念，你准备好迎接新的爱情了。你「重生」了。</p><p class="mb-2">如果你已经有伴侣，审判牌意味着你们的关系会经历一次「升华」——过去的误会和伤害会被原谅和疗愈，你们的感情会进入一个全新的阶段。</p><p>每一天都是新的开始。过去的都过去了，未来还很长。去爱吧，像从来没有受过伤一样 📯</p>',
        career: '<p class="mb-2">在事业方面，审判牌正位意味着「觉醒」和「召唤」——你可能突然意识到「这不是我想要的生活」，你听到了内心的声音，它在召唤你去做你真正想做的事。</p><p class="mb-2">也可能代表一个「迟来的回报」——你之前的努力和付出，会在这个时候得到认可和回报。虽然来得晚了一点，但它终究是来了。</p><p class="mb-2">审判牌提醒你：听从你内心的召唤。不要因为害怕、因为别人的眼光、因为「现实」，就放弃你真正想做的事。人生只有一次，去做你热爱的事吧。</p><p>听到了召唤，就勇敢回应它。你的人生，会因此而不同 ✨</p>',
        emotion: '<p class="mb-2">在情绪方面，审判牌正位代表着「觉醒」和「放下」——你突然想通了很多事，你放下了对自己的评判和指责，你原谅了过去的自己。</p><p class="mb-2">你有一种「重生」的感觉。就好像过去的那个你已经「死」了，现在的你是一个全新的你。你看事情的角度不一样了，你对自己的态度不一样了，你整个人都不一样了。</p><p class="mb-2">这种感觉非常棒。就像睡了很久很久，终于醒过来了。你睁开眼睛，发现世界是新的，你也是新的。</p><p>恭喜你重生！新的人生，开始了 🌟</p>',
        guide: '<p class="mb-2">今日指引：今天是「觉醒日」。听一听你心里的声音——它在召唤你去做什么？</p><p class="mb-2">宇宙想告诉你：你听到的那个声音，那个「我想……」「要是能……就好了」，那不是空想，那是你的灵魂在召唤你。</p><p class="mb-2">今天也适合「原谅自己」——过去的事，不管是什么，都让它过去吧。你已经惩罚自己够久了。今天，就跟过去的自己和解吧。</p><p>每一天都是新的开始。今天，就是你新人生的第一天 📯✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「原谅自己」。把你一直责怪自己的那件事，今天就放下吧。</p><p class="mb-2">宇宙想告诉你：你不需要完美，你不需要做到最好，你不需要所有人都满意。你已经做得很好了，你值得被原谅，首先是被你自己原谅。</p><p class="mb-2">今天可以做一个「原谅仪式」——写一封信给过去的自己，告诉她/他：「没关系，我原谅你了。」然后把它撕掉或者烧掉。</p><p>从今天起，做一个新的人。每一天，都是重生 📯</p>'
      }
    },
    positionInterpretation: {
      past: '过去的你，经历过一次「觉醒」——也许是某件事让你突然想通了，也许是某个人点醒了你，也许是你自己慢慢悟了。那次觉醒，改变了你的人生轨迹。',
  ...
  { id: 21, name: '世界', emoji: '🌍', keyword: '完成',
    ...
    scenes: {
      upright: {
        ...
        guide: '<p class="mb-2">今日指引：今天是「庆祝日」！为你已经完成的事、已经取得的成就，好好庆祝一下吧。</p><p class="mb-2">宇宙想告诉你：你已经走了很远很远了。你做得很好，你很棒。不要总盯着你还没有的，多看看你已经拥有的。你会发现，你已经很富有了。</p><p class="mb-2">今天也适合「收尾」——有什么一直拖着没做完的事，今天就把它做完吧。画上一个圆满的句号，然后准备好迎接新的开始。</p><p>完成，然后庆祝。然后，下一段旅程，会更精彩 🌍✨</p>'
      },
      reversed: {
        ...
        guide: '<p class="mb-2">今日指引：今天适合「盘点」和「庆祝」。盘点一下你已经拥有的东西，然后为它们庆祝。</p><p class="mb-2">宇宙想提醒你：不要总盯着你还没有的。看看你已经拥有的——健康、家人、朋友、能吃饱穿暖、能看到明天的太阳……你已经很富有了。</p><p class="mb-2">今天也适合「收尾」——有什么一直拖着没做完的事，今天就把它做完吧。画上句号，不管它完不完美。</p><p>完成比完美更重要。你已经做得很好了 🌍</p>'
      }
    },
    positionInterpretation: {
...
function selectTarotSpread(spread) {
  ...
  if (spread === 'single') {
    ...
    t.style.color = '';
    document.getElementById('tarot-draw-hint').textContent = '点击牌背抽一张牌';
    document.getElementById('tarot-cards-container').innerHTML = `
    ...
    s.style.color = '';
    document.getElementById('tarot-draw-hint').textContent = '点击牌背抽三张牌（过去·现在·未来）';
    document.getElementById('tarot-cards-container').innerHTML = `
  ...
  document.getElementById('tarot-draw-area').classList.remove('hidden');
  document.getElementById('tarot-result').classList.add('hidden');
  document.getElementById('tarot-single-result').classList.toggle('hidden', spread !== 'single');
  document.getElementById('tarot-three-result').classList.toggle('hidden', spread !== 'three');
...
function drawSingleTarot() {
  ...
  setTimeout(() => {
    document.getElementById('tarot-draw-area').classList.add('hidden');
    document.getElementById('tarot-result').classList.remove('hidden');
    document.getElementById('tarot-single-result').classList.remove('hidden');
    document.getElementById('tarot-three-result').classList.add('hidden');
    
    document.getElementById('tarot-card-name').textContent = (isReversed ? '逆位 · ' : '正位 · ') + card.name;
    document.getElementById('tarot-card-pos').textContent = isReversed ? '逆位 REVERSED' : '正位 UPRIGHT';
    document.getElementById('tarot-card-front').textContent = card.emoji;
    document.getElementById('tarot-card-front').style.transform = isReversed ? 'rotate(180deg)' : '';
    ...
    document.getElementById('tarot-meaning').innerHTML = `
      <div class="mb-3">
    ...
    `;
    document.getElementById('tarot-advice').innerHTML = advice;
...
function drawThreeTarot() {
  ...
  const posDesc = ['代表过去的能量和经历，是事情的根源', '代表当下的状态和你现在的处境', '代表未来的走向和可能的结果'];
  
  // 翻牌动画
  setTimeout(() => {
    document.getElementById('tarot-draw-area').classList.add('hidden');
    document.getElementById('tarot-result').classList.remove('hidden');
    document.getElementById('tarot-single-result').classList.add('hidden');
    document.getElementById('tarot-three-result').classList.remove('hidden');
    
    // 三张牌展示
    document.getElementById('three-cards-display').innerHTML = cards.map((c, i) => `
    ...
    // 详细解读
    const catNames = { love: '感情', career: '事业', emotion: '情绪', guide: '今日指引' };
    document.getElementById('three-cards-detail').innerHTML = cards.map((c, i) => {
      ...
      <div class="p-4 rounded-2xl" style="background:linear-gradient(135deg, rgba(245,230,200,0.25), rgba(240,213,224,0.15)); border:1px solid rgba(245,230,200,0.3)">
        <div class="font-title text-sm mb-2" style="color:#B8955A">💫 综合能量解读</div>
...
function generateThreeCardAdvice(cards) {
  ...
  return `这三张牌串起了你的能量流动：从「${cards[0].name}」的过去能量，走到「${cards[1].name}」的当下状态，再走向「${cards[2].name}」的未来可能。整体来看，${cards[2].reversed ? '未来还有一些需要调整的地方' : '未来的走向是积极的'}。重点关注当下的「${cards[1].name}」这张牌给你的提示——它是连接过去和未来的桥梁。${cards[1].advice.slice(0, 50)}... 相信你的直觉，一步一步来，一切都会越来越好的 ✨`;
}
...
const PLANS = {
  beginner: {
    ...
    total: 21,
    color: '#D4B5C7',
    intro: '欢迎来到21天新手显化计划！这21天里，我们会从「认识显化」到「清理信念」到「许愿」到「行动」，一步一步带你走进显化的世界。不用急，每天完成一个小任务就好。21天后，你会发现自己已经不一样了 ✨',
    tasks: [
      { day: 1, title: '认识显化：你的想法创造你的现实', guide: '欢迎来到第一天！今天我们不做复杂的练习，只需要你先了解一个核心概念：你的想法和感觉，正在创造你的现实。你生命中发生的一切，都是你内在意识的投射。从今天开始，试着留意：你每天都在想些什么？', practice: '拿一张纸，写下你最想显化的3个愿望。不用管「能不能实现」，就写你真正想要的。然后，在每个愿望旁边，写下你为什么想要它——它会给你带来什么感觉？', affirm: '我是我生命的创造者，我想要的一切都在向我走来。' },
      { day: 2, title: '找出你的限制性信念', guide: '显化最大的障碍是什么？是你内心深处那些「我不行」「我不配」「不可能」的信念。这些信念就像玻璃天花板，你看不见它，但它挡住了你。今天的任务就是：找出它们。', practice: '看着你昨天写下的3个愿望，问自己：「我相信我能得到它吗？」如果答案是「不」或者「不确定」，继续问：「为什么？」把冒出来的所有负面想法都写下来。这些就是你的限制性信念。', affirm: '我愿意看见我的限制性信念，看见就是改变的开始。' },
      ...
      { day: 4, title: '镜子练习：学会爱自己', guide: '自我概念是显化的核心。你怎么看待自己，世界就怎么对待你。镜子练习是最简单也最有效的提升自我概念的方法之一。今天，我们从镜子开始。', practice: '找一面镜子，看着镜子里自己的眼睛，认真地说10遍「我爱你」。如果说不出口也没关系，先从「我愿意学着爱你」开始。说完之后，写下你心里的感受。', affirm: '我爱我自己，我值得被好好爱着。' },
      { day: 5, title: '感恩练习：培养丰盛感', guide: '感恩是最快的「频率提升器」。当你感恩的时候，你处于最高频的状态。你感恩什么，就会吸引更多什么。今天开始，培养每天感恩的习惯。', practice: '写下10件你今天感恩的小事。不用是什么大事，「今天天气很好」「早餐很好吃」「公交车刚好赶上」都可以。写完之后，闭上眼睛，感受一下那种感恩的心情。', affirm: '我拥有的已经足够多，而且越来越多。' },
      { day: 6, title: 'BE-DO-HAVE：重新定义你的愿望', guide: '大多数人搞反了顺序：他们以为「等我有了钱（HAVE），我就能做我想做的事（DO），然后我就会快乐（BE）」。但宇宙的顺序是反过来的：先BE，再DO，然后自然会HAVE。', practice: '对你的每个愿望，都问自己三个问题：①拥有了它之后，我会成为什么样的人（BE）？②拥有了它之后，我会做什么（DO）？③我想要的到底是什么东西（HAVE）？然后，从今天开始，就先BE那个人。', affirm: '我已经是我想成为的那个人，我正在过我想过的生活。' },
      { day: 7, title: '视觉化练习：第一次「看见」你的愿望', guide: '恭喜你完成了第一周！今天我们来做第一个视觉化练习。视觉化不是「空想」，是在你的脑海里创造一个新的「记忆」。当你的潜意识接受了这个「记忆」，它就会帮你把它变成现实。', practice: '找一个安静的地方，闭上眼睛，深呼吸5次。然后想象你的愿望已经实现了。用第一视角，看到什么？听到什么？摸到什么？心里什么感觉？在那个感觉里待5分钟。', affirm: '我能清晰地看到我的愿望，它已经是我的了。' },
      { day: 8, title: '清理空间：为新事物腾地方', guide: '外在空间是内在空间的反射。你的房间乱不乱，反映了你的心乱不乱。今天我们来做一次「能量大扫除」，为你想要的新事物腾出空间。', practice: '清理你的房间（或者至少一个角落）。扔掉、捐掉那些你不再需要的东西。整理的过程中，想象你也在清理你内在的旧信念、旧模式。清理完之后，感受一下那种清爽的感觉。', affirm: '我清理掉所有不再服务于我的东西，为美好事物腾出空间。' },
      { day: 9, title: '快乐优先级：先让自己开心', guide: '很多人以为「等我实现了愿望我就会开心」，但真相是：你先开心了，愿望才会来。开心不是结果，是原因。今天的任务很简单：让自己开心。', practice: '做一件让你自己开心的小事。什么都可以——吃好吃的、看喜欢的剧、散步、听歌、发呆。重点是：在做这件事的时候，完完全全地享受它，不要想别的，不要有负罪感。', affirm: '我的快乐是最重要的，我越开心，显化越快。' },
      ...
      { day: 12, title: 'SATS冥想：睡前的强效显化', guide: '今天我们来学习SATS——睡前半梦半醒状态下的显化。这是内维尔戈达德最核心的方法之一，效果非常强大。睡前的几分钟，胜过白天的几小时。', practice: '今晚睡觉前，躺下来，放松身体，感觉快要睡着的时候，开始视觉化你的愿望。不用很长，一个10秒的小场景就够了。反复播放这个场景，直到你睡着。', affirm: '我每天晚上都在潜意识里种下美好的种子。' },
      { day: 13, title: '记录好事：积累「我很幸运」的证据', guide: '星愿信心来自哪里？来自一次又一次「成功」的经验。哪怕是很小的成功，积累多了，你就会越来越相信「我总能星愿成真」。', practice: '记录今天发生的3件好事/小确幸。什么都可以——路上遇到了可爱的猫、喜欢的歌刚好在放、有人对你笑了。每一件都认真地写下来，然后在心里说「谢谢」。', affirm: '好事总是发生在我身上，我是被宇宙眷顾的人。' },
      ...
      { day: 16, title: '数字排毒：清理你的信息环境', guide: '你每天看的东西、听的东西、关注的东西，都在影响你的潜意识。就像吃什么食物决定你的身体一样，「吃」什么信息决定你的精神。今天我们来做一次「信息排毒」。', practice: '清理你的手机：取关那些让你焦虑、嫉妒、自卑的账号；删掉没用的APP；整理你的相册。然后，今天给自己几个小时「不看手机」的时间，去做别的事。', affirm: '我选择让美好的信息进入我的生命。' },
      { day: 17, title: '肯定语轰炸：100遍的力量', guide: '重复是改变潜意识的钥匙。今天，我们来做一次「肯定语轰炸」——选一句你最有感觉的肯定语，重复100遍。', practice: '选一句你最喜欢的肯定语（可以是你自己写的，也可以从肯定语库里选）。找一个安静的地方，大声地或者在心里念100遍。念的时候，尽量去感受那句话的真实感。', affirm: '我每天都在强化我的正面信念，它们正在变成现实。' },
      { day: 18, title: '同频的人：你身边的人很重要', guide: '你身边的人，会潜移默化地影响你的信念和频率。和积极的人在一起，你会变得更积极；和消极的人在一起，你会变得更消极。今天，我们来看看你的「社交环境」。', practice: '给一个积极向上的朋友发一条消息，聊聊天，或者约出来见面。感受一下，和积极的人在一起，你的心情是什么样的。同时，想一想：哪些关系在消耗你？你可以慢慢减少它们的比重。', affirm: '我吸引同频美好的人来到我的生命里。' },
      ...
      { day: 20, title: '活在终点日：用终点状态过一整天', guide: '倒数第二天！今天是「活在终点日」——用你愿望已经实现的状态，完完整整过一天。从早上醒来，到晚上睡觉，都以「已经拥有了」的心态去生活。', practice: '早上醒来第一件事，就告诉自己：「我的愿望已经实现了。」然后，带着这个信念过一天。说话、做事、思考，都以「已经拥有的我」的方式。遇到任何事，都问自己：「已经拥有的我会怎么想、怎么做？」', affirm: '我活在愿望已经实现的状态里，一切都是完美的。' },
      { day: 21, title: '毕业典礼：你已经不一样了', guide: '🎉 恭喜你！21天计划完成了！你可能没有意识到，但你已经不是21天前的那个你了。你的信念变了，你的频率变了，你的人生正在改变。今天，好好庆祝一下吧！', practice: '给自己一个奖励——吃一顿好吃的、买一件小礼物、做一件你喜欢的事。然后，写下来：这21天我最大的收获是什么？接下来我想继续练习什么？最后，对自己说一声：「你真棒，我爱你。」', affirm: '我完成了21天计划，我为自己感到骄傲。我的显化能力越来越强！' },
    ],
  },
  sp: {
    title: '7天SP恋爱显化计划',
    total: 7,
    color: '#D4A5B8',
    intro: '欢迎来到7天SP显化计划！SP = Specific Person，特定的人。显化SP的核心不是「改变他/她」，而是「改变你对他/她的看法」，以及「改变你的自我概念」。这7天，我们从内在出发，一步步调整到「已经在一起」的状态。记住：你变了，他/她就会变 💖',
    tasks: [
      ...
      { day: 2, title: '第二天：清理你对爱情的限制性信念', guide: '为什么很多人显化SP不成功？因为他们内心深处不相信「自己值得被爱」。这些限制性信念，就像一堵墙，挡住了你的愿望。今天我们来找出它们、清理它们。', practice: '问自己几个问题：「我相信我值得被爱吗？」「我相信他/她会爱上我吗？」「我相信好的爱情会发生在我身上吗？」把冒出来的所有负面想法都写下来。然后，把每一条负面信念，改成一句正面肯定语。', affirm: '我值得被全心全意地爱着，我想要的人也在想着我。' },
      { day: 3, title: '第三天：稳定你的自我概念', guide: '显化SP的关键，其实是「自我概念」。你觉得自己值得被爱，别人就会爱你；你觉得自己会被抛弃，别人就会离开你。所以，与其天天想「他/她爱不爱我」，不如把注意力放回自己身上。', practice: '写10条「我是...」的肯定语，关于你值得被爱的。比如「我是值得被珍惜的」「我是独一无二的」「我是让人着迷的」。今天之内，把这10条至少念3遍，每一遍都认真感受。', affirm: '我是独一无二、值得被深深爱着的。爱我的人自然会向我走来。' },
      { day: 4, title: '第四天：视觉化——在一起的温馨场景', guide: '今天我们来做视觉化练习。在脑海里「创造」一个你和SP在一起的温馨场景。越细节越好，越真实越好。当你的潜意识接受了这个「画面」，它就会帮你把它变成现实。', practice: '找一个安静的地方，闭上眼睛，深呼吸。想象一个你和SP在一起的场景——比如一起吃饭、一起散步、拥抱、聊天。用第一视角：你看到什么？听到什么？摸到什么？他/她的声音是什么样的？你心里什么感觉？在那个感觉里待至少5分钟。', affirm: '我能清晰地感受到和他/她在一起的甜蜜，这已经是我的现实了。' },
      { day: 5, title: '第五天：修正你对SP的看法', guide: '你生命中的每一个人，都是你的投射。你怎么看待SP，他/她就会怎么对你。如果你觉得他/她冷漠，他/她就会对你冷漠；如果你觉得他/她很爱你，他/她就会很爱你。今天，我们来「重新定义」SP。', practice: '写下你对SP的所有负面看法（比如「他/她很冷漠」「他/她不喜欢我」）。然后，把每一条都改成正面的（比如「他/她很热情」「他/她超级喜欢我」）。写完之后，读3遍，读的时候尽量去相信。', affirm: '他/她每天都在想我，他/她超级爱我，他/她只想要我。' },
      { day: 6, title: '第六天：活在终点——用「已经在一起」的状态生活', guide: '今天是「活在终点日」。用「已经和SP在一起了」的心态，完完整整过一天。从早上醒来到晚上睡觉，都以「他/她是我的男/女朋友」的身份去生活。', practice: '早上醒来，第一件事就想：「真好，我们在一起了。」然后，带着这个感觉过一天。想他/她的时候，想的是「我们在一起真好」，而不是「他/她什么时候来找我」。遇到任何事，都问自己：「已经在一起的我会怎么想？」', affirm: '我们已经在一起了，每一天都很甜蜜，他/她只爱我一个人。' },
      { day: 7, title: '第七天：放下执念，好好爱自己', guide: '最后一天！今天的主题是「放下」。很多人显化不成功，就是因为太「抓」了——天天检查、天天焦虑，这种「我还没有」的感觉，反而把愿望推得更远。放下不是放弃，是「相信它已经是我的了，所以我不用急」。', practice: '今天，一整天都不要主动联系SP（如果你们已经在联系，就正常回应，但不要主动找话题）。把注意力完全放回自己身上：做你喜欢的事、和朋友出去玩、好好爱自己。你越开心、越不在乎，他/她来得越快。', affirm: '我放下所有的焦虑和抓取，我知道他/她已经是我的了。我好好爱自己，一切都会自然到来。' },
    ],
  },
  money: {
    title: '14天财富显化计划',
    total: 14,
    color: '#E8C87A',
    intro: '欢迎来到14天财富显化计划！显化财富的核心，不是「怎么赚钱」，而是「你和金钱的关系」。你觉得钱是好东西还是坏东西？你觉得自己值得拥有财富吗？你和金钱的关系好不好？这14天，我们从根上调整你和金钱的关系，让钱宝宝主动来找你 💰',
    tasks: [
      { day: 1, title: '第一天：写下你想要多少钱', guide: '显化的第一步是「明确」。你不能只说「我想变有钱」，你得说清楚你想要多少钱、用来做什么、什么时候要。越具体，宇宙越容易给你发货。', practice: '写下你想显化的具体金额（比如「3个月内多赚2万元」）。然后写下：这笔钱你打算用来做什么？越具体越好——买什么、吃什么、去哪里玩。最后，闭上眼睛，想象你已经有了这笔钱的感觉。', affirm: '金钱从四面八方涌向我，我想要的金额轻松到账。' },
      ...
      { day: 4, title: '第四天：感恩金钱——对每一分钱说谢谢', guide: '感恩是最快的「放大器」。你感恩什么，就会得到更多什么。如果你对花出去的钱都心怀感恩，钱就会更愿意来找你——因为它知道你会好好对待它。', practice: '今天，每花一笔钱（哪怕是一块钱），都在心里说一声「谢谢」。感谢这笔钱帮你买到了东西、带来了方便。同时，每收到一笔钱（哪怕是几分钱的红包），也说一声「谢谢，欢迎再来」。', affirm: '我感恩我拥有的每一分钱，金钱喜欢流向感恩的人。' },
      { day: 5, title: '第五天：视觉化——银行账户里的数字', guide: '今天我们来做财富视觉化。在脑海里「看到」你想要的金额，「感受到」拥有它的感觉。视觉化不是空想，是在给你的潜意识「编程」。', practice: '闭上眼睛，想象你打开手机银行APP，看到账户余额是你想要的数字。那个数字具体是多少？小数点后有几位数？你看到它的时候，心里什么感觉？是安心？是喜悦？是满足？在那个感觉里待至少5分钟。', affirm: '我的银行账户余额每天都在增长，钱宝宝源源不断地来找我。' },
      ...
      { day: 7, title: '第七天：让钱流动——做一次「丰盛消费」', guide: '财富的本质是「流动」。你越愿意让钱流动（花在让你开心的地方），钱就越愿意流向你。守财奴反而留不住钱，因为他们的「恐惧」会把钱推开。', practice: '今天花一笔钱，花在让你开心的事情上——可以是一杯奶茶、一本想看的书、一束花。花钱的时候，不要想「又花了多少钱」，要想「真好，我用这笔钱买到了快乐/价值」。感受那种「我付得起、我很丰盛」的感觉。', affirm: '钱花出去会带更多朋友回来，我的钱越花越多。' },
      ...
      { day: 11, title: '第十一天：记录所有进账——哪怕只有一分钱', guide: '很多人只关注「大钱」，忽略了「小钱」。但宇宙的逻辑是：你对小钱感恩，就会给你更多大钱。今天，我们来做「进账记录」。', practice: '今天记录所有的「进账」——工资、红包、优惠券、别人请你喝的奶茶、路上捡到的一块钱... 什么都算。每一笔都认真记下来，然后说一声「谢谢」。晚上看看你的记录，感受一下「我总是在收钱」的感觉。', affirm: '钱从四面八方来，每天都有进账，我越来越富有。' },
      { day: 12, title: '第十二天：和「有钱人」的思维对齐', guide: '你想变成有钱人，先学会像有钱人一样思考。不是说要变得势利，而是学习他们的「丰盛思维」——相信钱是无限的、相信自己能赚到、愿意投资自己、关注机会而不是困难。', practice: '问自己几个问题：「如果我是一个很有钱的人，我会怎么想？我会怎么做？我会怎么花钱？我会怎么看待金钱？」把答案写下来。然后，今天就试着用那种思维方式去生活一天。', affirm: '我拥有有钱人的思维，我正在变成越来越富有的人。' },
      { day: 13, title: '第十三天：活在终点——用「财富自由」的心态过一天', guide: '倒数第二天！今天是「活在终点日」。用「我已经财富自由了」的心态，完完整整过一天。不是让你乱花钱，而是让你感受那种「不缺钱、很安心」的感觉。', practice: '早上醒来，告诉自己：「我已经财富自由了，我有花不完的钱。」然后，带着这个感觉过一天。做决定的时候，问自己：「如果我财富自由了，我会怎么选？」不用真的花很多钱，重点是那种「安心、丰盛」的感觉。', affirm: '我已经财富自由了，我拥有源源不断的被动收入，我想要的一切都轻松到来。' },
      { day: 14, title: '第十四天：恭喜你，新的财富旅程开始了', guide: '🎉 14天财富计划完成了！这14天里，你清理了旧的金钱信念、建立了新的金钱观、练习了感恩和视觉化、迈出了行动的第一步。你和金钱的关系已经不一样了。从今天开始，继续保持这些好习惯，钱宝宝会越来越爱你的！', practice: '给自己一个奖励——用一笔「丰盛消费」来庆祝你的完成。然后，写下这14天你最大的3个收获，以及接下来你想继续坚持的3个习惯。最后，对自己说一声：「你真棒，你值得拥有所有的财富！」', affirm: '我完成了14天财富计划，我的财富能量已经升级。钱宝宝越来越爱我，我越来越富有！' },
    ],
  },
};
...
function selectPlan(type) {
  ...
  document.getElementById('plan-total-count').textContent = plan.total;
...
function renderPlanTasks() {
  ...
  document.getElementById('plan-done-count').textContent = doneCount;
  document.getElementById('plan-total-count').textContent = plan.total;
  document.getElementById('plan-progress-bar').style.width = (doneCount / plan.total * 100) + '%';
...
function selectTimerMode(mode) {
  ...
  document.getElementById('timer-mode-text').textContent = TIMER_MODES[mode].name;
  document.getElementById('timer-tip').textContent = TIMER_MODES[mode].tip;
  playSound('ding');
}
...
function resetTimer() {
  ...
  timerRemaining = timerDuration;
  updateTimerDisplay();
  document.getElementById('timer-toggle-btn').innerHTML = '▶️ 开始';
  playSound('page');
}
...
function renderPersonalSky() {
  ...
  document.getElementById('sky-total').textContent = state.wishes.length;
  document.getElementById('sky-done').textContent = state.wishes.filter(w => w.done).length;
}
...
function renderProgress() {
  ...
  document.getElementById('progress-belief').textContent = Math.round(belief) + '%';
  document.getElementById('progress-bar-belief').style.width = belief + '%';
  document.getElementById('progress-vision').textContent = Math.round(vision) + '%';
  document.getElementById('progress-bar-vision').style.width = vision + '%';
  document.getElementById('progress-state').textContent = Math.round(state_pct) + '%';
  document.getElementById('progress-bar-state').style.width = state_pct + '%';
  document.getElementById('progress-action').textContent = Math.round(action) + '%';
  document.getElementById('progress-bar-action').style.width = action + '%';
  ...
  document.getElementById('next-step-suggestion').textContent = nextStep;
}
...
function renderPalaceInfo() {
  document.getElementById('palace-nickname').value = state.nickname;
  document.getElementById('palace-energy').textContent = state.energy;
  document.getElementById('palace-wishes').textContent = state.wishes.length;
  document.getElementById('palace-flowers').textContent = (state.garden.flowers || []).filter(f => f.done).length;
  document.getElementById('palace-badges').textContent = state.badges.length;
  document.getElementById('palace-level').textContent = getLevel();

  const p = PERSONAS.find(x => x.id === state.mainPersona);
  document.getElementById('palace-persona-name').textContent = p ? p.name : '待解锁';
...
function renderPalaceStats() {
  const start = state.startDate ? new Date(state.startDate) : new Date();
  const days = Math.max(1, Math.ceil((Date.now() - start.getTime()) / (1000 * 60 * 60 * 24)));
  document.getElementById('palace-days').textContent = days;
  document.getElementById('palace-tests').textContent = state.testHistory.length;
  document.getElementById('palace-diaries').textContent = state.diaries.length;
}
...
function updateHomeStats() {
  document.getElementById('home-stat-wishes').textContent = state.wishes.length;
  document.getElementById('home-stat-purify').textContent = state.purify.total || 0;
  document.getElementById('home-stat-flowers').textContent = (state.garden.flowers || []).filter(f => f.done).length;
  const start = state.startDate ? new Date(state.startDate) : new Date();
  const days = Math.max(1, Math.ceil((Date.now() - start.getTime()) / (1000 * 60 * 60 * 24)));
  document.getElementById('home-stat-days').textContent = days;
  ...
  document.getElementById('daily-affirm-text').textContent = state.dailyAffirm;
}
...
function init() {
  ...
  // 重置每日
  const today = getTodayStr();
  const lastDay = localStorage.getItem('cosmos_island_lastday_v3');
  if (lastDay !== today) {
    state.purify.todayCount = 0;
    state.garden.todayCount = 0;
    state.todayDone = {};
    localStorage.setItem('cosmos_island_lastday_v3', today);
    saveState();
  }
  ...
  // 欢迎页：首次进入显示欢迎页，非首次直接进主岛
  if (!localStorage.getItem('cosmos_island_welcomed_v3')) {
    showPage('welcome');
  } else {
    goHome();
    // 已完成测试但未看过引导，进入主岛后显示引导
    if (state.mainPersona && !localStorage.getItem('cosmos_tutorial_done')) {
...
<!-- ========== 21天显化显化挑战 ========== -->
<section id="page-challenge" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">21天显化显化挑战</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      ...
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">第 <span id="challenge-current-day">1</span> 天</h2>
      <p class="text-sm mb-4" style="color:var(--text-soft)">连续打卡 <span id="challenge-streak">0</span> 天</p>
      <div class="progress-bar mb-2"><div id="challenge-progress" class="progress-fill" style="width:0%;background:linear-gradient(90deg,#D4B5C7,#B8A9C9)"></div></div>
      <p class="text-xs" style="color:var(--text-mute)">已完成 <span id="challenge-completed">0</span>/21 天</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <div class="flex items-center gap-2 mb-4"><span class="text-xl">📋</span><h3 class="font-medium">今日任务</h3></div>
      <div id="challenge-tasks" class="space-y-3"></div>
      <button id="challenge-checkin-btn" onclick="challengeCheckIn()" class="btn-primary btn-primary-lg w-full mt-5" style="display:none">完成今日打卡</button>
      <div id="challenge-completed-msg" class="text-center py-4" style="display:none">
        <div class="text-3xl mb-2">🎉</div>
        <p class="font-medium" style="color:var(--theme-primary)">今日任务已完成！</p>
        <p class="text-sm mt-1" style="color:var(--text-soft)">明天继续，你正在创造奇迹</p>
      </div>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-4">📅 21天路线图</h3>
      <div id="challenge-roadmap" class="grid grid-cols-7 gap-2"></div>
    </div>
  </div>
</section>

<!-- ========== 情绪导航器 ========== -->
<section id="page-emotion" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">情绪导航器</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6">
      <h2 class="text-center font-medium mb-4" style="font-family:'ZCOOL XiaoWei',sans-serif">你现在在哪里？</h2>
      <div class="emotion-scale mb-6"><div id="emotion-marker" class="emotion-marker" style="left:50%"></div></div>
      <div class="flex justify-between text-xs mb-6" style="color:var(--text-mute)">
        <span>绝望</span><span>抑郁</span><span>恐惧</span><span>愤怒</span><span>责备</span><span>失望</span><span>怀疑</span><span>担忧</span><span>乐观</span><span>希望</span><span>满足</span><span>喜悦</span>
      </div>
      <input type="range" id="emotion-slider" min="1" max="22" value="11" class="w-full mb-4" style="accent-color:#B8A9C9" oninput="onEmotionSlide(this.value)">
      <div id="emotion-current" class="text-center p-4 rounded-xl" style="background:rgba(212,181,199,0.1)">
        <div class="text-2xl mb-1" id="emotion-emoji">😐</div>
        <div class="font-medium" id="emotion-name">中立</div>
        <div class="text-sm mt-1" style="color:var(--text-soft)" id="emotion-desc">这是一个可以接受的起点</div>
      </div>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🚀 升阶练习</h3>
      <div id="emotion-exercise" class="p-4 rounded-xl text-sm" style="background:rgba(255,255,255,0.5);border:1px solid rgba(212,181,199,0.2)">选择一个情绪等级来查看对应的升阶练习</div>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">📝 情绪日记</h3>
      <textarea id="emotion-note" class="dream-input mb-3" rows="3" placeholder="记录下此刻的感受..."></textarea>
      <button onclick="saveEmotionNote()" class="btn-primary w-full py-3 rounded-xl">保存记录</button>
      <div id="emotion-history" class="mt-4 space-y-2" style="max-height:200px;overflow-y:auto"></div>
    </div>
  </div>
</section>

<!-- ========== SP显化专区 ========== -->
<section id="page-sp" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">SP显化专区</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">💕</div>
      <h2 class="text-xl font-medium mb-2" style="font-family:'ZCOOL XiaoWei',sans-serif">显化你的特定之人</h2>
      <p class="text-sm" style="color:var(--text-soft)">你不是在操控任何人，你在改变自己眼中的世界</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">💌 SP肯定语</h3>
      <div class="flex gap-2 mb-4 flex-wrap">
        <button class="chip-soft active" onclick="switchSpCategory(this,'all')">全部</button>
        <button class="chip-soft" onclick="switchSpCategory(this,'reunion')">复合</button>
        <button class="chip-soft" onclick="switchSpCategory(this,'new')">新人</button>
        <button class="chip-soft" onclick="switchSpCategory(this,'deepen')">升温</button>
      </div>
      <div id="sp-affirmations" class="space-y-3"></div>
    </div>
    <div class="glass-card p-5 mb-6">
      <div class="flex items-center justify-between mb-3">
        <h3 class="font-medium">🚫 忽略3D模式</h3>
        <div class="toggle-switch" id="ignore-3d-toggle" onclick="toggleIgnore3D()"></div>
      </div>
      <p class="text-sm mb-3" style="color:var(--text-soft)">开启后，系统会提醒你停止检查社交媒体和消息</p>
      <div id="ignore-3d-status" class="text-center p-4 rounded-xl" style="display:none;background:rgba(212,181,199,0.1)">
        <div class="text-2xl mb-1">🛡️</div><p class="font-medium">保护模式已开启</p><p class="text-xs mt-1" style="color:var(--text-soft)">你的能量正在被守护</p>
      </div>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">🎬 视觉化场景</h3>
      <div id="sp-scenes" class="space-y-3"></div>
    </div>
  </div>
</section>

<!-- ========== 财富丰盛专区 ========== -->
<section id="page-wealth" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">财富丰盛专区</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">💰</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">财富能量场</h2>
      <p class="text-sm" style="color:var(--text-soft)">你值得拥有丰盛的一切</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🔍 财富信念测试</h3>
      <p class="text-sm mb-3" style="color:var(--text-soft)">勾选你有感觉的限制性信念</p>
      <div id="wealth-beliefs" class="space-y-2">
        <label class="flex items-center gap-3 p-3 rounded-xl cursor-pointer" style="background:rgba(255,255,255,0.5)"><input type="checkbox" class="wealth-belief" value="赚钱必须很辛苦" style="accent-color:#B8A9C9;width:18px;height:18px"><span class="text-sm">赚钱必须很辛苦</span></label>
        <label class="flex items-center gap-3 p-3 rounded-xl cursor-pointer" style="background:rgba(255,255,255,0.5)"><input type="checkbox" class="wealth-belief" value="有钱人都不快乐" style="accent-color:#B8A9C9;width:18px;height:18px"><span class="text-sm">有钱人都不快乐</span></label>
        <label class="flex items-center gap-3 p-3 rounded-xl cursor-pointer" style="background:rgba(255,255,255,0.5)"><input type="checkbox" class="wealth-belief" value="谈钱很俗" style="accent-color:#B8A9C9;width:18px;height:18px"><span class="text-sm">谈钱很俗</span></label>
        <label class="flex items-center gap-3 p-3 rounded-xl cursor-pointer" style="background:rgba(255,255,255,0.5)"><input type="checkbox" class="wealth-belief" value="我不配赚很多钱" style="accent-color:#B8A9C9;width:18px;height:18px"><span class="text-sm">我不配赚很多钱</span></label>
        <label class="flex items-center gap-3 p-3 rounded-xl cursor-pointer" style="background:rgba(255,255,255,0.5)"><input type="checkbox" class="wealth-belief" value="钱不够花是正常的" style="accent-color:#B8A9C9;width:18px;height:18px"><span class="text-sm">钱不够花是正常的</span></label>
      </div>
      <div id="wealth-belief-result" class="mt-4 p-3 rounded-xl text-sm hidden" style="background:rgba(245,230,200,0.3);border:1px solid rgba(245,158,11,0.2)"></div>
      <button onclick="checkWealthBeliefs()" class="btn-primary w-full py-3 rounded-xl mt-4">查看我的财富模式</button>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">💫 丰盛肯定语</h3>
      <div id="wealth-affirmations" class="space-y-3"></div>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🪄 魔法支票</h3>
      <p class="text-sm mb-3" style="color:var(--text-soft)">填写你渴望收到的金额，感受已经拥有的喜悦</p>
      <div class="p-5 rounded-xl mb-4" style="background:linear-gradient(135deg,#FEF3C7,#FDE68A);border:1px solid #F59E0B;box-shadow:0 4px 20px rgba(251,191,36,0.15)">
        <div class="text-center text-xs mb-2" style="color:#B45309">宇宙银行 · 无限额度</div>
        <div class="flex items-center justify-center gap-2 mb-3">
          <span class="text-2xl font-bold" style="color:#B45309">¥</span>
          <input type="number" id="magic-check-amount" class="dream-input text-center text-xl font-bold" style="width:160px;color:#B45309;border-color:rgba(245,158,11,0.3)" placeholder="金额" min="0">
        </div>
        <input type="text" id="magic-check-purpose" class="dream-input text-sm text-center" placeholder="用途：感谢宇宙为我..." style="border-color:rgba(245,158,11,0.3)">
      </div>
      <button onclick="saveMagicCheck()" class="btn-primary w-full py-3 rounded-xl">签发魔法支票</button>
      <div id="magic-check-history" class="mt-4 space-y-2"></div>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">📈 收入显化日志</h3>
      <div class="flex gap-2 mb-3">
        <input type="number" id="wealth-income-amount" class="dream-input" placeholder="金额" style="flex:1">
        <input type="text" id="wealth-income-source" class="dream-input" placeholder="来源" style="flex:2">
      </div>
      <button onclick="addIncomeLog()" class="btn-primary w-full py-3 rounded-xl mb-4">记录一笔进账</button>
      <div id="wealth-income-list" class="space-y-2" style="max-height:200px;overflow-y:auto"></div>
    </div>
  </div>
</section>

<!-- ========== 疗愈影院模块 ========== -->
<section id="page-movies" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">疗愈影院</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">🎬</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">显化疗愈影院</h2>
      <p class="text-sm" style="color:var(--text-soft)">每一部电影都是一堂显化课</p>
    </div>
...
<!-- ========== AI 宇宙闺蜜 ========== -->
<section id="page-ai" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      ...
      <div class="text-center">
        <h1 class="text-lg font-medium" style="color:var(--theme-text)">宇宙闺蜜</h1>
        <p class="text-xs" style="color:var(--text-mute)">你的专属显化陪伴</p>
      </div>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div id="ai-chat-area" class="space-y-4 mb-4" style="min-height:300px">
      <div class="flex items-start gap-3">
        <div class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 text-white text-sm" style="background:linear-gradient(135deg,#E8B5C8,#C8A5D8)">🌙</div>
        <div class="p-4 rounded-2xl rounded-tl-sm text-sm" style="background:rgba(255,255,255,0.8);color:var(--theme-text);max-width:75%">嗨呀～我是你的宇宙闺蜜 🌙<br><br>今天心情怎么样？有什么想要显化的事情吗？你可以告诉我，我会陪你一起梳理情绪、设定意图，或者只是聊聊天 💕</div>
      </div>
    </div>
    <div class="flex gap-2 flex-wrap mb-3">
      <button onclick="sendAiPrompt('今天情绪很低落')" class="chip-soft text-xs">今天情绪很低落</button>
      <button onclick="sendAiPrompt('SP不理我怎么办')" class="chip-soft text-xs">SP不理我怎么办</button>
      <button onclick="sendAiPrompt('我想显化财富')" class="chip-soft text-xs">我想显化财富</button>
      <button onclick="sendAiPrompt('给我一句今天的肯定语')" class="chip-soft text-xs">今日肯定语</button>
      <button onclick="sendAiPrompt('我最近总是焦虑')" class="chip-soft text-xs">总是很焦虑</button>
    </div>
    <div class="flex gap-2">
      <input type="text" id="ai-input" class="dream-input" placeholder="和宇宙闺蜜说点什么..." onkeydown="if(event.key==='Enter')sendAiMessage()" style="flex:1">
      <button onclick="sendAiMessage()" class="btn-primary w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style="padding:0">
...
<!-- ========== 分享卡片模态框 ========== -->
<div id="share-card-modal" class="modal-backdrop" onclick="if(event.target===this)closeShareCard()">
  <div class="modal-content p-5" style="max-width:380px">
    <div class="flex items-center justify-between mb-4">
      <h3 class="font-medium">生成分享卡片</h3>
      <button onclick="closeShareCard()" class="w-8 h-8 rounded-full flex items-center justify-center" style="background:rgba(212,181,199,0.15)">✕</button>
    </div>
    <div id="share-card-preview" class="rounded-2xl p-6 mb-4 text-center" style="background:linear-gradient(135deg,#FFFEFF,#FAF5F7);border:1px solid rgba(255,255,255,0.8);box-shadow:0 8px 32px rgba(184,169,201,0.15)">
      <div class="text-xs mb-2" style="color:var(--text-mute)">✨ 星愿花园 · 星辰日记</div>
      <div id="share-card-date" class="text-xs mb-3" style="color:var(--text-mute)"></div>
      <div id="share-card-content" class="text-sm font-medium leading-relaxed mb-4" style="color:var(--theme-text);font-family:'ZCOOL XiaoWei',sans-serif"></div>
      <div class="flex items-center justify-center gap-2 text-xs" style="color:var(--text-mute)"><span>🏝️</span><span>星愿花园</span></div>
    </div>
    <div class="flex gap-2">
      <button onclick="downloadShareCard()" class="btn-primary flex-1 py-3 rounded-xl text-sm">保存图片</button>
      <button onclick="copyShareText()" class="btn-soft flex-1 py-3 rounded-xl text-sm">复制文字</button>
    </div>
  </div>
</div>

<!-- ========== 梦境工坊 ========== -->
<section id="page-dreams" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">梦境工坊</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">🌙</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">梦境是你的潜意识来信</h2>
      <p class="text-sm" style="color:var(--text-soft)">记录梦境，解读象征，发现宇宙给你的信号</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">📝 记录昨晚的梦</h3>
      <textarea id="dream-content" class="dream-input mb-3" rows="4" placeholder="描述你的梦境...越详细越好，颜色、情绪、人物、地点..."></textarea>
      <div class="flex gap-2 mb-3">
        <select id="dream-mood" class="dream-input" style="flex:1">
          <option value="">梦境情绪</option><option value="愉悦">😊 愉悦</option><option value="焦虑">😰 焦虑</option><option value="恐惧">😨 恐惧</option><option value="平静">😌 平静</option><option value="兴奋">🤩 兴奋</option><option value="悲伤">😢 悲伤</option><option value="神秘">🔮 神秘</option>
        </select>
        <select id="dream-lucid" class="dream-input" style="flex:1">
          <option value="">是否清醒梦</option><option value="是">✨ 是</option><option value="否">💤 不是</option><option value="模糊">🌫️ 模糊</option>
        </select>
      </div>
      <button onclick="saveDream()" class="btn-primary w-full py-3 rounded-xl">记录梦境</button>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🔮 常见梦境象征</h3>
      <div id="dream-symbols" class="grid grid-cols-2 gap-2"></div>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">📚 我的梦境日记</h3>
      <div id="dream-history" class="space-y-3" style="max-height:400px;overflow-y:auto"></div>
    </div>
  </div>
</section>

<!-- ========== 星愿成真故事墙 ========== -->
<section id="page-stories" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">显化故事墙</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">✨</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">每一个显化都是奇迹</h2>
      <p class="text-sm" style="color:var(--text-soft)">阅读他人的故事，分享你的奇迹，能量会倍增</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">📝 分享你的星愿奇迹</h3>
      <input type="text" id="story-title" class="dream-input mb-3" placeholder="给你的故事起个标题...">
      <select id="story-category" class="dream-input mb-3">
        <option value="">选择类别</option><option value="SP复合">💕 SP复合</option><option value="财富">💰 财富</option><option value="工作">💼 工作</option><option value="健康">🏥 健康</option><option value="自我成长">🌱 自我成长</option><option value="其他">🌟 其他</option>
      </select>
      <textarea id="story-content" class="dream-input mb-3" rows="4" placeholder="分享你的星愿故事...用了多久？做了什么？最后怎么实现的？"></textarea>
      <button onclick="submitStory()" class="btn-primary w-full py-3 rounded-xl">发布故事</button>
    </div>
    <div class="flex gap-2 mb-4 overflow-x-auto pb-1">
      <button class="chip-soft active" onclick="filterStories('all',this)">全部</button>
      <button class="chip-soft" onclick="filterStories('SP复合',this)">💕 SP复合</button>
      <button class="chip-soft" onclick="filterStories('财富',this)">💰 财富</button>
      <button class="chip-soft" onclick="filterStories('工作',this)">💼 工作</button>
      <button class="chip-soft" onclick="filterStories('自我成长',this)">🌱 成长</button>
    </div>
...
<!-- ========== SATS深度冥想引导器 ========== -->
<section id="page-sats" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">SATS冥想</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">🌙</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">SATS · 状态像似睡眠</h2>
      <p class="text-sm" style="color:var(--text-soft)">临睡前的黄金15分钟，改写你的潜意识</p>
    </div>

    <!-- 睡梦显化引导 v5.4 -->
    <div id="sats-guide" class="glass-card p-5 mb-6">
      <div class="flex items-center justify-between mb-4">
        <h3 class="font-medium" style="color:var(--theme-text)">🧘 分步引导</h3>
        <div class="text-xs" style="color:var(--text-mute)">第 <span id="sats-step-num">1</span> / 5 步</div>
      </div>
      <div id="sats-step-content" class="mb-4">
        <div class="text-lg font-medium mb-2" style="color:var(--theme-text)">1. 放松身体</div>
        <div class="text-sm mb-3" style="color:var(--text-soft)">从头顶到脚底，逐一放松每一块肌肉。深呼吸三次，让身体沉入床中。</div>
        <div class="p-3 rounded-xl text-center" style="background:rgba(212,181,199,0.1)">
          <div class="text-2xl mb-1">🫁</div>
          <div class="text-xs" style="color:var(--text-mute)">吸气 4秒 → 屏息 4秒 → 呼气 6秒</div>
        </div>
      </div>
      <div class="flex gap-2 justify-between">
        <button onclick="prevSatsStep()" id="sats-prev-btn" class="btn-soft px-4 py-2 rounded-xl text-sm hidden">← 上一步</button>
        <button onclick="nextSatsStep()" id="sats-next-btn" class="btn-primary px-4 py-2 rounded-xl text-sm flex-1">下一步 →</button>
      </div>
    </div>

    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🎬 选择你的场景</h3>
      <div id="sats-scenes" class="space-y-3"></div>
    </div>
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-5xl mb-4 font-medium" id="sats-timer" style="font-family:'ZCOOL XiaoWei',sans-serif;color:var(--theme-text)">15:00</div>
      <div class="flex gap-2 justify-center">
        <button onclick="startSatsTimer()" id="sats-btn-start" class="btn-primary px-6 py-2 rounded-xl">开始</button>
        <button onclick="pauseSatsTimer()" id="sats-btn-pause" class="btn-soft px-6 py-2 rounded-xl hidden">暂停</button>
        <button onclick="resetSatsTimer()" class="btn-soft px-6 py-2 rounded-xl">重置</button>
      </div>
      <p class="text-xs mt-4" style="color:var(--text-mute)">建议睡前进行，配合场景想象，直到自然入睡</p>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">📖 SATS 核心指引</h3>
      <div class="space-y-3 text-sm" style="color:var(--text-soft)">
        <p><span class="font-medium" style="color:var(--theme-text)">1. 放松身体</span> — 从头顶到脚底，逐一放松每一块肌肉</p>
        <p><span class="font-medium" style="color:var(--theme-text)">2. 想象场景</span> — 不是"看"画面，而是"进入"画面，成为其中的人</p>
        <p><span class="font-medium" style="color:var(--theme-text)">3. 感受情绪</span> — 最关键：让"已经拥有"的感觉充满全身</p>
        <p><span class="font-medium" style="color:var(--theme-text)">4. 循环重复</span> — 同一个场景在脑中反复播放，直到自然入睡</p>
        <p><span class="font-medium" style="color:var(--theme-text)">5. 信任过程</span> — 不需要知道"怎么做"，只需要知道"已经成"</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ========== 数据备份与导出 ========== -->
<section id="page-backup" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">数据备份</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <div class="glass-card p-5 mb-6 text-center">
      <div class="text-3xl mb-2">💾</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">守护你的星愿数据</h2>
      <p class="text-sm" style="color:var(--text-soft)">所有记录都值得被安全保存</p>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">📤 导出全部数据</h3>
      <p class="text-sm mb-4" style="color:var(--text-soft)">将你的星辰日记、情绪花园、打卡数据等导出为JSON文件，可跨设备迁移。</p>
      <div class="flex gap-2">
        <button onclick="exportAllData()" class="btn-primary flex-1 py-3 rounded-xl">导出备份文件</button>
        <button onclick="copyAllData()" class="btn-soft flex-1 py-3 rounded-xl">复制到剪贴板</button>
      </div>
    </div>
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">📥 导入数据</h3>
      <p class="text-sm mb-4" style="color:var(--text-soft)">从备份文件恢复数据，或粘贴JSON文本。</p>
      <textarea id="import-data-text" class="dream-input mb-3" rows="4" placeholder="粘贴备份JSON内容..."></textarea>
      <button onclick="importAllData()" class="btn-primary w-full py-3 rounded-xl">导入数据</button>
    </div>
    <div class="glass-card p-5">
      <h3 class="font-medium mb-3">📊 数据概览</h3>
      <div id="data-overview" class="space-y-2"></div>
    </div>
  </div>
</section>
...
<!-- ========== 会员中心 ========== -->
<section id="page-vip" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="goHome()" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">会员中心</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <!-- 会员卡片 -->
    <div class="glass-card p-5 mb-6 text-center relative overflow-hidden" style="background:linear-gradient(135deg,rgba(212,181,199,0.3),rgba(184,169,201,0.2));border:1.5px solid rgba(212,181,199,0.3)">
      <div class="text-3xl mb-2">👑</div>
      <h2 class="text-xl font-medium mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif" id="vip-tier-name">免费体验</h2>
      <p class="text-sm mb-3" style="color:var(--text-soft)" id="vip-tier-desc">升级会员，解锁全部显化工具</p>
      <div class="flex items-center justify-center gap-1 mb-3">
        <span class="text-2xl">💎</span>
        <span class="text-xl font-bold" style="color:var(--theme-text)" id="vip-crystal-count">0</span>
        <span class="text-xs" style="color:var(--text-mute)">星光水晶</span>
      </div>
      <button id="vip-upgrade-btn" onclick="showVipPlans()" class="btn-primary w-full py-3 rounded-xl" style="display:none">升级会员</button>
      <button id="vip-renew-btn" onclick="showVipPlans()" class="btn-soft w-full py-3 rounded-xl" style="display:none">续费会员</button>
    </div>
    ...
    <div class="glass-card p-5 mb-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <span class="text-xs" style="color:var(--text-mute)">连续 <span id="checkin-streak">0</span> 天</span>
      </div>
      <div class="grid grid-cols-7 gap-2 mb-3">
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-1"><div class="text-xs" style="color:var(--text-mute)">一</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+5</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-2"><div class="text-xs" style="color:var(--text-mute)">二</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+5</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-3"><div class="text-xs" style="color:var(--text-mute)">三</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+5</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-4"><div class="text-xs" style="color:var(--text-mute)">四</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+5</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-5"><div class="text-xs" style="color:var(--text-mute)">五</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+5</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-6"><div class="text-xs" style="color:var(--text-mute)">六</div><div class="text-lg">💎</div><div class="text-[10px]" style="color:var(--text-mute)">+10</div></div>
        <div class="text-center p-2 rounded-xl" style="background:rgba(255,255,255,0.5)" id="checkin-d-7"><div class="text-xs" style="color:var(--text-mute)">日</div><div class="text-lg">🎁</div><div class="text-[10px]" style="color:var(--text-mute)">+20</div></div>
      </div>
      <button id="checkin-btn" onclick="doCheckIn()" class="btn-primary w-full py-3 rounded-xl">今日签到</button>
      <button id="checkin-done" class="btn-soft w-full py-3 rounded-xl hidden" disabled>已签到 ✓</button>
    </div>

    <!-- 赚取星光水晶 -->
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-4">✨ 赚取星光水晶</h3>
      <div class="space-y-3">
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">📅</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">每日签到</div><div class="text-xs" style="color:var(--text-mute)">+5 星光水晶</div></div>
          </div>
          <div class="text-xs px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)" id="task-checkin">进行中</div>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">⭐</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">完成打卡</div><div class="text-xs" style="color:var(--text-mute)">+3 星光水晶</div></div>
          </div>
          <div class="text-xs px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)" id="task-challenge">进行中</div>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">📝</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">记录情绪</div><div class="text-xs" style="color:var(--text-mute)">+2 星光水晶</div></div>
          </div>
          <div class="text-xs px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)" id="task-emotion">进行中</div>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">📤</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">分享卡片</div><div class="text-xs" style="color:var(--text-mute)">+5 星光水晶</div></div>
          </div>
          <div class="text-xs px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)" id="task-share">进行中</div>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">📖</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">阅读书籍</div><div class="text-xs" style="color:var(--text-mute)">+10 星光水晶/本</div></div>
          </div>
          <div class="text-xs px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)" id="task-book">进行中</div>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">🤝</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">邀请好友</div><div class="text-xs" style="color:var(--text-mute)">双方各 +30 星光水晶</div></div>
          </div>
          <button onclick="showInvitePage()" class="text-xs px-3 py-1.5 rounded-full" style="background:linear-gradient(135deg,#E8B5C8,#C8A5D8);color:white">去邀请</button>
        </div>
      </div>
    </div>
    ...
    <!-- 星光水晶商城 -->
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-4">🛒 星光水晶商城</h3>
      <div class="space-y-3">
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">📖</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">解锁一本书</div><div class="text-xs" style="color:var(--text-mute)">永久解锁单本书籍</div></div>
          </div>
          <button onclick="unlockWithCrystals('book', 30)" class="text-xs px-3 py-1.5 rounded-full flex items-center gap-1" style="background:linear-gradient(135deg,#FDE68A,#F59E0B);color:white"><span>💎</span>30</button>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">🤖</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">AI 5次对话</div><div class="text-xs" style="color:var(--text-mute)">解锁AI闺蜜5次对话</div></div>
          </div>
          <button onclick="unlockWithCrystals('ai5', 10)" class="text-xs px-3 py-1.5 rounded-full flex items-center gap-1" style="background:linear-gradient(135deg,#FDE68A,#F59E0B);color:white"><span>💎</span>10</button>
        </div>
        <div class="flex items-center justify-between p-3 rounded-xl" style="background:rgba(255,255,255,0.5)">
          <div class="flex items-center gap-3">
            <div class="text-xl">🌙</div>
            <div><div class="text-sm font-medium" style="color:var(--theme-text)">会员1天体验</div><div class="text-xs" style="color:var(--text-mute)">体验全部会员功能</div></div>
          </div>
          <button onclick="unlockWithCrystals('member1d', 50)" class="text-xs px-3 py-1.5 rounded-full flex items-center gap-1" style="background:linear-gradient(135deg,#E8B5C8,#C8A5D8);color:white"><span>💎</span>50</button>
        </div>
      </div>
    </div>
    ...
    <!-- 邀请好友 -->
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-3">🤝 邀请好友</h3>
      <p class="text-sm mb-3" style="color:var(--text-soft)">邀请好友一起显化，双方各得 30 星光水晶！</p>
      <div class="flex gap-2 mb-3">
        <input type="text" id="my-invite-code" class="dream-input text-center font-mono" style="flex:1" readonly value="">
        <button onclick="copyInviteCode()" class="btn-soft px-4 py-2 rounded-xl text-sm">复制</button>
      </div>
      <div class="flex gap-2 mb-3">
        <input type="text" id="input-invite-code" class="dream-input" style="flex:1" placeholder="输入好友邀请码">
        <button onclick="submitInviteCode()" class="btn-primary px-4 py-2 rounded-xl text-sm">领取</button>
      </div>
      <div class="text-center p-3 rounded-xl" style="background:rgba(212,181,199,0.1)">
        <div class="text-sm" style="color:var(--text-soft)">已邀请 <span id="invited-count" class="font-bold" style="color:var(--theme-text)">0</span> 人</div>
      </div>
    </div>

    <!-- 会员权益对比 -->
    <div class="glass-card p-5 mb-6">
      <h3 class="font-medium mb-4">📊 会员权益对比</h3>
      <div class="overflow-x-auto">
        <table class="w-full text-xs" style="min-width:320px">
          <thead><tr><th class="text-left py-2" style="color:var(--text-mute)">功能</th><th class="text-center py-2" style="color:var(--text-mute)">免费</th><th class="text-center py-2" style="color:var(--theme-text)">会员</th><th class="text-center py-2" style="color:#F59E0B">高级</th></tr></thead>
          <tbody style="color:var(--theme-text)">
            <tr><td class="py-2">每日星辰塔罗</td><td class="text-center">1张</td><td class="text-center font-medium">3张</td><td class="text-center font-medium">无限</td></tr>
            <tr><td class="py-2">AI 闺蜜对话</td><td class="text-center">3次</td><td class="text-center font-medium">20次</td><td class="text-center font-medium">无限</td></tr>
            <tr><td class="py-2">SATS 冥想</td><td class="text-center">1次/天</td><td class="text-center font-medium">3次/天</td><td class="text-center font-medium">无限</td></tr>
            <tr><td class="py-2">经典书籍</td><td class="text-center">2本</td><td class="text-center font-medium">8本</td><td class="text-center font-medium">8本</td></tr>
            <tr><td class="py-2">数据导出</td><td class="text-center">❌</td><td class="text-center font-medium">✅</td><td class="text-center font-medium">✅</td></tr>
            <tr><td class="py-2">高级图表</td><td class="text-center">❌</td><td class="text-center font-medium">✅</td><td class="text-center font-medium">✅</td></tr>
            <tr><td class="py-2">SP 完整专区</td><td class="text-center">部分</td><td class="text-center font-medium">✅</td><td class="text-center font-medium">✅</td></tr>
            <tr><td class="py-2">AI 深度显化教练</td><td class="text-center">❌</td><td class="text-center">❌</td><td class="text-center font-medium">✅</td></tr>
          </tbody>
        </table>
      </div>
    </div>
...
<!-- ========== 会员订阅页 ========== -->
<section id="page-vip-plans" class="page" style="padding-bottom:100px;">
  <div class="glass-header sticky top-0 z-40 px-5 py-4">
    <div class="flex items-center justify-between max-w-lg mx-auto">
      <button onclick="showPage('vip')" class="soft-btn w-10 h-10 rounded-full flex items-center justify-center" style="background:rgba(255,255,255,0.6)">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
      </button>
      <h1 class="text-lg font-medium" style="color:var(--theme-text)">升级会员</h1>
      <div class="w-10"></div>
    </div>
  </div>
  <div class="max-w-lg mx-auto px-5 py-6">
    <!-- 限时优惠条 -->
    <div id="vip-limited-banner" class="p-4 rounded-2xl mb-6 text-center" style="background:linear-gradient(135deg,#FDE68A,#F59E0B);display:none">
      <div class="text-sm font-medium text-white mb-1">🎉 新用户限时特惠</div>
      <div class="text-2xl font-bold text-white">首月仅需 ¥6</div>
      <div class="text-xs text-white opacity-80">原价 ¥18，限时72小时</div>
      <button onclick="selectPlan('member_first_month')" class="mt-3 w-full py-2 rounded-xl bg-white text-sm font-medium" style="color:#F59E0B">立即抢购</button>
    </div>

    <!-- 会员方案 -->
    <div class="space-y-4 mb-6">
      <!-- 月度会员 -->
      <div class="glass-card p-5 relative" style="border:1.5px solid rgba(212,181,199,0.3)">
        <div class="flex items-start justify-between mb-3">
          <div>
            <h3 class="font-medium text-lg" style="color:var(--theme-text)">✨ 宇宙会员</h3>
            <p class="text-xs" style="color:var(--text-mute)">解锁全部基础显化工具</p>
          </div>
          <div class="text-right">
            <div class="text-xl font-bold" style="color:var(--theme-text)">¥18</div>
            <div class="text-xs" style="color:var(--text-mute)">/月</div>
          </div>
        </div>
        <div class="flex flex-wrap gap-1.5 mb-4">
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">星辰塔罗3张/天</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">AI 20次/天</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">8本书</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">数据导出</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">高级图表</span>
        </div>
        <button onclick="selectPlan('member_month')" class="btn-primary w-full py-3 rounded-xl">选择月度会员</button>
      </div>

      <!-- 年度会员 -->
      <div class="glass-card p-5 relative" style="border:1.5px solid #F59E0B">
        <div class="absolute -top-2 right-4 text-xs px-3 py-1 rounded-full text-white font-medium" style="background:linear-gradient(135deg,#F59E0B,#FDE68A)">最划算</div>
        <div class="flex items-start justify-between mb-3">
          <div>
            <h3 class="font-medium text-lg" style="color:var(--theme-text)">🌟 宇宙会员 · 年卡</h3>
            <p class="text-xs" style="color:var(--text-mute)">每天只需 ¥0.35</p>
          </div>
          <div class="text-right">
            <div class="text-xl font-bold" style="color:#F59E0B">¥128</div>
            <div class="text-xs" style="color:var(--text-mute)">/年 <span style="text-decoration:line-through">¥216</span></div>
          </div>
        </div>
        <div class="flex flex-wrap gap-1.5 mb-4">
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">全部会员功能</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">省 ¥88</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(212,181,199,0.15);color:var(--text-soft)">额外赠 100 星光水晶</span>
        </div>
        <button onclick="selectPlan('member_year')" class="w-full py-3 rounded-xl text-white font-medium" style="background:linear-gradient(135deg,#F59E0B,#FDE68A)">选择年度会员</button>
      </div>

      <!-- 高级会员 -->
      <div class="glass-card p-5 relative" style="border:1.5px solid rgba(245,158,11,0.4)">
        <div class="flex items-start justify-between mb-3">
          <div>
            <h3 class="font-medium text-lg" style="color:#F59E0B">👑 星际高级会员</h3>
            <p class="text-xs" style="color:var(--text-mute)">深度显化显化教练 · 无限使用</p>
          </div>
          <div class="text-right">
            <div class="text-xl font-bold" style="color:#F59E0B">¥38</div>
            <div class="text-xs" style="color:var(--text-mute)">/月</div>
          </div>
        </div>
        <div class="flex flex-wrap gap-1.5 mb-4">
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(245,158,11,0.15);color:#B45309">全部会员功能</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(245,158,11,0.15);color:#B45309">AI 深度显化教练</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(245,158,11,0.15);color:#B45309">无限对话</span>
          <span class="text-[10px] px-2 py-1 rounded-full" style="background:rgba(245,158,11,0.15);color:#B45309">优先响应</span>
        </div>
        <button onclick="selectPlan('vip_month')" class="w-full py-3 rounded-xl text-white font-medium" style="background:linear-gradient(135deg,#F59E0B,#D97706)">选择高级会员</button>
      </div>
    </div>

    <!-- 订阅说明 -->
    <div class="text-xs text-center" style="color:var(--text-mute)">
      <p>🔒 订阅自动续期，可随时取消</p>
      <p>💎 所有会员方案均包含星光水晶奖励</p>
      <p>🌙 升级后所有功能立即解锁</p>
    </div>
...
<!-- ========== 限时优惠弹窗 ========== -->
<div id="limited-offer-modal" class="modal-backdrop" onclick="if(event.target===this)closeLimitedOffer()">
  <div class="modal-content p-6 text-center" style="max-width:340px">
    <div class="text-4xl mb-3">🎁</div>
    <h3 class="font-medium text-lg mb-1" style="font-family:'ZCOOL XiaoWei',sans-serif">限时特惠</h3>
    <p class="text-sm mb-3" style="color:var(--text-soft)">新用户专享，错过再等一年</p>
    <div class="p-4 rounded-2xl mb-4" style="background:linear-gradient(135deg,#FDE68A,#F59E0B)">
      <div class="text-white text-sm font-medium mb-1">宇宙会员首月</div>
      <div class="flex items-baseline justify-center gap-1">
        <span class="text-white text-lg">¥</span>
        <span class="text-white text-4xl font-bold">6</span>
        <span class="text-white text-sm opacity-70" style="text-decoration:line-through">¥18</span>
      </div>
      <div class="text-white text-xs mt-1 opacity-80">限时72小时 · 剩余 <span id="offer-timer">23:59:59</span></div>
    </div>
    <button onclick="selectPlan('member_first_month');closeLimitedOffer()" class="btn-primary w-full py-3 rounded-xl mb-2">立即抢购</button>
    <button onclick="closeLimitedOffer()" class="text-xs" style="color:var(--text-mute)">稍后再说</button>
  </div>
</div>

<!-- ========== 功能锁定提示弹窗 ========== -->
<div id="lock-modal" class="modal-backdrop" onclick="if(event.target===this)closeLockModal()">
  <div class="modal-content p-6 text-center" style="max-width:340px">
    <div class="text-4xl mb-3">🔒</div>
    <h3 class="font-medium text-lg mb-2" style="font-family:'ZCOOL XiaoWei',sans-serif" id="lock-title">功能锁定</h3>
    <p class="text-sm mb-4" style="color:var(--text-soft)" id="lock-desc">升级会员即可解锁此功能</p>
    <div class="flex gap-2 mb-3">
      <button onclick="closeLockModal();showPage('vip')" class="btn-primary flex-1 py-3 rounded-xl text-sm">升级会员</button>
      <button onclick="closeLockModal()" class="btn-soft flex-1 py-3 rounded-xl text-sm">用星光水晶解锁</button>
    </div>
    <button onclick="closeLockModal()" class="text-xs" style="color:var(--text-mute)">稍后再说</button>
  </div>
</div>
...
function startAudioScene(idx) {
  ...
  document.getElementById('audio-player-scene').textContent = scene.title;
  document.getElementById('audio-player').classList.remove('hidden');
  document.getElementById('audio-scenes').classList.add('hidden');
...
function pauseAudio() {
  if(audioPlaying && currentAudioCtx && currentAudioCtx.state === 'running') {
    ...
    audioPlaying = false;
    document.getElementById('audio-pause-btn').textContent = '▶️ 继续';
  } else if(currentAudioCtx && currentAudioCtx.state === 'suspended') {
    currentAudioCtx.resume();
    if(window.speechSynthesis) window.speechSynthesis.resume();
    audioPlaying = true;
    document.getElementById('audio-pause-btn').textContent = '⏸️ 暂停';
  }
}
  ...
  setTimeout(() => {
    ...
    banner.innerHTML = `
      <div style="position:fixed;bottom:80px;left:16px;right:16px;z-index:50;background:linear-gradient(135deg,#D4B5C7,#B8A9C9);border-radius:16px;padding:14px 18px;display:flex;align-items:center;gap:12px;box-shadow:0 8px 24px rgba(93,78,109,0.15);color:white;">
        ...
        <button onclick="localStorage.setItem('pwa_dismissed','true'); document.getElementById('pwa-install-banner').remove();" style="background:rgba(255,255,255,0.2);color:white;border:none;border-radius:10px;padding:8px 10px;font-size:12px;cursor:pointer;">×</button>
      </div>
    `;
...
function selectBreatheMode(mode, el) {
  ...
  document.querySelectorAll('[id^="breathe-mode-"]').forEach(d => d.style.border = '');
  if(el) el.style.border = '2px solid var(--theme-text)';
  const cfg = BREATHE_MODES[mode];
  document.getElementById('breathe-instruction').textContent = cfg.text;
...
function stopBreathe() {
  ...
  document.getElementById('breathe-text').textContent = '吸气';
  document.getElementById('breathe-circle').style.transform = 'scale(1)';
  document.getElementById('breathe-bar').style.width = '0%';
  // 记录
  const today = getTodayStr();
...
function playBreatheRound() {
  ...
  breatheState.round++;
  document.getElementById('breathe-round').textContent = `第 ${breatheState.round} / ${cfg.rounds} 轮`;
  document.getElementById('breathe-bar').style.width = `${(breatheState.round/cfg.rounds)*100}%`;
...
function runPhase(phases, idx) {
  ...
  document.getElementById('breathe-text').textContent = name;
  ...
  const tick = () => {
    if (!breatheState.running) return;
    document.getElementById('breathe-timer').textContent = remaining;
    remaining--;
...
function startVoiceRecord() {
  ...
  navigator.mediaDevices.getUserMedia({ audio: true }).then(stream => {
    ...
    voiceRecorder.onstop = () => {
      ...
      document.getElementById('voice-status').textContent = '录制完成！';
      document.getElementById('voice-record-btn').style.background = 'linear-gradient(135deg,#D4B5C7,#B8A9C9)';
      document.getElementById('voice-wave').style.opacity = '0';
      logActivity('voice_record', '录制肯定语');
    };
    voiceRecorder.start();
    voiceRecordStartTime = Date.now();
    document.getElementById('voice-status').textContent = '正在录制...';
    document.getElementById('voice-record-btn').style.background = '#F87171';
    document.getElementById('voice-wave').style.opacity = '1';
    // 计时器
...
function playSleepStory(idx) {
  ...
  document.getElementById('sleep-player').classList.remove('hidden');
  document.getElementById('sleep-story-title').textContent = story.emoji + ' ' + story.title;
  ...
  document.getElementById('sleep-progress').style.width = '0%';
  ...
  document.getElementById('sleep-pause-btn').textContent = '⏸️ 暂停';
...
function speakNextParagraph() {
  ...
  if (idx >= paragraphs.length) { sleepStoryState.playing = false; document.getElementById('sleep-pause-btn').textContent = '▶️ 播放'; return; }
...
function pauseSleepStory() {
  ...
  if (sleepStoryState.paused) {
    ...
    document.getElementById('sleep-pause-btn').textContent = '▶️ 继续';
  } else {
...
function stopSleepStory() {
  ...
  speechSynthesis.cancel();
  document.getElementById('sleep-player').classList.add('hidden');
}
...
if (name === 'voice') { showPage('voice'); initVoice(); return; }
if (name === 'sleep') { showPage('sleep'); initSleep(); return; }
if (name === 'mood-chart') { showPage('mood-chart'); initMoodChart(); return; }
if (name === 'habit-calendar') { showPage('habit-calendar'); initHabitCalendar(); return; }
if (name === 'vision') { showPage('vision'); initVisionBoard(); return; }
if (name === 'qr-sync') { showPage('qr-sync'); return; }
if (name === 'badge-wall') { showPage('badge-wall'); initBadgeWall(); return; }
...
function initMoodChart() {
  ...
  document.getElementById('mood-chart-stats').innerHTML = `
...
function renderHabitCalendar(date) {
  ...
  document.getElementById('habit-calendar-title').textContent = `${year}年 ${monthNames[month]}`;
...
function generateDataQR() {
  ...
  document.getElementById('qr-import-area').classList.add('hidden');
...
function showImportInput() {
  document.getElementById('qr-import-area').classList.remove('hidden');
  document.getElementById('qr-export-area').classList.add('hidden');
}
...
function exportSelectedData() {
  ...
  window.__qrSyncData = compressed;
  document.getElementById('qr-export-area').classList.remove('hidden');
  document.getElementById('qr-import-area').classList.add('hidden');
...
function renderSatsStep() {
  ...
  document.getElementById('sats-step-num').textContent = satsCurrentStep + 1;
  document.getElementById('sats-step-content').innerHTML = `
  ...
  `;
  document.getElementById('sats-prev-btn').classList.toggle('hidden', satsCurrentStep === 0);
...
function renderAboutStats() {
  ...
  const days = state.startDate ? Math.max(1, Math.ceil((Date.now() - new Date(state.startDate).getTime()) / 86400000)) : 0;
  el.innerHTML = [
  ...
  container.innerHTML = `
    <div class="glass-card p-4 mb-4">
      ...
      <div class="flex items-center gap-3 mb-3">
        ...
        <input type="range" id="sign-intensity" min="1" max="5" value="3" class="flex-1" oninput="document.getElementById('intensity-label').textContent = this.value">
  ...
  container.innerHTML = `
    ...
    <div class="glass-card p-4 mb-4">
      ...
      ${current ? `
        ...
        <input type="range" id="rampage-after" min="1" max="10" value="7" class="w-full mb-3" oninput="document.getElementById('rampage-after-val').textContent=this.value">
